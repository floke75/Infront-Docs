---
title: "CdapiGetCommonInstrumentsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonInstrumentsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetCommonInstrumentsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonInstrumentsOptions.html"
defines: ["CdapiGetCommonInstrumentsOptions"]
member_count: 49
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiCommonInstrumentsData"]
reference_count: 15
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonInstrumentsOptionsEetCarbonFootprintSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonInstrumentsOptionsEetEutaxSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonInstrumentsOptionsEetExposureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonInstrumentsOptionsEetManufacturerSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonInstrumentsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonInstrumentsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonInstrumentsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonInstrumentsOptionsInstrumentAdditionalSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonInstrumentsOptionsListingAdditionalSource", "SDK.InfrontSDK.CoreDataAPI.CdapiCommonInstrumentsData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonInstrumentsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonInstrumentsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonInstrumentsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetCommonInstruments"]
---

# CdapiGetCommonInstrumentsOptions

Request options for [cdapiGetCommonInstruments](./SDK.InfrontSDK.CoreDataAPI.cdapiGetCommonInstruments.md)

```ts
interface CdapiGetCommonInstrumentsOptions {
...
    eet_carbon_footprint_source?: CdapiGetCommonInstrumentsOptionsEetCarbonFootprintSource;
    eet_eutax_source?: CdapiGetCommonInstrumentsOptionsEetEutaxSource;
    eet_exposure_source?: CdapiGetCommonInstrumentsOptionsEetExposureSource;
    eet_manufacturer_source?: CdapiGetCommonInstrumentsOptionsEetManufacturerSource;
    eet_sfdr_pai_source?: CdapiGetCommonInstrumentsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetCommonInstrumentsOptionsEetSpiSource;
    esg_risk_source?: CdapiGetCommonInstrumentsOptionsEsgRiskSource;
...
    instrument_additional_source?: CdapiGetCommonInstrumentsOptionsInstrumentAdditionalSource;
...
    limit?: number;
    listing_additional_source?: CdapiGetCommonInstrumentsOptionsListingAdditionalSource;
    listing_id?: string | readonly string[];
    main_index_listing_id?: string;
    nsin?: string | readonly string[];
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiCommonInstrumentsData>;
    onError?: CoreDataRequestErrorCallback<CdapiCommonInstrumentsData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiCommonInstrumentsData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetCommonInstrumentsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetCommonInstrumentsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetCommonInstrumentsSortField>
        | readonly CdapiSortField<CdapiGetCommonInstrumentsSortField>[];
...
- CdapiCommonRequestOptions<CdapiCommonInstrumentsData>
