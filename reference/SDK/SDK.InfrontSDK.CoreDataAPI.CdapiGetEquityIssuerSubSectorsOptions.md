---
title: "CdapiGetEquityIssuerSubSectorsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSubSectorsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetEquityIssuerSubSectorsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSubSectorsOptions.html"
defines: ["CdapiGetEquityIssuerSubSectorsOptions"]
member_count: 52
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiEquityIssuerSubSectorData"]
reference_count: 14
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSubSectorsOptionsCompanySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSubSectorsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSubSectorsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSubSectorsOptionsEquityIssuerEstimateKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSubSectorsOptionsEquityIssuerKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSubSectorsOptionsEquityKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSubSectorsOptionsEquitySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSubSectorsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiEquityIssuerSubSectorData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSubSectorsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSubSectorsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSubSectorsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityIssuerSubSectors"]
---

# CdapiGetEquityIssuerSubSectorsOptions

Request options for [cdapiGetEquityIssuerSubSectors](./SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityIssuerSubSectors.md)

```ts
interface CdapiGetEquityIssuerSubSectorsOptions {
...
    company_source?: CdapiGetEquityIssuerSubSectorsOptionsCompanySource;
    country_code?: string | readonly string[];
    country_id?: number | readonly number[];
    currency_code?: string | readonly string[];
    eet_sfdr_pai_source?: CdapiGetEquityIssuerSubSectorsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetEquityIssuerSubSectorsOptionsEetSpiSource;
    equity_issuer_estimate_keyfigure_source?: CdapiGetEquityIssuerSubSectorsOptionsEquityIssuerEstimateKeyfigureSource;
    equity_issuer_keyfigure_source?: CdapiGetEquityIssuerSubSectorsOptionsEquityIssuerKeyfigureSource;
    equity_keyfigure_source?: CdapiGetEquityIssuerSubSectorsOptionsEquityKeyfigureSource;
    equity_source?: CdapiGetEquityIssuerSubSectorsOptionsEquitySource;
    esg_risk_source?: CdapiGetEquityIssuerSubSectorsOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiEquityIssuerSubSectorData>;
    onError?: CoreDataRequestErrorCallback<CdapiEquityIssuerSubSectorData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiEquityIssuerSubSectorData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetEquityIssuerSubSectorsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetEquityIssuerSubSectorsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetEquityIssuerSubSectorsSortField>
        | readonly CdapiSortField<CdapiGetEquityIssuerSubSectorsSortField>[];
...
- CdapiCommonRequestOptions<CdapiEquityIssuerSubSectorData>
