---
title: "CdapiGetFundBenchmarksOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundBenchmarksOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetFundBenchmarksOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetFundBenchmarksOptions.html"
defines: ["CdapiGetFundBenchmarksOptions"]
member_count: 46
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiFundBenchmarksData"]
reference_count: 9
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetFundBenchmarksOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundBenchmarksOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundBenchmarksOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiFundBenchmarksData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundBenchmarksOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundBenchmarksOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundBenchmarksSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetFundBenchmarks"]
---

# CdapiGetFundBenchmarksOptions

Request options for [cdapiGetFundBenchmarks](./SDK.InfrontSDK.CoreDataAPI.cdapiGetFundBenchmarks.md)

```ts
interface CdapiGetFundBenchmarksOptions {
...
    eet_sfdr_pai_source?: CdapiGetFundBenchmarksOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetFundBenchmarksOptionsEetSpiSource;
    efc_id?: number | readonly number[];
    esg_risk_source?: CdapiGetFundBenchmarksOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiFundBenchmarksData>;
    onError?: CoreDataRequestErrorCallback<CdapiFundBenchmarksData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiFundBenchmarksData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetFundBenchmarksOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetFundBenchmarksOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sfdr?: number | readonly number[];
    sort?:
        | CdapiSortField<CdapiGetFundBenchmarksSortField>
        | readonly CdapiSortField<CdapiGetFundBenchmarksSortField>[];
...
- CdapiCommonRequestOptions<CdapiFundBenchmarksData>
