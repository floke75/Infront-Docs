---
title: "CdapiGetCommonTradingVenuesOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonTradingVenuesOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetCommonTradingVenuesOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonTradingVenuesOptions.html"
defines: ["CdapiGetCommonTradingVenuesOptions"]
member_count: 49
...
reference_count: 15
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonTradingVenuesOptionsEetCarbonFootprintSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonTradingVenuesOptionsEetEutaxSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonTradingVenuesOptionsEetExposureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonTradingVenuesOptionsEetManufacturerSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonTradingVenuesOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonTradingVenuesOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonTradingVenuesOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonTradingVenuesOptionsInstrumentAdditionalSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonTradingVenuesOptionsListingAdditionalSource", "SDK.InfrontSDK.CoreDataAPI.CdapiCommonTradingVenuesData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonTradingVenuesOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonTradingVenuesOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonTradingVenuesSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetCommonTradingVenues"]
---

# CdapiGetCommonTradingVenuesOptions

Request options for [cdapiGetCommonTradingVenues](./SDK.InfrontSDK.CoreDataAPI.cdapiGetCommonTradingVenues.md)

```ts
interface CdapiGetCommonTradingVenuesOptions {
...
    eet_carbon_footprint_source?: CdapiGetCommonTradingVenuesOptionsEetCarbonFootprintSource;
    eet_eutax_source?: CdapiGetCommonTradingVenuesOptionsEetEutaxSource;
    eet_exposure_source?: CdapiGetCommonTradingVenuesOptionsEetExposureSource;
    eet_manufacturer_source?: CdapiGetCommonTradingVenuesOptionsEetManufacturerSource;
    eet_sfdr_pai_source?: CdapiGetCommonTradingVenuesOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetCommonTradingVenuesOptionsEetSpiSource;
    esg_risk_source?: CdapiGetCommonTradingVenuesOptionsEsgRiskSource;
...
    instrument_additional_source?: CdapiGetCommonTradingVenuesOptionsInstrumentAdditionalSource;
...
    limit?: number;
    listing_additional_source?: CdapiGetCommonTradingVenuesOptionsListingAdditionalSource;
...
    preferred_trading_venue_strategy_code?: CdapiGetCommonTradingVenuesOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetCommonTradingVenuesOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetCommonTradingVenuesSortField>
        | readonly CdapiSortField<CdapiGetCommonTradingVenuesSortField>[];
