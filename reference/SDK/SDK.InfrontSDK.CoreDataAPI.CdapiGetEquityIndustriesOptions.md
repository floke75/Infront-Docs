---
title: "CdapiGetEquityIndustriesOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIndustriesOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetEquityIndustriesOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIndustriesOptions.html"
defines: ["CdapiGetEquityIndustriesOptions"]
member_count: 52
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiEquityIndustriessData"]
reference_count: 14
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIndustriesOptionsCompanySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIndustriesOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIndustriesOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIndustriesOptionsEquityIssuerEstimateKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIndustriesOptionsEquityIssuerKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIndustriesOptionsEquityKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIndustriesOptionsEquitySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIndustriesOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiEquityIndustriessData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIndustriesOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIndustriesOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIndustriesSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityIndustries"]
---

# CdapiGetEquityIndustriesOptions

Request options for [cdapiGetEquityIndustries](./SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityIndustries.md)

```ts
interface CdapiGetEquityIndustriesOptions {
...
    company_source?: CdapiGetEquityIndustriesOptionsCompanySource;
    country_code?: string | readonly string[];
    country_id?: number | readonly number[];
    currency_code?: string | readonly string[];
    eet_sfdr_pai_source?: CdapiGetEquityIndustriesOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetEquityIndustriesOptionsEetSpiSource;
    equity_issuer_estimate_keyfigure_source?: CdapiGetEquityIndustriesOptionsEquityIssuerEstimateKeyfigureSource;
    equity_issuer_keyfigure_source?: CdapiGetEquityIndustriesOptionsEquityIssuerKeyfigureSource;
    equity_keyfigure_source?: CdapiGetEquityIndustriesOptionsEquityKeyfigureSource;
    equity_source?: CdapiGetEquityIndustriesOptionsEquitySource;
    esg_risk_source?: CdapiGetEquityIndustriesOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiEquityIndustriessData>;
    onError?: CoreDataRequestErrorCallback<CdapiEquityIndustriessData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiEquityIndustriessData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetEquityIndustriesOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetEquityIndustriesOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetEquityIndustriesSortField>
        | readonly CdapiSortField<CdapiGetEquityIndustriesSortField>[];
...
- CdapiCommonRequestOptions<CdapiEquityIndustriessData>
