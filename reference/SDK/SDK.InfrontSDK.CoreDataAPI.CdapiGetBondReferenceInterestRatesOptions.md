---
title: "CdapiGetBondReferenceInterestRatesOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondReferenceInterestRatesOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetBondReferenceInterestRatesOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetBondReferenceInterestRatesOptions.html"
defines: ["CdapiGetBondReferenceInterestRatesOptions"]
member_count: 52
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiBondReferenceInterestRatesData"]
reference_count: 9
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetBondReferenceInterestRatesOptionsBondKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondReferenceInterestRatesOptionsBondSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondReferenceInterestRatesOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondReferenceInterestRatesOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondReferenceInterestRatesOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiBondReferenceInterestRatesData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondReferenceInterestRatesOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondReferenceInterestRatesOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.cdapiGetBondReferenceInterestRates"]
---

# CdapiGetBondReferenceInterestRatesOptions

Request options for [cdapiGetBondReferenceInterestRates](./SDK.InfrontSDK.CoreDataAPI.cdapiGetBondReferenceInterestRates.md)

```ts
interface CdapiGetBondReferenceInterestRatesOptions {
...
    bond_keyfigure_source?: CdapiGetBondReferenceInterestRatesOptionsBondKeyfigureSource;
    bond_source?: CdapiGetBondReferenceInterestRatesOptionsBondSource;
...
    eet_sfdr_pai_source?: CdapiGetBondReferenceInterestRatesOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetBondReferenceInterestRatesOptionsEetSpiSource;
    esg_risk_source?: CdapiGetBondReferenceInterestRatesOptionsEsgRiskSource;
...
    | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetBondReferenceInterestRatesOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetBondReferenceInterestRatesOptionsRatingSource;
...
- CdapiCommonRequestOptions<CdapiBondReferenceInterestRatesData>
...
```ts
onData?: CoreDataRequestSuccessCallback<CdapiBondReferenceInterestRatesData>
```
...
```ts
onFinally?: CoreDataRequestFinallyCallback<CdapiBondReferenceInterestRatesData>
```
