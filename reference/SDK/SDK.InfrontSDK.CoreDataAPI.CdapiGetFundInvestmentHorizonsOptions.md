---
title: "CdapiGetFundInvestmentHorizonsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundInvestmentHorizonsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetFundInvestmentHorizonsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetFundInvestmentHorizonsOptions.html"
defines: ["CdapiGetFundInvestmentHorizonsOptions"]
member_count: 46
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiFundInvestmentHorizonsData"]
reference_count: 9
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetFundInvestmentHorizonsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundInvestmentHorizonsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundInvestmentHorizonsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiFundInvestmentHorizonsData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundInvestmentHorizonsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundInvestmentHorizonsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundInvestmentHorizonsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetFundInvestmentHorizons"]
---

# CdapiGetFundInvestmentHorizonsOptions

Request options for [cdapiGetFundInvestmentHorizons](./SDK.InfrontSDK.CoreDataAPI.cdapiGetFundInvestmentHorizons.md)

```ts
interface CdapiGetFundInvestmentHorizonsOptions {
...
    eet_sfdr_pai_source?: CdapiGetFundInvestmentHorizonsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetFundInvestmentHorizonsOptionsEetSpiSource;
    efc_id?: number | readonly number[];
    esg_risk_source?: CdapiGetFundInvestmentHorizonsOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiFundInvestmentHorizonsData>;
    onError?: CoreDataRequestErrorCallback<CdapiFundInvestmentHorizonsData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiFundInvestmentHorizonsData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetFundInvestmentHorizonsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetFundInvestmentHorizonsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sfdr?: number | readonly number[];
    sort?:
        | CdapiSortField<CdapiGetFundInvestmentHorizonsSortField>
        | readonly CdapiSortField<CdapiGetFundInvestmentHorizonsSortField>[];
...
- CdapiCommonRequestOptions<CdapiFundInvestmentHorizonsData>
