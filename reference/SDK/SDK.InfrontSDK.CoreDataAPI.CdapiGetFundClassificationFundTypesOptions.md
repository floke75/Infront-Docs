---
title: "CdapiGetFundClassificationFundTypesOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundClassificationFundTypesOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetFundClassificationFundTypesOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetFundClassificationFundTypesOptions.html"
defines: ["CdapiGetFundClassificationFundTypesOptions"]
member_count: 46
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiFundClassificationFundTypesData"]
reference_count: 9
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetFundClassificationFundTypesOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundClassificationFundTypesOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundClassificationFundTypesOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiFundClassificationFundTypesData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundClassificationFundTypesOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundClassificationFundTypesOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundClassificationFundTypesSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetFundClassificationFundTypes"]
---

# CdapiGetFundClassificationFundTypesOptions

Request options for [cdapiGetFundClassificationFundTypes](./SDK.InfrontSDK.CoreDataAPI.cdapiGetFundClassificationFundTypes.md)

```ts
interface CdapiGetFundClassificationFundTypesOptions {
...
    eet_sfdr_pai_source?: CdapiGetFundClassificationFundTypesOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetFundClassificationFundTypesOptionsEetSpiSource;
    efc_id?: number | readonly number[];
    esg_risk_source?: CdapiGetFundClassificationFundTypesOptionsEsgRiskSource;
...
    | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetFundClassificationFundTypesOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetFundClassificationFundTypesOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sfdr?: number | readonly number[];
    sort?:
        | CdapiSortField<CdapiGetFundClassificationFundTypesSortField>
        | readonly CdapiSortField<CdapiGetFundClassificationFundTypesSortField>[];
...
- CdapiCommonRequestOptions<CdapiFundClassificationFundTypesData>
...
```ts
onData?: CoreDataRequestSuccessCallback<CdapiFundClassificationFundTypesData>
```
...
```ts
onError?: CoreDataRequestErrorCallback<CdapiFundClassificationFundTypesData>
```
...
```ts
onFinally?: CoreDataRequestFinallyCallback<CdapiFundClassificationFundTypesData>
```
