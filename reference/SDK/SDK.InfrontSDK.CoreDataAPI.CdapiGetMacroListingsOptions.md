---
title: "CdapiGetMacroListingsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetMacroListingsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetMacroListingsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetMacroListingsOptions.html"
defines: ["CdapiGetMacroListingsOptions"]
member_count: 23
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiMacroListingsData"]
reference_count: 2
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiMacroListingsData", "SDK.InfrontSDK.CoreDataAPI.cdapiGetMacroListings"]
---

# CdapiGetMacroListingsOptions

Request options for [cdapiGetMacroListings](./SDK.InfrontSDK.CoreDataAPI.cdapiGetMacroListings.md)

```ts
interface CdapiGetMacroListingsOptions {
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiMacroListingsData>;
    onError?: CoreDataRequestErrorCallback<CdapiMacroListingsData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiMacroListingsData>;
...
- CdapiCommonRequestOptions<CdapiMacroListingsData>
