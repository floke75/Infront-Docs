---
title: "CdapiGetFundClassificationEfcsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundClassificationEfcsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetFundClassificationEfcsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetFundClassificationEfcsOptions.html"
defines: ["CdapiGetFundClassificationEfcsOptions"]
member_count: 46
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiFundClassificationEfcsData"]
reference_count: 9
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetFundClassificationEfcsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundClassificationEfcsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundClassificationEfcsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiFundClassificationEfcsData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundClassificationEfcsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundClassificationEfcsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundClassificationEfcsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetFundClassificationEfcs"]
---

# CdapiGetFundClassificationEfcsOptions

Request options for [cdapiGetFundClassificationEfcs](./SDK.InfrontSDK.CoreDataAPI.cdapiGetFundClassificationEfcs.md)

```ts
interface CdapiGetFundClassificationEfcsOptions {
...
    eet_sfdr_pai_source?: CdapiGetFundClassificationEfcsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetFundClassificationEfcsOptionsEetSpiSource;
    efc_id?: number | readonly number[];
    esg_risk_source?: CdapiGetFundClassificationEfcsOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiFundClassificationEfcsData>;
    onError?: CoreDataRequestErrorCallback<CdapiFundClassificationEfcsData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiFundClassificationEfcsData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetFundClassificationEfcsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetFundClassificationEfcsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sfdr?: number | readonly number[];
    sort?:
        | CdapiSortField<CdapiGetFundClassificationEfcsSortField>
        | readonly CdapiSortField<CdapiGetFundClassificationEfcsSortField>[];
...
- CdapiCommonRequestOptions<CdapiFundClassificationEfcsData>
