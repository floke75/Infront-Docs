---
title: "CdapiGetCommonIssuerCountriesOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerCountriesOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetCommonIssuerCountriesOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerCountriesOptions.html"
defines: ["CdapiGetCommonIssuerCountriesOptions"]
member_count: 49
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiCommonIssuerCountriesData"]
reference_count: 15
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerCountriesOptionsEetCarbonFootprintSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerCountriesOptionsEetEutaxSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerCountriesOptionsEetExposureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerCountriesOptionsEetManufacturerSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerCountriesOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerCountriesOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerCountriesOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerCountriesOptionsInstrumentAdditionalSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerCountriesOptionsListingAdditionalSource", "SDK.InfrontSDK.CoreDataAPI.CdapiCommonIssuerCountriesData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerCountriesOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerCountriesOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerCountriesSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetCommonIssuerCountries"]
---

# CdapiGetCommonIssuerCountriesOptions

Request options for [cdapiGetCommonIssuerCountries](./SDK.InfrontSDK.CoreDataAPI.cdapiGetCommonIssuerCountries.md)

```ts
interface CdapiGetCommonIssuerCountriesOptions {
...
    eet_carbon_footprint_source?: CdapiGetCommonIssuerCountriesOptionsEetCarbonFootprintSource;
    eet_eutax_source?: CdapiGetCommonIssuerCountriesOptionsEetEutaxSource;
    eet_exposure_source?: CdapiGetCommonIssuerCountriesOptionsEetExposureSource;
    eet_manufacturer_source?: CdapiGetCommonIssuerCountriesOptionsEetManufacturerSource;
    eet_sfdr_pai_source?: CdapiGetCommonIssuerCountriesOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetCommonIssuerCountriesOptionsEetSpiSource;
    esg_risk_source?: CdapiGetCommonIssuerCountriesOptionsEsgRiskSource;
...
    instrument_additional_source?: CdapiGetCommonIssuerCountriesOptionsInstrumentAdditionalSource;
...
    limit?: number;
    listing_additional_source?: CdapiGetCommonIssuerCountriesOptionsListingAdditionalSource;
    listing_id?: string | readonly string[];
    main_index_listing_id?: string;
    nsin?: string | readonly string[];
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiCommonIssuerCountriesData>;
    onError?: CoreDataRequestErrorCallback<CdapiCommonIssuerCountriesData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiCommonIssuerCountriesData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetCommonIssuerCountriesOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetCommonIssuerCountriesOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetCommonIssuerCountriesSortField>
        | readonly CdapiSortField<CdapiGetCommonIssuerCountriesSortField>[];
...
- CdapiCommonRequestOptions<CdapiCommonIssuerCountriesData>
