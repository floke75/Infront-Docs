---
title: "CdapiGetFundAdministratorsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundAdministratorsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetFundAdministratorsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetFundAdministratorsOptions.html"
defines: ["CdapiGetFundAdministratorsOptions"]
member_count: 46
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiFundAdministratorsData"]
reference_count: 9
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetFundAdministratorsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundAdministratorsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundAdministratorsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiFundAdministratorsData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundAdministratorsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundAdministratorsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundAdministratorsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetFundAdministrators"]
---

# CdapiGetFundAdministratorsOptions

Request options for [cdapiGetFundAdministrators](./SDK.InfrontSDK.CoreDataAPI.cdapiGetFundAdministrators.md)

```ts
interface CdapiGetFundAdministratorsOptions {
...
    eet_sfdr_pai_source?: CdapiGetFundAdministratorsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetFundAdministratorsOptionsEetSpiSource;
    efc_id?: number | readonly number[];
    esg_risk_source?: CdapiGetFundAdministratorsOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiFundAdministratorsData>;
    onError?: CoreDataRequestErrorCallback<CdapiFundAdministratorsData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiFundAdministratorsData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetFundAdministratorsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetFundAdministratorsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sfdr?: number | readonly number[];
    sort?:
        | CdapiSortField<CdapiGetFundAdministratorsSortField>
        | readonly CdapiSortField<CdapiGetFundAdministratorsSortField>[];
...
- CdapiCommonRequestOptions<CdapiFundAdministratorsData>
