---
title: "CdapiGetBondClassificationBondTypesOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondClassificationBondTypesOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetBondClassificationBondTypesOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetBondClassificationBondTypesOptions.html"
defines: ["CdapiGetBondClassificationBondTypesOptions"]
member_count: 52
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiBondClassificationBondTypesData"]
reference_count: 9
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetBondClassificationBondTypesOptionsBondKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondClassificationBondTypesOptionsBondSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondClassificationBondTypesOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondClassificationBondTypesOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondClassificationBondTypesOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiBondClassificationBondTypesData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondClassificationBondTypesOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondClassificationBondTypesOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.cdapiGetBondClassificationBondTypes"]
---

# CdapiGetBondClassificationBondTypesOptions

Request options for [cdapiGetBondClassificationBondTypes](./SDK.InfrontSDK.CoreDataAPI.cdapiGetBondClassificationBondTypes.md)

```ts
interface CdapiGetBondClassificationBondTypesOptions {
...
    bond_keyfigure_source?: CdapiGetBondClassificationBondTypesOptionsBondKeyfigureSource;
    bond_source?: CdapiGetBondClassificationBondTypesOptionsBondSource;
...
    eet_sfdr_pai_source?: CdapiGetBondClassificationBondTypesOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetBondClassificationBondTypesOptionsEetSpiSource;
    esg_risk_source?: CdapiGetBondClassificationBondTypesOptionsEsgRiskSource;
...
    | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetBondClassificationBondTypesOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetBondClassificationBondTypesOptionsRatingSource;
...
- CdapiCommonRequestOptions<CdapiBondClassificationBondTypesData>
...
```ts
onData?: CoreDataRequestSuccessCallback<CdapiBondClassificationBondTypesData>
```
...
```ts
onError?: CoreDataRequestErrorCallback<CdapiBondClassificationBondTypesData>
```
...
```ts
onFinally?: CoreDataRequestFinallyCallback<CdapiBondClassificationBondTypesData>
```
