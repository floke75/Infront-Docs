---
title: "CdapiGetBondSpecialDebitorRedemptionsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondSpecialDebitorRedemptionsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetBondSpecialDebitorRedemptionsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetBondSpecialDebitorRedemptionsOptions.html"
defines: ["CdapiGetBondSpecialDebitorRedemptionsOptions"]
member_count: 52
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiBondSpecialDebitorRedemptionsData"]
reference_count: 9
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetBondSpecialDebitorRedemptionsOptionsBondKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondSpecialDebitorRedemptionsOptionsBondSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondSpecialDebitorRedemptionsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondSpecialDebitorRedemptionsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondSpecialDebitorRedemptionsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiBondSpecialDebitorRedemptionsData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondSpecialDebitorRedemptionsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondSpecialDebitorRedemptionsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.cdapiGetBondSpecialDebitorRedemptions"]
---

# CdapiGetBondSpecialDebitorRedemptionsOptions

Request options for [cdapiGetBondSpecialDebitorRedemptions](./SDK.InfrontSDK.CoreDataAPI.cdapiGetBondSpecialDebitorRedemptions.md)

```ts
interface CdapiGetBondSpecialDebitorRedemptionsOptions {
...
    bond_keyfigure_source?: CdapiGetBondSpecialDebitorRedemptionsOptionsBondKeyfigureSource;
    bond_source?: CdapiGetBondSpecialDebitorRedemptionsOptionsBondSource;
...
    eet_sfdr_pai_source?: CdapiGetBondSpecialDebitorRedemptionsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetBondSpecialDebitorRedemptionsOptionsEetSpiSource;
    esg_risk_source?: CdapiGetBondSpecialDebitorRedemptionsOptionsEsgRiskSource;
...
    | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetBondSpecialDebitorRedemptionsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetBondSpecialDebitorRedemptionsOptionsRatingSource;
...
- CdapiCommonRequestOptions<CdapiBondSpecialDebitorRedemptionsData>
...
```ts
onData?: CoreDataRequestSuccessCallback<CdapiBondSpecialDebitorRedemptionsData>
```
...
```ts
onError?: CoreDataRequestErrorCallback<CdapiBondSpecialDebitorRedemptionsData>
```
