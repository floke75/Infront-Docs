---
title: "CdapiGetCommonIssuerSubSectorsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSubSectorsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetCommonIssuerSubSectorsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSubSectorsOptions.html"
defines: ["CdapiGetCommonIssuerSubSectorsOptions"]
member_count: 49
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiCommonIssuerSubSectorData"]
reference_count: 15
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSubSectorsOptionsEetCarbonFootprintSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSubSectorsOptionsEetEutaxSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSubSectorsOptionsEetExposureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSubSectorsOptionsEetManufacturerSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSubSectorsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSubSectorsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSubSectorsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSubSectorsOptionsInstrumentAdditionalSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSubSectorsOptionsListingAdditionalSource", "SDK.InfrontSDK.CoreDataAPI.CdapiCommonIssuerSubSectorData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSubSectorsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSubSectorsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSubSectorsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetCommonIssuerSubSectors"]
---

# CdapiGetCommonIssuerSubSectorsOptions

Request options for [cdapiGetCommonIssuerSubSectors](./SDK.InfrontSDK.CoreDataAPI.cdapiGetCommonIssuerSubSectors.md)

```ts
interface CdapiGetCommonIssuerSubSectorsOptions {
...
    eet_carbon_footprint_source?: CdapiGetCommonIssuerSubSectorsOptionsEetCarbonFootprintSource;
    eet_eutax_source?: CdapiGetCommonIssuerSubSectorsOptionsEetEutaxSource;
    eet_exposure_source?: CdapiGetCommonIssuerSubSectorsOptionsEetExposureSource;
    eet_manufacturer_source?: CdapiGetCommonIssuerSubSectorsOptionsEetManufacturerSource;
    eet_sfdr_pai_source?: CdapiGetCommonIssuerSubSectorsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetCommonIssuerSubSectorsOptionsEetSpiSource;
    esg_risk_source?: CdapiGetCommonIssuerSubSectorsOptionsEsgRiskSource;
...
    instrument_additional_source?: CdapiGetCommonIssuerSubSectorsOptionsInstrumentAdditionalSource;
...
    limit?: number;
    listing_additional_source?: CdapiGetCommonIssuerSubSectorsOptionsListingAdditionalSource;
    listing_id?: string | readonly string[];
    main_index_listing_id?: string;
    nsin?: string | readonly string[];
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiCommonIssuerSubSectorData>;
    onError?: CoreDataRequestErrorCallback<CdapiCommonIssuerSubSectorData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiCommonIssuerSubSectorData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetCommonIssuerSubSectorsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetCommonIssuerSubSectorsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetCommonIssuerSubSectorsSortField>
        | readonly CdapiSortField<CdapiGetCommonIssuerSubSectorsSortField>[];
...
- CdapiCommonRequestOptions<CdapiCommonIssuerSubSectorData>
