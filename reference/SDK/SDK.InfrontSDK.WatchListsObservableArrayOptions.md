---
title: "WatchListsObservableArrayOptions"
qualified_name: "SDK.InfrontSDK.WatchListsObservableArrayOptions"
kind: interface
...
group: "WatchLists"
nav_path: "SDK > InfrontSDK > WatchLists > WatchListsObservableArrayOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.WatchListsObservableArrayOptions.html"
defines: ["WatchListsObservableArrayOptions"]
member_count: 5
members: ["signal?", "subscribe?", "onData", "onError?", "onStatus?"]
member_groups:
  "Properties": ["signal?", "subscribe?"]
  "Methods": ["onData", "onError?", "onStatus?"]
related_types: ["SDK.InfrontSDK.DataRequestOptions", "Utils.InfrontUtil.ObservableArray", "SDK.InfrontSDK.Watchlist"]
reference_count: 5
references: ["Utils.InfrontUtil.ObservableArray", "SDK.InfrontSDK.RequestStatus", "SDK.InfrontSDK.RequestDetails", "SDK.InfrontSDK.DataRequestOptions", "SDK.InfrontSDK.Watchlist"]
---

# WatchListsObservableArrayOptions

Options to request all watchlists for the current user within an ObservableArray.

```ts
interface WatchListsObservableArrayOptions {
    signal?: AbortSignal;
    subscribe?: boolean;
...
#### Hierarchy ([View Summary](../type-hierarchy.md#SDK.InfrontSDK.WatchListsObservableArrayOptions))

- DataRequestOptions<ObservableArray<Watchlist>>
