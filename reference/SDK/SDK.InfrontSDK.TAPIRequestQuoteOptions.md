---
title: "TAPIRequestQuoteOptions"
qualified_name: "SDK.InfrontSDK.TAPIRequestQuoteOptions"
kind: interface
...
group: "Other"
nav_path: "SDK > InfrontSDK > Other > TAPIRequestQuoteOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.TAPIRequestQuoteOptions.html"
defines: ["TAPIRequestQuoteOptions"]
member_count: 5
members: ["signal?", "subscribe?", "onData", "onError?", "onStatus?"]
member_groups:
  "Properties": ["signal?", "subscribe?"]
  "Methods": ["onData", "onError?", "onStatus?"]
related_types: ["SDK.InfrontSDK.DataRequestOptions", "SDK.InfrontSDK.TAPIRequestQuoteMetadata"]
reference_count: 4
references: ["SDK.InfrontSDK.TAPIRequestQuoteMetadata", "SDK.InfrontSDK.RequestStatus", "SDK.InfrontSDK.RequestDetails", "SDK.InfrontSDK.DataRequestOptions"]
---
...
```ts
interface TAPIRequestQuoteOptions {
    signal?: AbortSignal;
    subscribe?: boolean;
    onData(data: TAPIRequestQuoteMetadata[]): void;
...
#### Hierarchy ([View Summary](../type-hierarchy.md#SDK.InfrontSDK.TAPIRequestQuoteOptions))

- DataRequestOptions<TAPIRequestQuoteMetadata[]>
