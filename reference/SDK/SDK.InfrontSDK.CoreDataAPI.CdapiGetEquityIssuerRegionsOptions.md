---
title: "CdapiGetEquityIssuerRegionsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerRegionsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetEquityIssuerRegionsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerRegionsOptions.html"
defines: ["CdapiGetEquityIssuerRegionsOptions"]
member_count: 52
...
reference_count: 14
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerRegionsOptionsCompanySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerRegionsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerRegionsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerRegionsOptionsEquityIssuerEstimateKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerRegionsOptionsEquityIssuerKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerRegionsOptionsEquityKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerRegionsOptionsEquitySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerRegionsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiCommonIssuerRegionsData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerRegionsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerRegionsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerRegionsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityIssuerRegions"]
---

# CdapiGetEquityIssuerRegionsOptions

Request options for [cdapiGetEquityIssuerRegions](./SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityIssuerRegions.md)

```ts
interface CdapiGetEquityIssuerRegionsOptions {
...
    company_source?: CdapiGetEquityIssuerRegionsOptionsCompanySource;
    country_code?: string | readonly string[];
    country_id?: number | readonly number[];
    currency_code?: string | readonly string[];
    eet_sfdr_pai_source?: CdapiGetEquityIssuerRegionsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetEquityIssuerRegionsOptionsEetSpiSource;
    equity_issuer_estimate_keyfigure_source?: CdapiGetEquityIssuerRegionsOptionsEquityIssuerEstimateKeyfigureSource;
    equity_issuer_keyfigure_source?: CdapiGetEquityIssuerRegionsOptionsEquityIssuerKeyfigureSource;
    equity_keyfigure_source?: CdapiGetEquityIssuerRegionsOptionsEquityKeyfigureSource;
    equity_source?: CdapiGetEquityIssuerRegionsOptionsEquitySource;
    esg_risk_source?: CdapiGetEquityIssuerRegionsOptionsEsgRiskSource;
...
    preferred_trading_venue_strategy_code?: CdapiGetEquityIssuerRegionsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetEquityIssuerRegionsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetEquityIssuerRegionsSortField>
        | readonly CdapiSortField<CdapiGetEquityIssuerRegionsSortField>[];
