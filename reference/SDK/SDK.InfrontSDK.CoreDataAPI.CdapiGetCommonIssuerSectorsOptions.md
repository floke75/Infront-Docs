---
title: "CdapiGetCommonIssuerSectorsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSectorsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetCommonIssuerSectorsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSectorsOptions.html"
defines: ["CdapiGetCommonIssuerSectorsOptions"]
member_count: 49
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiCommonIssuerSectorData"]
reference_count: 15
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSectorsOptionsEetCarbonFootprintSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSectorsOptionsEetEutaxSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSectorsOptionsEetExposureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSectorsOptionsEetManufacturerSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSectorsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSectorsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSectorsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSectorsOptionsInstrumentAdditionalSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSectorsOptionsListingAdditionalSource", "SDK.InfrontSDK.CoreDataAPI.CdapiCommonIssuerSectorData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSectorsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSectorsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerSectorsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetCommonIssuerSectors"]
---

# CdapiGetCommonIssuerSectorsOptions

Request options for [cdapiGetCommonIssuerSectors](./SDK.InfrontSDK.CoreDataAPI.cdapiGetCommonIssuerSectors.md)

```ts
interface CdapiGetCommonIssuerSectorsOptions {
...
    eet_carbon_footprint_source?: CdapiGetCommonIssuerSectorsOptionsEetCarbonFootprintSource;
    eet_eutax_source?: CdapiGetCommonIssuerSectorsOptionsEetEutaxSource;
    eet_exposure_source?: CdapiGetCommonIssuerSectorsOptionsEetExposureSource;
    eet_manufacturer_source?: CdapiGetCommonIssuerSectorsOptionsEetManufacturerSource;
    eet_sfdr_pai_source?: CdapiGetCommonIssuerSectorsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetCommonIssuerSectorsOptionsEetSpiSource;
    esg_risk_source?: CdapiGetCommonIssuerSectorsOptionsEsgRiskSource;
...
    instrument_additional_source?: CdapiGetCommonIssuerSectorsOptionsInstrumentAdditionalSource;
...
    limit?: number;
    listing_additional_source?: CdapiGetCommonIssuerSectorsOptionsListingAdditionalSource;
    listing_id?: string | readonly string[];
    main_index_listing_id?: string;
    nsin?: string | readonly string[];
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiCommonIssuerSectorData>;
    onError?: CoreDataRequestErrorCallback<CdapiCommonIssuerSectorData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiCommonIssuerSectorData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetCommonIssuerSectorsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetCommonIssuerSectorsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetCommonIssuerSectorsSortField>
        | readonly CdapiSortField<CdapiGetCommonIssuerSectorsSortField>[];
...
- CdapiCommonRequestOptions<CdapiCommonIssuerSectorData>
