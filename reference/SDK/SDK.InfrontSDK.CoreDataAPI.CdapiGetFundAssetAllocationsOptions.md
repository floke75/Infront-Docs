---
title: "CdapiGetFundAssetAllocationsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundAssetAllocationsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetFundAssetAllocationsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetFundAssetAllocationsOptions.html"
defines: ["CdapiGetFundAssetAllocationsOptions"]
member_count: 46
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiFundAssetAllocationsData"]
reference_count: 9
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetFundAssetAllocationsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundAssetAllocationsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundAssetAllocationsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiFundAssetAllocationsData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundAssetAllocationsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundAssetAllocationsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundAssetAllocationsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetFundAssetAllocations"]
---

# CdapiGetFundAssetAllocationsOptions

Request options for [cdapiGetFundAssetAllocations](./SDK.InfrontSDK.CoreDataAPI.cdapiGetFundAssetAllocations.md)

```ts
interface CdapiGetFundAssetAllocationsOptions {
...
    eet_sfdr_pai_source?: CdapiGetFundAssetAllocationsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetFundAssetAllocationsOptionsEetSpiSource;
    efc_id?: number | readonly number[];
    esg_risk_source?: CdapiGetFundAssetAllocationsOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiFundAssetAllocationsData>;
    onError?: CoreDataRequestErrorCallback<CdapiFundAssetAllocationsData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiFundAssetAllocationsData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetFundAssetAllocationsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetFundAssetAllocationsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sfdr?: number | readonly number[];
    sort?:
        | CdapiSortField<CdapiGetFundAssetAllocationsSortField>
        | readonly CdapiSortField<CdapiGetFundAssetAllocationsSortField>[];
...
- CdapiCommonRequestOptions<CdapiFundAssetAllocationsData>
