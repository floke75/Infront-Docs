---
title: "TAPIRFQGetQuoteOptions"
qualified_name: "SDK.InfrontSDK.TAPIRFQGetQuoteOptions"
kind: interface
...
group: "Other"
nav_path: "SDK > InfrontSDK > Other > TAPIRFQGetQuoteOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.TAPIRFQGetQuoteOptions.html"
defines: ["TAPIRFQGetQuoteOptions"]
member_count: 5
members: ["signal?", "subscribe?", "onData", "onError?", "onStatus?"]
member_groups:
  "Properties": ["signal?", "subscribe?"]
  "Methods": ["onData", "onError?", "onStatus?"]
related_types: ["SDK.InfrontSDK.DataRequestOptions", "SDK.InfrontSDK.TAPIRFQGetQuoteMetadata"]
reference_count: 4
references: ["SDK.InfrontSDK.TAPIRFQGetQuoteMetadata", "SDK.InfrontSDK.RequestStatus", "SDK.InfrontSDK.RequestDetails", "SDK.InfrontSDK.DataRequestOptions"]
---

# TAPIRFQGetQuoteOptions

RFQ Quote request options.

```ts
interface TAPIRFQGetQuoteOptions {
    signal?: AbortSignal;
    subscribe?: boolean;
    onData(data: TAPIRFQGetQuoteMetadata[]): void;
...
#### Hierarchy ([View Summary](../type-hierarchy.md#SDK.InfrontSDK.TAPIRFQGetQuoteOptions))

- DataRequestOptions<TAPIRFQGetQuoteMetadata[]>
