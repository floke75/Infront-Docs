---
title: "CdapiGetFundComputePerformancesOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundComputePerformancesOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetFundComputePerformancesOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetFundComputePerformancesOptions.html"
defines: ["CdapiGetFundComputePerformancesOptions"]
member_count: 8
...
reference_count: 3
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetFundComputePerformancesOptionsAssetClassCategoryCode", "SDK.InfrontSDK.CoreDataAPI.AnalyticscalculationsPerformanceResult", "SDK.InfrontSDK.CoreDataAPI.cdapiGetFundComputePerformances"]
---

# CdapiGetFundComputePerformancesOptions

Request options for [cdapiGetFundComputePerformances](./SDK.InfrontSDK.CoreDataAPI.cdapiGetFundComputePerformances.md)

```ts
interface CdapiGetFundComputePerformancesOptions {
    asset_class_category_code?: CdapiGetFundComputePerformancesOptionsAssetClassCategoryCode;
    bvi_method?: boolean;
