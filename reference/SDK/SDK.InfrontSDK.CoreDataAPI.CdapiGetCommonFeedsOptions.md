---
title: "CdapiGetCommonFeedsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonFeedsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetCommonFeedsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonFeedsOptions.html"
defines: ["CdapiGetCommonFeedsOptions"]
member_count: 49
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiCommonFeedsData"]
reference_count: 15
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonFeedsOptionsEetCarbonFootprintSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonFeedsOptionsEetEutaxSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonFeedsOptionsEetExposureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonFeedsOptionsEetManufacturerSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonFeedsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonFeedsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonFeedsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonFeedsOptionsInstrumentAdditionalSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonFeedsOptionsListingAdditionalSource", "SDK.InfrontSDK.CoreDataAPI.CdapiCommonFeedsData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonFeedsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonFeedsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonFeedsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetCommonFeeds"]
---

# CdapiGetCommonFeedsOptions

Request options for [cdapiGetCommonFeeds](./SDK.InfrontSDK.CoreDataAPI.cdapiGetCommonFeeds.md)

```ts
interface CdapiGetCommonFeedsOptions {
...
    eet_carbon_footprint_source?: CdapiGetCommonFeedsOptionsEetCarbonFootprintSource;
    eet_eutax_source?: CdapiGetCommonFeedsOptionsEetEutaxSource;
    eet_exposure_source?: CdapiGetCommonFeedsOptionsEetExposureSource;
    eet_manufacturer_source?: CdapiGetCommonFeedsOptionsEetManufacturerSource;
    eet_sfdr_pai_source?: CdapiGetCommonFeedsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetCommonFeedsOptionsEetSpiSource;
    esg_risk_source?: CdapiGetCommonFeedsOptionsEsgRiskSource;
...
    instrument_additional_source?: CdapiGetCommonFeedsOptionsInstrumentAdditionalSource;
...
    limit?: number;
    listing_additional_source?: CdapiGetCommonFeedsOptionsListingAdditionalSource;
    listing_id?: string | readonly string[];
    main_index_listing_id?: string;
    nsin?: string | readonly string[];
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiCommonFeedsData>;
    onError?: CoreDataRequestErrorCallback<CdapiCommonFeedsData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiCommonFeedsData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetCommonFeedsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetCommonFeedsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetCommonFeedsSortField>
        | readonly CdapiSortField<CdapiGetCommonFeedsSortField>[];
...
- CdapiCommonRequestOptions<CdapiCommonFeedsData>
