---
title: "CdapiGetFundDividendFrequenciesOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundDividendFrequenciesOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetFundDividendFrequenciesOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetFundDividendFrequenciesOptions.html"
defines: ["CdapiGetFundDividendFrequenciesOptions"]
member_count: 46
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiFundDividendFrequenciesData"]
reference_count: 9
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetFundDividendFrequenciesOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundDividendFrequenciesOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundDividendFrequenciesOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiFundDividendFrequenciesData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundDividendFrequenciesOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundDividendFrequenciesOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundDividendFrequenciesSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetFundDividendFrequencies"]
---

# CdapiGetFundDividendFrequenciesOptions

Request options for [cdapiGetFundDividendFrequencies](./SDK.InfrontSDK.CoreDataAPI.cdapiGetFundDividendFrequencies.md)

```ts
interface CdapiGetFundDividendFrequenciesOptions {
...
    eet_sfdr_pai_source?: CdapiGetFundDividendFrequenciesOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetFundDividendFrequenciesOptionsEetSpiSource;
    efc_id?: number | readonly number[];
    esg_risk_source?: CdapiGetFundDividendFrequenciesOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiFundDividendFrequenciesData>;
...
    | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetFundDividendFrequenciesOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetFundDividendFrequenciesOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sfdr?: number | readonly number[];
    sort?:
        | CdapiSortField<CdapiGetFundDividendFrequenciesSortField>
        | readonly CdapiSortField<CdapiGetFundDividendFrequenciesSortField>[];
...
- CdapiCommonRequestOptions<CdapiFundDividendFrequenciesData>
...
```ts
onFinally?: CoreDataRequestFinallyCallback<CdapiFundDividendFrequenciesData>
```
