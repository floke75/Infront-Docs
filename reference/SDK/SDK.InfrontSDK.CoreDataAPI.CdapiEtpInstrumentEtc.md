---
title: "CdapiEtpInstrumentEtc"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiEtpInstrumentEtc"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiEtpInstrumentEtc"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiEtpInstrumentEtc.html"
defines: ["CdapiEtpInstrumentEtc"]
member_count: 13
...
reference_count: 2
references: ["SDK.InfrontSDK.CoreDataAPI.BasedefEntityMeta", "SDK.InfrontSDK.CoreDataAPI.CdapiEtpInstrumentEtcVolume"]
---

# CdapiEtpInstrumentEtc

InstrumentEtc represents the master data for an Exchange Traded Commodity (ETC).
An ETC is a debt instrument backed by physical commodities or commodity futures
and trades on an exchange like a stock.

#### Remarks

API Schema ID: dev.infrontfinance.cdapi.etp.InstrumentEtc

```ts
interface CdapiEtpInstrumentEtc {
...
    volume: CdapiEtpInstrumentEtcVolume;
}
```
...
ISO 3166-1 alpha-2 country code of the ETC's country of origin (e.g. "DE", "IE").
...
Date the ETC was founded / launched. ISO-8601 format recommended.
...
Indicates whether this ETC distributes income (true) or accumulates it (false).
...
Indicates whether the ETC is fully replicated or uses sampling.
...
Traded volume of the ETC. See nested Volume message for field details.
