---
title: "CdapiGetEquityIssuerSectorsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSectorsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetEquityIssuerSectorsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSectorsOptions.html"
defines: ["CdapiGetEquityIssuerSectorsOptions"]
member_count: 52
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiEquityIssuerSectorData"]
reference_count: 14
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSectorsOptionsCompanySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSectorsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSectorsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSectorsOptionsEquityIssuerEstimateKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSectorsOptionsEquityIssuerKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSectorsOptionsEquityKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSectorsOptionsEquitySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSectorsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiEquityIssuerSectorData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSectorsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSectorsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerSectorsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityIssuerSectors"]
---

# CdapiGetEquityIssuerSectorsOptions

Request options for [cdapiGetEquityIssuerSectors](./SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityIssuerSectors.md)

```ts
interface CdapiGetEquityIssuerSectorsOptions {
...
    company_source?: CdapiGetEquityIssuerSectorsOptionsCompanySource;
    country_code?: string | readonly string[];
    country_id?: number | readonly number[];
    currency_code?: string | readonly string[];
    eet_sfdr_pai_source?: CdapiGetEquityIssuerSectorsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetEquityIssuerSectorsOptionsEetSpiSource;
    equity_issuer_estimate_keyfigure_source?: CdapiGetEquityIssuerSectorsOptionsEquityIssuerEstimateKeyfigureSource;
    equity_issuer_keyfigure_source?: CdapiGetEquityIssuerSectorsOptionsEquityIssuerKeyfigureSource;
    equity_keyfigure_source?: CdapiGetEquityIssuerSectorsOptionsEquityKeyfigureSource;
    equity_source?: CdapiGetEquityIssuerSectorsOptionsEquitySource;
    esg_risk_source?: CdapiGetEquityIssuerSectorsOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiEquityIssuerSectorData>;
    onError?: CoreDataRequestErrorCallback<CdapiEquityIssuerSectorData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiEquityIssuerSectorData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetEquityIssuerSectorsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetEquityIssuerSectorsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetEquityIssuerSectorsSortField>
        | readonly CdapiSortField<CdapiGetEquityIssuerSectorsSortField>[];
...
- CdapiCommonRequestOptions<CdapiEquityIssuerSectorData>
