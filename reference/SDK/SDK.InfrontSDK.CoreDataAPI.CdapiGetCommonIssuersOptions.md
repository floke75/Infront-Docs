---
title: "CdapiGetCommonIssuersOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuersOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetCommonIssuersOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuersOptions.html"
defines: ["CdapiGetCommonIssuersOptions"]
member_count: 49
...
reference_count: 15
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuersOptionsEetCarbonFootprintSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuersOptionsEetEutaxSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuersOptionsEetExposureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuersOptionsEetManufacturerSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuersOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuersOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuersOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuersOptionsInstrumentAdditionalSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuersOptionsListingAdditionalSource", "SDK.InfrontSDK.CoreDataAPI.CdapiCommonIssuersData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuersOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuersOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuersSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetCommonIssuers"]
---

# CdapiGetCommonIssuersOptions

Request options for [cdapiGetCommonIssuers](./SDK.InfrontSDK.CoreDataAPI.cdapiGetCommonIssuers.md)

```ts
interface CdapiGetCommonIssuersOptions {
...
    eet_carbon_footprint_source?: CdapiGetCommonIssuersOptionsEetCarbonFootprintSource;
    eet_eutax_source?: CdapiGetCommonIssuersOptionsEetEutaxSource;
    eet_exposure_source?: CdapiGetCommonIssuersOptionsEetExposureSource;
    eet_manufacturer_source?: CdapiGetCommonIssuersOptionsEetManufacturerSource;
    eet_sfdr_pai_source?: CdapiGetCommonIssuersOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetCommonIssuersOptionsEetSpiSource;
    esg_risk_source?: CdapiGetCommonIssuersOptionsEsgRiskSource;
...
    instrument_additional_source?: CdapiGetCommonIssuersOptionsInstrumentAdditionalSource;
...
    limit?: number;
    listing_additional_source?: CdapiGetCommonIssuersOptionsListingAdditionalSource;
...
    preferred_trading_venue_strategy_code?: CdapiGetCommonIssuersOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetCommonIssuersOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetCommonIssuersSortField>
        | readonly CdapiSortField<CdapiGetCommonIssuersSortField>[];
