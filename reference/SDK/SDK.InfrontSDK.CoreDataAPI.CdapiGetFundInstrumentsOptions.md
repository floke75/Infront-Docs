---
title: "CdapiGetFundInstrumentsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundInstrumentsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetFundInstrumentsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetFundInstrumentsOptions.html"
defines: ["CdapiGetFundInstrumentsOptions"]
member_count: 46
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiFundInstrumentsData"]
reference_count: 9
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetFundInstrumentsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundInstrumentsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundInstrumentsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiFundInstrumentsData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundInstrumentsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundInstrumentsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundInstrumentsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetFundInstruments"]
---

# CdapiGetFundInstrumentsOptions

Request options for [cdapiGetFundInstruments](./SDK.InfrontSDK.CoreDataAPI.cdapiGetFundInstruments.md)

```ts
interface CdapiGetFundInstrumentsOptions {
...
    eet_sfdr_pai_source?: CdapiGetFundInstrumentsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetFundInstrumentsOptionsEetSpiSource;
    efc_id?: number | readonly number[];
    esg_risk_source?: CdapiGetFundInstrumentsOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiFundInstrumentsData>;
    onError?: CoreDataRequestErrorCallback<CdapiFundInstrumentsData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiFundInstrumentsData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetFundInstrumentsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetFundInstrumentsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sfdr?: number | readonly number[];
    sort?:
        | CdapiSortField<CdapiGetFundInstrumentsSortField>
        | readonly CdapiSortField<CdapiGetFundInstrumentsSortField>[];
...
- CdapiCommonRequestOptions<CdapiFundInstrumentsData>
