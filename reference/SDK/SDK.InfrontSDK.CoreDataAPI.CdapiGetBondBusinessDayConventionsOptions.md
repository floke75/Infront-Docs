---
title: "CdapiGetBondBusinessDayConventionsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondBusinessDayConventionsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetBondBusinessDayConventionsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetBondBusinessDayConventionsOptions.html"
defines: ["CdapiGetBondBusinessDayConventionsOptions"]
member_count: 52
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiBondListBusinessDayConventionsData"]
reference_count: 9
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetBondBusinessDayConventionsOptionsBondKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondBusinessDayConventionsOptionsBondSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondBusinessDayConventionsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondBusinessDayConventionsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondBusinessDayConventionsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiBondListBusinessDayConventionsData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondBusinessDayConventionsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetBondBusinessDayConventionsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.cdapiGetBondBusinessDayConventions"]
---

# CdapiGetBondBusinessDayConventionsOptions

Request options for [cdapiGetBondBusinessDayConventions](./SDK.InfrontSDK.CoreDataAPI.cdapiGetBondBusinessDayConventions.md)

```ts
interface CdapiGetBondBusinessDayConventionsOptions {
...
    bond_keyfigure_source?: CdapiGetBondBusinessDayConventionsOptionsBondKeyfigureSource;
    bond_source?: CdapiGetBondBusinessDayConventionsOptionsBondSource;
...
    eet_sfdr_pai_source?: CdapiGetBondBusinessDayConventionsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetBondBusinessDayConventionsOptionsEetSpiSource;
    esg_risk_source?: CdapiGetBondBusinessDayConventionsOptionsEsgRiskSource;
...
    | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetBondBusinessDayConventionsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetBondBusinessDayConventionsOptionsRatingSource;
...
- CdapiCommonRequestOptions<CdapiBondListBusinessDayConventionsData>
...
```ts
onData?: CoreDataRequestSuccessCallback<CdapiBondListBusinessDayConventionsData>
```
...
```ts
onError?: CoreDataRequestErrorCallback<CdapiBondListBusinessDayConventionsData>
```
