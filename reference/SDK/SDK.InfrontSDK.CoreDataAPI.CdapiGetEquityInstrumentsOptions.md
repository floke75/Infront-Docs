---
title: "CdapiGetEquityInstrumentsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityInstrumentsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetEquityInstrumentsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityInstrumentsOptions.html"
defines: ["CdapiGetEquityInstrumentsOptions"]
member_count: 52
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiEquityInstrumentsData"]
reference_count: 14
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityInstrumentsOptionsCompanySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityInstrumentsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityInstrumentsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityInstrumentsOptionsEquityIssuerEstimateKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityInstrumentsOptionsEquityIssuerKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityInstrumentsOptionsEquityKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityInstrumentsOptionsEquitySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityInstrumentsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiEquityInstrumentsData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityInstrumentsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityInstrumentsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityInstrumentsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityInstruments"]
---

# CdapiGetEquityInstrumentsOptions

Request options for [cdapiGetEquityInstruments](./SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityInstruments.md)

```ts
interface CdapiGetEquityInstrumentsOptions {
...
    company_source?: CdapiGetEquityInstrumentsOptionsCompanySource;
    country_code?: string | readonly string[];
    country_id?: number | readonly number[];
    currency_code?: string | readonly string[];
    eet_sfdr_pai_source?: CdapiGetEquityInstrumentsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetEquityInstrumentsOptionsEetSpiSource;
    equity_issuer_estimate_keyfigure_source?: CdapiGetEquityInstrumentsOptionsEquityIssuerEstimateKeyfigureSource;
    equity_issuer_keyfigure_source?: CdapiGetEquityInstrumentsOptionsEquityIssuerKeyfigureSource;
    equity_keyfigure_source?: CdapiGetEquityInstrumentsOptionsEquityKeyfigureSource;
    equity_source?: CdapiGetEquityInstrumentsOptionsEquitySource;
    esg_risk_source?: CdapiGetEquityInstrumentsOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiEquityInstrumentsData>;
    onError?: CoreDataRequestErrorCallback<CdapiEquityInstrumentsData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiEquityInstrumentsData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetEquityInstrumentsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetEquityInstrumentsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetEquityInstrumentsSortField>
        | readonly CdapiSortField<CdapiGetEquityInstrumentsSortField>[];
...
- CdapiCommonRequestOptions<CdapiEquityInstrumentsData>
