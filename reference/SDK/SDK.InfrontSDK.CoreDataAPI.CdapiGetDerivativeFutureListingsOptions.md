---
title: "CdapiGetDerivativeFutureListingsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetDerivativeFutureListingsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetDerivativeFutureListingsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetDerivativeFutureListingsOptions.html"
defines: ["CdapiGetDerivativeFutureListingsOptions"]
member_count: 33
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiDerivativeListingsFutureData"]
reference_count: 7
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetDerivativeFutureListingsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetDerivativeFutureListingsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetDerivativeFutureListingsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiDerivativeListingsFutureData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetDerivativeFutureListingsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetDerivativeFutureListingsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.cdapiGetDerivativeFutureListings"]
---

# CdapiGetDerivativeFutureListingsOptions

Request options for [cdapiGetDerivativeFutureListings](./SDK.InfrontSDK.CoreDataAPI.cdapiGetDerivativeFutureListings.md)

```ts
interface CdapiGetDerivativeFutureListingsOptions {
...
    eet_sfdr_pai_source?: CdapiGetDerivativeFutureListingsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetDerivativeFutureListingsOptionsEetSpiSource;
    esg_risk_source?: CdapiGetDerivativeFutureListingsOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiDerivativeListingsFutureData>;
...
    | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetDerivativeFutureListingsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetDerivativeFutureListingsOptionsRatingSource;
...
- CdapiCommonRequestOptions<CdapiDerivativeListingsFutureData>
...
```ts
onFinally?: CoreDataRequestFinallyCallback<CdapiDerivativeListingsFutureData>
```
