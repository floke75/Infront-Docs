---
title: "CdapiGetEquityIssuerCountriesOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerCountriesOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetEquityIssuerCountriesOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerCountriesOptions.html"
defines: ["CdapiGetEquityIssuerCountriesOptions"]
member_count: 52
...
reference_count: 14
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerCountriesOptionsCompanySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerCountriesOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerCountriesOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerCountriesOptionsEquityIssuerEstimateKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerCountriesOptionsEquityIssuerKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerCountriesOptionsEquityKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerCountriesOptionsEquitySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerCountriesOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiCommonIssuerCountriesData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerCountriesOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerCountriesOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuerCountriesSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityIssuerCountries"]
---

# CdapiGetEquityIssuerCountriesOptions

Request options for [cdapiGetEquityIssuerCountries](./SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityIssuerCountries.md)

```ts
interface CdapiGetEquityIssuerCountriesOptions {
...
    company_source?: CdapiGetEquityIssuerCountriesOptionsCompanySource;
    country_code?: string | readonly string[];
    country_id?: number | readonly number[];
    currency_code?: string | readonly string[];
    eet_sfdr_pai_source?: CdapiGetEquityIssuerCountriesOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetEquityIssuerCountriesOptionsEetSpiSource;
    equity_issuer_estimate_keyfigure_source?: CdapiGetEquityIssuerCountriesOptionsEquityIssuerEstimateKeyfigureSource;
    equity_issuer_keyfigure_source?: CdapiGetEquityIssuerCountriesOptionsEquityIssuerKeyfigureSource;
    equity_keyfigure_source?: CdapiGetEquityIssuerCountriesOptionsEquityKeyfigureSource;
    equity_source?: CdapiGetEquityIssuerCountriesOptionsEquitySource;
    esg_risk_source?: CdapiGetEquityIssuerCountriesOptionsEsgRiskSource;
...
    preferred_trading_venue_strategy_code?: CdapiGetEquityIssuerCountriesOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetEquityIssuerCountriesOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetEquityIssuerCountriesSortField>
        | readonly CdapiSortField<CdapiGetEquityIssuerCountriesSortField>[];
