---
title: "CdapiGetFundCompartmentsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundCompartmentsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetFundCompartmentsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetFundCompartmentsOptions.html"
defines: ["CdapiGetFundCompartmentsOptions"]
member_count: 46
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiFundCompartmentsData"]
reference_count: 9
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetFundCompartmentsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundCompartmentsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundCompartmentsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiFundCompartmentsData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundCompartmentsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundCompartmentsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundCompartmentsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetFundCompartments"]
---

# CdapiGetFundCompartmentsOptions

Request options for [cdapiGetFundCompartments](./SDK.InfrontSDK.CoreDataAPI.cdapiGetFundCompartments.md)

```ts
interface CdapiGetFundCompartmentsOptions {
...
    eet_sfdr_pai_source?: CdapiGetFundCompartmentsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetFundCompartmentsOptionsEetSpiSource;
    efc_id?: number | readonly number[];
    esg_risk_source?: CdapiGetFundCompartmentsOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiFundCompartmentsData>;
    onError?: CoreDataRequestErrorCallback<CdapiFundCompartmentsData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiFundCompartmentsData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetFundCompartmentsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetFundCompartmentsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sfdr?: number | readonly number[];
    sort?:
        | CdapiSortField<CdapiGetFundCompartmentsSortField>
        | readonly CdapiSortField<CdapiGetFundCompartmentsSortField>[];
...
- CdapiCommonRequestOptions<CdapiFundCompartmentsData>
