---
title: "CdapiGetCommonIssuerRegionsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerRegionsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetCommonIssuerRegionsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerRegionsOptions.html"
defines: ["CdapiGetCommonIssuerRegionsOptions"]
member_count: 49
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiCommonIssuerRegionsData"]
reference_count: 15
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerRegionsOptionsEetCarbonFootprintSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerRegionsOptionsEetEutaxSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerRegionsOptionsEetExposureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerRegionsOptionsEetManufacturerSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerRegionsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerRegionsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerRegionsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerRegionsOptionsInstrumentAdditionalSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerRegionsOptionsListingAdditionalSource", "SDK.InfrontSDK.CoreDataAPI.CdapiCommonIssuerRegionsData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerRegionsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerRegionsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonIssuerRegionsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetCommonIssuerRegions"]
---

# CdapiGetCommonIssuerRegionsOptions

Request options for [cdapiGetCommonIssuerRegions](./SDK.InfrontSDK.CoreDataAPI.cdapiGetCommonIssuerRegions.md)

```ts
interface CdapiGetCommonIssuerRegionsOptions {
...
    eet_carbon_footprint_source?: CdapiGetCommonIssuerRegionsOptionsEetCarbonFootprintSource;
    eet_eutax_source?: CdapiGetCommonIssuerRegionsOptionsEetEutaxSource;
    eet_exposure_source?: CdapiGetCommonIssuerRegionsOptionsEetExposureSource;
    eet_manufacturer_source?: CdapiGetCommonIssuerRegionsOptionsEetManufacturerSource;
    eet_sfdr_pai_source?: CdapiGetCommonIssuerRegionsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetCommonIssuerRegionsOptionsEetSpiSource;
    esg_risk_source?: CdapiGetCommonIssuerRegionsOptionsEsgRiskSource;
...
    instrument_additional_source?: CdapiGetCommonIssuerRegionsOptionsInstrumentAdditionalSource;
...
    limit?: number;
    listing_additional_source?: CdapiGetCommonIssuerRegionsOptionsListingAdditionalSource;
    listing_id?: string | readonly string[];
    main_index_listing_id?: string;
    nsin?: string | readonly string[];
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiCommonIssuerRegionsData>;
    onError?: CoreDataRequestErrorCallback<CdapiCommonIssuerRegionsData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiCommonIssuerRegionsData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetCommonIssuerRegionsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetCommonIssuerRegionsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetCommonIssuerRegionsSortField>
        | readonly CdapiSortField<CdapiGetCommonIssuerRegionsSortField>[];
...
- CdapiCommonRequestOptions<CdapiCommonIssuerRegionsData>
