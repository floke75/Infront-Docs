---
title: "CdapiGetCommonCountriesOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonCountriesOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetCommonCountriesOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonCountriesOptions.html"
defines: ["CdapiGetCommonCountriesOptions"]
member_count: 49
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiCommonCountriesData"]
reference_count: 15
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonCountriesOptionsEetCarbonFootprintSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonCountriesOptionsEetEutaxSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonCountriesOptionsEetExposureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonCountriesOptionsEetManufacturerSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonCountriesOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonCountriesOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonCountriesOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonCountriesOptionsInstrumentAdditionalSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonCountriesOptionsListingAdditionalSource", "SDK.InfrontSDK.CoreDataAPI.CdapiCommonCountriesData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonCountriesOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonCountriesOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetCommonCountriesSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetCommonCountries"]
---

# CdapiGetCommonCountriesOptions

Request options for [cdapiGetCommonCountries](./SDK.InfrontSDK.CoreDataAPI.cdapiGetCommonCountries.md)

```ts
interface CdapiGetCommonCountriesOptions {
...
    eet_carbon_footprint_source?: CdapiGetCommonCountriesOptionsEetCarbonFootprintSource;
    eet_eutax_source?: CdapiGetCommonCountriesOptionsEetEutaxSource;
    eet_exposure_source?: CdapiGetCommonCountriesOptionsEetExposureSource;
    eet_manufacturer_source?: CdapiGetCommonCountriesOptionsEetManufacturerSource;
    eet_sfdr_pai_source?: CdapiGetCommonCountriesOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetCommonCountriesOptionsEetSpiSource;
    esg_risk_source?: CdapiGetCommonCountriesOptionsEsgRiskSource;
...
    instrument_additional_source?: CdapiGetCommonCountriesOptionsInstrumentAdditionalSource;
...
    limit?: number;
    listing_additional_source?: CdapiGetCommonCountriesOptionsListingAdditionalSource;
    listing_id?: string | readonly string[];
    main_index_listing_id?: string;
    nsin?: string | readonly string[];
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiCommonCountriesData>;
    onError?: CoreDataRequestErrorCallback<CdapiCommonCountriesData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiCommonCountriesData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetCommonCountriesOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetCommonCountriesOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetCommonCountriesSortField>
        | readonly CdapiSortField<CdapiGetCommonCountriesSortField>[];
...
- CdapiCommonRequestOptions<CdapiCommonCountriesData>
