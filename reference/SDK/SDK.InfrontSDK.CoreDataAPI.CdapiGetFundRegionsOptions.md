---
title: "CdapiGetFundRegionsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundRegionsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetFundRegionsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetFundRegionsOptions.html"
defines: ["CdapiGetFundRegionsOptions"]
member_count: 46
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiFundRegionsData"]
reference_count: 9
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetFundRegionsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundRegionsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundRegionsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiFundRegionsData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundRegionsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundRegionsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundRegionsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetFundRegions"]
---

# CdapiGetFundRegionsOptions

Request options for [cdapiGetFundRegions](./SDK.InfrontSDK.CoreDataAPI.cdapiGetFundRegions.md)

```ts
interface CdapiGetFundRegionsOptions {
...
    eet_sfdr_pai_source?: CdapiGetFundRegionsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetFundRegionsOptionsEetSpiSource;
    efc_id?: number | readonly number[];
    esg_risk_source?: CdapiGetFundRegionsOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiFundRegionsData>;
    onError?: CoreDataRequestErrorCallback<CdapiFundRegionsData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiFundRegionsData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetFundRegionsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetFundRegionsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sfdr?: number | readonly number[];
    sort?:
        | CdapiSortField<CdapiGetFundRegionsSortField>
        | readonly CdapiSortField<CdapiGetFundRegionsSortField>[];
...
- CdapiCommonRequestOptions<CdapiFundRegionsData>
