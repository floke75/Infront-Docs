---
title: "CdapiGetEquityClassificationGicsSubIndustriesOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSubIndustriesOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetEquityClassificationGicsSubIndustriesOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSubIndustriesOptions.html"
defines: ["CdapiGetEquityClassificationGicsSubIndustriesOptions"]
member_count: 52
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiEquityGicsSubIndustriesData"]
reference_count: 14
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSubIndustriesOptionsCompanySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSubIndustriesOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSubIndustriesOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSubIndustriesOptionsEquityIssuerEstimateKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSubIndustriesOptionsEquityIssuerKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSubIndustriesOptionsEquityKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSubIndustriesOptionsEquitySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSubIndustriesOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiEquityGicsSubIndustriesData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSubIndustriesOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSubIndustriesOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSubIndustriesSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityClassificationGicsSubIndustries"]
---

# CdapiGetEquityClassificationGicsSubIndustriesOptions

Request options for [cdapiGetEquityClassificationGicsSubIndustries](./SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityClassificationGicsSubIndustries.md)

```ts
interface CdapiGetEquityClassificationGicsSubIndustriesOptions {
...
    company_source?: CdapiGetEquityClassificationGicsSubIndustriesOptionsCompanySource;
    country_code?: string | readonly string[];
    country_id?: number | readonly number[];
    currency_code?: string | readonly string[];
    eet_sfdr_pai_source?: CdapiGetEquityClassificationGicsSubIndustriesOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetEquityClassificationGicsSubIndustriesOptionsEetSpiSource;
    equity_issuer_estimate_keyfigure_source?: CdapiGetEquityClassificationGicsSubIndustriesOptionsEquityIssuerEstimateKeyfigureSource;
    equity_issuer_keyfigure_source?: CdapiGetEquityClassificationGicsSubIndustriesOptionsEquityIssuerKeyfigureSource;
    equity_keyfigure_source?: CdapiGetEquityClassificationGicsSubIndustriesOptionsEquityKeyfigureSource;
    equity_source?: CdapiGetEquityClassificationGicsSubIndustriesOptionsEquitySource;
    esg_risk_source?: CdapiGetEquityClassificationGicsSubIndustriesOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiEquityGicsSubIndustriesData>;
...
    | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetEquityClassificationGicsSubIndustriesOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetEquityClassificationGicsSubIndustriesOptionsRatingSource;
...
- CdapiCommonRequestOptions<CdapiEquityGicsSubIndustriesData>
...
```ts
onFinally?: CoreDataRequestFinallyCallback<CdapiEquityGicsSubIndustriesData>
```
...
```ts
sort?:
    | CdapiSortField<CdapiGetEquityClassificationGicsSubIndustriesSortField>
    | readonly CdapiSortField<
        CdapiGetEquityClassificationGicsSubIndustriesSortField,
    >[]
```
