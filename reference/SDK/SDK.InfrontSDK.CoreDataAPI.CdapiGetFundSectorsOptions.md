---
title: "CdapiGetFundSectorsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundSectorsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetFundSectorsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetFundSectorsOptions.html"
defines: ["CdapiGetFundSectorsOptions"]
member_count: 46
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiFundSectorsData"]
reference_count: 9
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetFundSectorsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundSectorsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundSectorsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiFundSectorsData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundSectorsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundSectorsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundSectorsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetFundSectors"]
---

# CdapiGetFundSectorsOptions

Request options for [cdapiGetFundSectors](./SDK.InfrontSDK.CoreDataAPI.cdapiGetFundSectors.md)

```ts
interface CdapiGetFundSectorsOptions {
...
    eet_sfdr_pai_source?: CdapiGetFundSectorsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetFundSectorsOptionsEetSpiSource;
    efc_id?: number | readonly number[];
    esg_risk_source?: CdapiGetFundSectorsOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiFundSectorsData>;
    onError?: CoreDataRequestErrorCallback<CdapiFundSectorsData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiFundSectorsData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetFundSectorsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetFundSectorsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sfdr?: number | readonly number[];
    sort?:
        | CdapiSortField<CdapiGetFundSectorsSortField>
        | readonly CdapiSortField<CdapiGetFundSectorsSortField>[];
...
- CdapiCommonRequestOptions<CdapiFundSectorsData>
