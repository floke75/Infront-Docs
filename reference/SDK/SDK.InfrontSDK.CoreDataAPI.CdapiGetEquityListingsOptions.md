---
title: "CdapiGetEquityListingsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityListingsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetEquityListingsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityListingsOptions.html"
defines: ["CdapiGetEquityListingsOptions"]
member_count: 52
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiEquityListingsData"]
reference_count: 14
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityListingsOptionsCompanySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityListingsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityListingsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityListingsOptionsEquityIssuerEstimateKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityListingsOptionsEquityIssuerKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityListingsOptionsEquityKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityListingsOptionsEquitySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityListingsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiEquityListingsData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityListingsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityListingsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityListingsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityListings"]
---

# CdapiGetEquityListingsOptions

Request options for [cdapiGetEquityListings](./SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityListings.md)

```ts
interface CdapiGetEquityListingsOptions {
...
    company_source?: CdapiGetEquityListingsOptionsCompanySource;
    country_code?: string | readonly string[];
    country_id?: number | readonly number[];
    currency_code?: string | readonly string[];
    eet_sfdr_pai_source?: CdapiGetEquityListingsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetEquityListingsOptionsEetSpiSource;
    equity_issuer_estimate_keyfigure_source?: CdapiGetEquityListingsOptionsEquityIssuerEstimateKeyfigureSource;
    equity_issuer_keyfigure_source?: CdapiGetEquityListingsOptionsEquityIssuerKeyfigureSource;
    equity_keyfigure_source?: CdapiGetEquityListingsOptionsEquityKeyfigureSource;
    equity_source?: CdapiGetEquityListingsOptionsEquitySource;
    esg_risk_source?: CdapiGetEquityListingsOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiEquityListingsData>;
    onError?: CoreDataRequestErrorCallback<CdapiEquityListingsData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiEquityListingsData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetEquityListingsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetEquityListingsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetEquityListingsSortField>
        | readonly CdapiSortField<CdapiGetEquityListingsSortField>[];
...
- CdapiCommonRequestOptions<CdapiEquityListingsData>
