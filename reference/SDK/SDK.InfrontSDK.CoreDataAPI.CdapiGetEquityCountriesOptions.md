---
title: "CdapiGetEquityCountriesOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityCountriesOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetEquityCountriesOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityCountriesOptions.html"
defines: ["CdapiGetEquityCountriesOptions"]
member_count: 52
...
reference_count: 14
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityCountriesOptionsCompanySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityCountriesOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityCountriesOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityCountriesOptionsEquityIssuerEstimateKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityCountriesOptionsEquityIssuerKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityCountriesOptionsEquityKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityCountriesOptionsEquitySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityCountriesOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiCommonCountriesData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityCountriesOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityCountriesOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityCountriesSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityCountries"]
---

# CdapiGetEquityCountriesOptions

Request options for [cdapiGetEquityCountries](./SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityCountries.md)

```ts
interface CdapiGetEquityCountriesOptions {
...
    company_source?: CdapiGetEquityCountriesOptionsCompanySource;
    country_code?: string | readonly string[];
    country_id?: number | readonly number[];
    currency_code?: string | readonly string[];
    eet_sfdr_pai_source?: CdapiGetEquityCountriesOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetEquityCountriesOptionsEetSpiSource;
    equity_issuer_estimate_keyfigure_source?: CdapiGetEquityCountriesOptionsEquityIssuerEstimateKeyfigureSource;
    equity_issuer_keyfigure_source?: CdapiGetEquityCountriesOptionsEquityIssuerKeyfigureSource;
    equity_keyfigure_source?: CdapiGetEquityCountriesOptionsEquityKeyfigureSource;
    equity_source?: CdapiGetEquityCountriesOptionsEquitySource;
    esg_risk_source?: CdapiGetEquityCountriesOptionsEsgRiskSource;
...
    preferred_trading_venue_strategy_code?: CdapiGetEquityCountriesOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetEquityCountriesOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetEquityCountriesSortField>
        | readonly CdapiSortField<CdapiGetEquityCountriesSortField>[];
