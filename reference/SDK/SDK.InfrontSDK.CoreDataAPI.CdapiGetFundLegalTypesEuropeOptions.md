---
title: "CdapiGetFundLegalTypesEuropeOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundLegalTypesEuropeOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetFundLegalTypesEuropeOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetFundLegalTypesEuropeOptions.html"
defines: ["CdapiGetFundLegalTypesEuropeOptions"]
member_count: 46
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiFundLegalTypesEuropeData"]
reference_count: 9
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetFundLegalTypesEuropeOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundLegalTypesEuropeOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundLegalTypesEuropeOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiFundLegalTypesEuropeData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundLegalTypesEuropeOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundLegalTypesEuropeOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundLegalTypesEuropeSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetFundLegalTypesEurope"]
---

# CdapiGetFundLegalTypesEuropeOptions

Request options for [cdapiGetFundLegalTypesEurope](./SDK.InfrontSDK.CoreDataAPI.cdapiGetFundLegalTypesEurope.md)

```ts
interface CdapiGetFundLegalTypesEuropeOptions {
...
    eet_sfdr_pai_source?: CdapiGetFundLegalTypesEuropeOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetFundLegalTypesEuropeOptionsEetSpiSource;
    efc_id?: number | readonly number[];
    esg_risk_source?: CdapiGetFundLegalTypesEuropeOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiFundLegalTypesEuropeData>;
    onError?: CoreDataRequestErrorCallback<CdapiFundLegalTypesEuropeData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiFundLegalTypesEuropeData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetFundLegalTypesEuropeOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetFundLegalTypesEuropeOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sfdr?: number | readonly number[];
    sort?:
        | CdapiSortField<CdapiGetFundLegalTypesEuropeSortField>
        | readonly CdapiSortField<CdapiGetFundLegalTypesEuropeSortField>[];
...
- CdapiCommonRequestOptions<CdapiFundLegalTypesEuropeData>
