---
title: "CdapiGetEquityClassificationGicsSectorsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSectorsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetEquityClassificationGicsSectorsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSectorsOptions.html"
defines: ["CdapiGetEquityClassificationGicsSectorsOptions"]
member_count: 52
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiEquityGicsSectorsData"]
reference_count: 14
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSectorsOptionsCompanySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSectorsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSectorsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSectorsOptionsEquityIssuerEstimateKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSectorsOptionsEquityIssuerKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSectorsOptionsEquityKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSectorsOptionsEquitySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSectorsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiEquityGicsSectorsData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSectorsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSectorsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsSectorsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityClassificationGicsSectors"]
---

# CdapiGetEquityClassificationGicsSectorsOptions

Request options for [cdapiGetEquityClassificationGicsSectors](./SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityClassificationGicsSectors.md)

```ts
interface CdapiGetEquityClassificationGicsSectorsOptions {
...
    company_source?: CdapiGetEquityClassificationGicsSectorsOptionsCompanySource;
    country_code?: string | readonly string[];
    country_id?: number | readonly number[];
    currency_code?: string | readonly string[];
    eet_sfdr_pai_source?: CdapiGetEquityClassificationGicsSectorsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetEquityClassificationGicsSectorsOptionsEetSpiSource;
    equity_issuer_estimate_keyfigure_source?: CdapiGetEquityClassificationGicsSectorsOptionsEquityIssuerEstimateKeyfigureSource;
    equity_issuer_keyfigure_source?: CdapiGetEquityClassificationGicsSectorsOptionsEquityIssuerKeyfigureSource;
    equity_keyfigure_source?: CdapiGetEquityClassificationGicsSectorsOptionsEquityKeyfigureSource;
    equity_source?: CdapiGetEquityClassificationGicsSectorsOptionsEquitySource;
    esg_risk_source?: CdapiGetEquityClassificationGicsSectorsOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiEquityGicsSectorsData>;
    onError?: CoreDataRequestErrorCallback<CdapiEquityGicsSectorsData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiEquityGicsSectorsData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetEquityClassificationGicsSectorsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetEquityClassificationGicsSectorsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetEquityClassificationGicsSectorsSortField>
        | readonly CdapiSortField<
            CdapiGetEquityClassificationGicsSectorsSortField,
        >[];
...
- CdapiCommonRequestOptions<CdapiEquityGicsSectorsData>
...
sort?:
    | CdapiSortField<CdapiGetEquityClassificationGicsSectorsSortField>
    | readonly CdapiSortField<CdapiGetEquityClassificationGicsSectorsSortField>[]
```
