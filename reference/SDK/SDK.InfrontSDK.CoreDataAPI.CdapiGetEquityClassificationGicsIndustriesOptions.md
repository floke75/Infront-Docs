---
title: "CdapiGetEquityClassificationGicsIndustriesOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsIndustriesOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetEquityClassificationGicsIndustriesOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsIndustriesOptions.html"
defines: ["CdapiGetEquityClassificationGicsIndustriesOptions"]
member_count: 52
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiEquityGicsIndustriesData"]
reference_count: 14
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsIndustriesOptionsCompanySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsIndustriesOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsIndustriesOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsIndustriesOptionsEquityIssuerEstimateKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsIndustriesOptionsEquityIssuerKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsIndustriesOptionsEquityKeyfigureSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsIndustriesOptionsEquitySource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsIndustriesOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiEquityGicsIndustriesData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsIndustriesOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsIndustriesOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityClassificationGicsIndustriesSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityClassificationGicsIndustries"]
---

# CdapiGetEquityClassificationGicsIndustriesOptions

Request options for [cdapiGetEquityClassificationGicsIndustries](./SDK.InfrontSDK.CoreDataAPI.cdapiGetEquityClassificationGicsIndustries.md)

```ts
interface CdapiGetEquityClassificationGicsIndustriesOptions {
...
    company_source?: CdapiGetEquityClassificationGicsIndustriesOptionsCompanySource;
    country_code?: string | readonly string[];
    country_id?: number | readonly number[];
    currency_code?: string | readonly string[];
    eet_sfdr_pai_source?: CdapiGetEquityClassificationGicsIndustriesOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetEquityClassificationGicsIndustriesOptionsEetSpiSource;
    equity_issuer_estimate_keyfigure_source?: CdapiGetEquityClassificationGicsIndustriesOptionsEquityIssuerEstimateKeyfigureSource;
    equity_issuer_keyfigure_source?: CdapiGetEquityClassificationGicsIndustriesOptionsEquityIssuerKeyfigureSource;
    equity_keyfigure_source?: CdapiGetEquityClassificationGicsIndustriesOptionsEquityKeyfigureSource;
    equity_source?: CdapiGetEquityClassificationGicsIndustriesOptionsEquitySource;
    esg_risk_source?: CdapiGetEquityClassificationGicsIndustriesOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiEquityGicsIndustriesData>;
    onError?: CoreDataRequestErrorCallback<CdapiEquityGicsIndustriesData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiEquityGicsIndustriesData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetEquityClassificationGicsIndustriesOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetEquityClassificationGicsIndustriesOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sort?:
        | CdapiSortField<CdapiGetEquityClassificationGicsIndustriesSortField>
...
- CdapiCommonRequestOptions<CdapiEquityGicsIndustriesData>
