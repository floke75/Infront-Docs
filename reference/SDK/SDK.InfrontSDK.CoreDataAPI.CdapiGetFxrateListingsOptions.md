---
title: "CdapiGetFxrateListingsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetFxrateListingsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetFxrateListingsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetFxrateListingsOptions.html"
defines: ["CdapiGetFxrateListingsOptions"]
member_count: 24
members: ["asset_class_category_code?", "asset_class_group_code?", "chunk_size?", "country_code?", "currency_code?", "from_currency_code?", "id?", "ids_feed_number?", "ids_ticker?", "instrument_id?", "isin?", "issuer_id?", "lei?", "limit?", "listing_id?", "nsin?", "offset?", "onData?", "onError?", "onFinally?", "search_string?", "to_currency_code?", "trading_venue_code?", "vwd_key?"]
member_groups:
  "Properties": ["asset_class_category_code?", "asset_class_group_code?", "chunk_size?", "country_code?", "currency_code?", "from_currency_code?", "id?", "ids_feed_number?", "ids_ticker?", "instrument_id?", "isin?", "issuer_id?", "lei?", "limit?", "listing_id?", "nsin?", "offset?", "onData?", "onError?", "onFinally?", "search_string?", "to_currency_code?", "trading_venue_code?", "vwd_key?"]
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiFxrateListingsData"]
reference_count: 2
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiFxrateListingsData", "SDK.InfrontSDK.CoreDataAPI.cdapiGetFxrateListings"]
---

# CdapiGetFxrateListingsOptions

Request options for [cdapiGetFxrateListings](./SDK.InfrontSDK.CoreDataAPI.cdapiGetFxrateListings.md)

```ts
interface CdapiGetFxrateListingsOptions {
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiFxrateListingsData>;
    onError?: CoreDataRequestErrorCallback<CdapiFxrateListingsData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiFxrateListingsData>;
...
- CdapiCommonRequestOptions<CdapiFxrateListingsData>
