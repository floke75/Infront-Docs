---
title: "CdapiGetFundListingsOptions"
qualified_name: "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundListingsOptions"
kind: interface
...
group: "CoreDataAPI"
nav_path: "SDK > InfrontSDK > Other > CoreDataAPI > CdapiGetFundListingsOptions"
source_url: "https://docs.infrontfinance.com/docs/interfaces/SDK.InfrontSDK.CoreDataAPI.CdapiGetFundListingsOptions.html"
defines: ["CdapiGetFundListingsOptions"]
member_count: 46
...
related_types: ["SDK.InfrontSDK.CoreDataAPI.CdapiFundListingsData"]
reference_count: 9
references: ["SDK.InfrontSDK.CoreDataAPI.CdapiGetFundListingsOptionsEetSfdrPaiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundListingsOptionsEetSpiSource", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundListingsOptionsEsgRiskSource", "SDK.InfrontSDK.CoreDataAPI.CdapiFundListingsData", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundListingsOptionsPreferredTradingVenueStrategyCode", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundListingsOptionsRatingSource", "SDK.InfrontSDK.CoreDataAPI.CdapiSortField", "SDK.InfrontSDK.CoreDataAPI.CdapiGetFundListingsSortField", "SDK.InfrontSDK.CoreDataAPI.cdapiGetFundListings"]
---

# CdapiGetFundListingsOptions

Request options for [cdapiGetFundListings](./SDK.InfrontSDK.CoreDataAPI.cdapiGetFundListings.md)

```ts
interface CdapiGetFundListingsOptions {
...
    eet_sfdr_pai_source?: CdapiGetFundListingsOptionsEetSfdrPaiSource;
    eet_spi_source?: CdapiGetFundListingsOptionsEetSpiSource;
    efc_id?: number | readonly number[];
    esg_risk_source?: CdapiGetFundListingsOptionsEsgRiskSource;
...
    offset?: number;
    onData?: CoreDataRequestSuccessCallback<CdapiFundListingsData>;
    onError?: CoreDataRequestErrorCallback<CdapiFundListingsData>;
    onFinally?: CoreDataRequestFinallyCallback<CdapiFundListingsData>;
    operating_mic_code?: string | readonly string[];
    preferred_trading_venue_strategy_code?: CdapiGetFundListingsOptionsPreferredTradingVenueStrategyCode;
    rating_source?: CdapiGetFundListingsOptionsRatingSource;
    search_string?: string;
    sector_id?: number | readonly number[];
    segment_mic_code?: string | readonly string[];
    sfdr?: number | readonly number[];
    sort?:
        | CdapiSortField<CdapiGetFundListingsSortField>
        | readonly CdapiSortField<CdapiGetFundListingsSortField>[];
...
- CdapiCommonRequestOptions<CdapiFundListingsData>
