---
title: "PortfolioSingleValueWidgetOptions"
qualified_name: "WTK.PortfolioSingleValueWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > PortfolioSingleValueWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.PortfolioSingleValueWidgetOptions.html"
defines: ["PortfolioSingleValueWidgetOptions"]
member_count: 41
members: ["hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "name", "onClick", "onValueItemEmpty", "valueName", "decimals", "defaultContent", "instrument", "allowZero", "blinkDuration", "blinkType", "className?", "column", "compute", "computeFields", "content", "currencyClassName?", "dataItem", "dataType", "enableChangeStatusColors", "hover?", "rootElement", "showCurrency", "translate?", "type?"]
member_groups:
  ...
  "PortfolioSingleValueWidget": ["name", "onClick", "onValueItemEmpty", "valueName"]
  "SingleInstrumentWidget": ["decimals", "defaultContent", "instrument"]
  "ValueWidget": ["allowZero", "blinkDuration", "blinkType", "className?", "column", "compute", "computeFields", "content", "currencyClassName?", "dataItem", "dataType", "enableChangeStatusColors", "hover?", "rootElement", "showCurrency", "translate?", "type?"]
related_types: ["WTK.ValueWidgetOptions"]
reference_count: 10
references: ["WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.BlinkDuration", "WTK.BlinkType", "WTK.DataType", "WTK.ValueWidgetOptions", "WTK.PortfolioSingleValueWidget", "WTK.WidgetOptions", "WTK.InfrontWidget"]
---

# PortfolioSingleValueWidgetOptions

PortfolioSingleValueWidgetOptions class extending ValueWidgetOptions class.

Set options for the PortfolioSingleValueWidget.

#### See

PortfolioSingleValueWidget | WidgetOptions | ValueWidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.PortfolioSingleValueWidgetOptions))
...
Overrides ValueWidgetOptions.name
...
```ts
onValueItemEmpty: (name: string) => void
```

Callback on value item empty.
