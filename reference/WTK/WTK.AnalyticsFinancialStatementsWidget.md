---
title: "AnalyticsFinancialStatementsWidget"
qualified_name: "WTK.AnalyticsFinancialStatementsWidget"
kind: class
...
nav_path: "WTK > Analytics Widgets > AnalyticsFinancialStatementsWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsFinancialStatementsWidget.html"
defines: ["AnalyticsFinancialStatementsWidget"]
member_count: 14
...
related_types: ["WTK.AnalyticsFinancialStatementsWidgetOptions", "WTK.StaticSvelteInfrontWidgetComponent"]
reference_count: 6
references: ["WTK.UI", "WTK.AnalyticsFinancialStatementsWidgetOptions", "WTK.WidgetState", "WTK.WidgetBase", "WTK.InfrontWidget", "WTK.StaticSvelteInfrontWidgetComponent"]
---

# AnalyticsFinancialStatementsWidget

AnalyticsFinancialStatementsWidget class extending SvelteSingleInstrumentWidgetBase class.

`InfrontWidget = infront.analyticsFinancialStatementsWidget(target, [options]);`

This widget is used for comparing the financial statements data in a table (annually/quarterly).

Options can be configured with AnalyticsFinancialStatementsWidgetOptions.

#### Example

```ts
// This configuration creates a window to add or modify financial statements widget.
<script type="text/javascript">
    var opts = new Infront.AnalyticsFinancialStatementsWidgetOptions();
    opts.instrument = { ticker: 'BMW', feed: 26 };

    widget = infront.analyticsFinancialStatementsWidget("#analyticsFinancialStatementsWidget, opts);
</script>
...
<div id="analyticsFinancialStatementsWidget"></div>
```

#### See

AnalyticsFinancialStatementsWidgetOptions | WidgetBase | SvelteSingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<AnalyticsFinancialStatementsWidgetOptions>

  - AnalyticsFinancialStatementsWidget

#### Implements

- [StaticSvelteInfrontWidgetComponent](./WTK.StaticSvelteInfrontWidgetComponent.md)<typeof AnalyticsFinancialStatementsWidget>
...
    element: HTMLElement,
    infrontUI: UI,
    options: AnalyticsFinancialStatementsWidgetOptions,
...
- infrontUI: UI
- options: AnalyticsFinancialStatementsWidgetOptions
- widgetFn: SvelteWidgetFn<AnalyticsFinancialStatementsWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: AnalyticsFinancialStatementsWidgetOptions): void
```
