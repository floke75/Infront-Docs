---
title: "CompanyFundamentalsWidget"
qualified_name: "WTK.CompanyFundamentalsWidget"
kind: class
...
module: "WTK"
group: "Widgets"
nav_path: "WTK > Widgets > CompanyFundamentalsWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.CompanyFundamentalsWidget.html"
defines: ["CompanyFundamentalsWidget"]
member_count: 11
...
reference_count: 5
references: ["WTK.WidgetSubscriptions", "WTK.SingleInstrumentWidgetBase", "WTK.CompanyFundamentalsWidgetOptions", "WTK.WidgetBase", "WTK.InfrontWidget"]
---

# CompanyFundamentalsWidget

CompanyFundamentalsWidget class extending SingleInstrumentWidgetBase class.

`InfrontWidget = Infront.companyFundamentals(target, [options]);`

This widget is used for displaying company fundamentals data. (Sweden only)

Options can be configured with CompanyFundamentalsWidgetOptions.
...
<script type="text/javascript">
    ...
    opts.rows = [
        ...
        CompanyFundamentalsRows.PE_Adjusted,
        ...
        CompanyFundamentalsRows.FINANS_NETTO,
        CompanyFundamentalsRows.Eget_kapital,
        CompanyFundamentalsRows.Netto_resultat,
        ...
        CompanyFundamentalsRows.EarningsYield,
        CompanyFundamentalsRows.EarningsYieldAdjusted,
...
...
<div id="companyFundamental"></div>
```

#### See

CompanyFundamentalsWidgetOptions | WidgetBase | SingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.CompanyFundamentalsWidget))
