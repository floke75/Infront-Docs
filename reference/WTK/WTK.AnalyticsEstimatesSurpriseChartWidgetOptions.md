---
title: "AnalyticsEstimatesSurpriseChartWidgetOptions"
qualified_name: "WTK.AnalyticsEstimatesSurpriseChartWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > AnalyticsEstimatesSurpriseChartWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsEstimatesSurpriseChartWidgetOptions.html"
defines: ["AnalyticsEstimatesSurpriseChartWidgetOptions"]
member_count: 36
members: ["instrument?", "decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "chartHeight?", "chartWidth?", "colors", "estimateSource", "fields", "fontFamily", "fundamentalSource", "legend", "legendLabelColor", "periodCount", "selectedField", "showKeyFiguresDropdown", "spacingBottom", "spacingLeft", "spacingRight", "spacingTop", "onFieldSelected?"]
member_groups:
  ...
  "AnalyticsEstimatesSurpriseChartWidget": ["chartHeight?", "chartWidth?", "colors", "estimateSource", "fields", "fontFamily", "fundamentalSource", "legend", "legendLabelColor", "periodCount", "selectedField", "showKeyFiguresDropdown", "spacingBottom", "spacingLeft", "spacingRight", "spacingTop", "onFieldSelected?"]
reference_count: 10
references: ["SDK.InfrontSDK.SymbolId", "WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "SDK.InfrontSDK.CoreDataAPI.CdapiEquityCompanyEstimateSource", "SDK.InfrontSDK.CoreDataAPI.CdapiEquityCompanyFundamentalSource", "WTK.AnalyticsEstimatesSurpriseChartWidget", "WTK.SvelteWidgetOptions", "WTK.InfrontWidget"]
---

# AnalyticsEstimatesSurpriseChartWidgetOptions

AnalyticsEstimatesSurpriseChartWidgetOptions class extending SvelteSingleInstrumentWidgetBaseOptions class.

Set Options for the AnalyticsEstimatesSurpriseChartWidget.

#### See

AnalyticsEstimatesSurpriseChartWidget | SvelteWidgetOptions | SvelteSingleInstrumentWidgetBaseOptions
...
```ts
colors: EstimatesSurpriceChartColorItem = ...
```

Hex colors (e.g. `'#ff00ff'`) to use in the chart.
...
```ts
fields: readonly AnalyticsEstimatesSurpriseChartField[] = DEFAULT_FIELDS
```

The fields to display in dropdown
...
```ts
periodCount: number = 15
```

How many years of surprise chart data.
...
```ts
selectedField: AnalyticsEstimatesSurpriseChartField = 'NET_SALES'
```

The field selected in the dropdown to display the chart

#### showKeyFiguresDropdown

```ts
showKeyFiguresDropdown: boolean = false
```

Display KeyFigures Dropdown
...
#### `Optional` onFieldSelected

```ts
onFieldSelected?(
    event: { field: AnalyticsEstimatesSurpriseChartField; label: string },
): void
```

Callback for when a different field is selected
(when [showKeyFiguresDropdown](#showkeyfiguresdropdown) is `true`).
