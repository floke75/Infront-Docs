---
title: "RiskMeasuresTimeseriesWidgetOptions"
qualified_name: "WTK.RiskMeasuresTimeseriesWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > RiskMeasuresTimeseriesWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.RiskMeasuresTimeseriesWidgetOptions.html"
defines: ["RiskMeasuresTimeseriesWidgetOptions"]
member_count: 39
members: ["instrument?", "decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "chartHeight?", "chartWidth?", "color", "fromDate", "lineWidth", "measureType", "plotlineColors", "plotlineWidth", "portfolioId", "portfolioSource", "showLegend", "showPlotlines", "showTitle", "showTooltip", "spacingBottom", "spacingLeft", "spacingRight", "spacingTop", "tickPixelInterval", "toDate"]
member_groups:
  ...
  "RiskMeasuresTimeseriesWidget": ["chartHeight?", "chartWidth?", "color", "fromDate", "lineWidth", "measureType", "plotlineColors", "plotlineWidth", "portfolioId", "portfolioSource", "showLegend", "showPlotlines", "showTitle", "showTooltip", "spacingBottom", "spacingLeft", "spacingRight", "spacingTop", "tickPixelInterval", "toDate"]
reference_count: 8
references: ["SDK.InfrontSDK.SymbolId", "WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.RiskMeasuresTimeseriesWidget", "WTK.SvelteWidgetOptions", "WTK.InfrontWidget"]
---

# RiskMeasuresTimeseriesWidgetOptions

RiskMeasuresTimeseriesWidgetOptions class extending SvelteSingleInstrumentWidgetBaseOptions class.

Set Options for the RiskMeasuresTimeseriesWidget.

#### See

RiskMeasuresTimeseriesWidget | SvelteWidgetOptions | SvelteSingleInstrumentWidgetBaseOptions
...
Define color of the chart line.

Or set color by css-variable: --wtk-risk-measures-timeseries-options-color

##### Default Value

`'#EB003F'` - default set by failover
...
Define width of the chart line.
...
```ts
measureType: RiskMeasureType = 'VALUE_AT_RISK'
```

The risk measure to display as a timeseries.
...
- --wtk-risk-measures-timeseries-options-x-plotline-color
- --wtk-risk-measures-timeseries-options-y-plotline-color

##### Default Value

`['#334CCC', '#334CCC']` - default set by failover
...
Show or hide the plotlines on the chart.

The plotlines show the y-values of first and last item.
