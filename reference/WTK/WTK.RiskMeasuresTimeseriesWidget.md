---
title: "RiskMeasuresTimeseriesWidgetAlpha"
qualified_name: "WTK.RiskMeasuresTimeseriesWidget"
kind: class
...
module: "WTK"
group: "Risk Widgets"
nav_path: "WTK > Risk Widgets > RiskMeasuresTimeseriesWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.RiskMeasuresTimeseriesWidget.html"
defines: ["RiskMeasuresTimeseriesWidget"]
member_count: 41
...
related_types: ["WTK.RiskMeasuresTimeseriesWidgetOptions"]
reference_count: 6
references: ["WTK.UI", "WTK.RiskMeasuresTimeseriesWidgetOptions", "WTK.WidgetState", "SDK.InfrontSDK.SymbolId", "WTK.WidgetBase", "WTK.InfrontWidget"]
---

# RiskMeasuresTimeseriesWidgetAlpha

RiskMeasuresTimeseriesWidget class extending SvelteSingleInstrumentWidgetBase class.

`InfrontWidget = infront.riskMeasuresTimeseriesWidget(target, [options]);`

The RiskMeasuresTimeseries widget shows a line chart with the portfolio value at risk over some user specified time horizon.

Options can be configured with RiskMeasuresTimeseriesWidgetOptions.

#### Example

```ts
<script type="text/javascript">
    var opts = new Infront.RiskMeasuresTimeseriesWidgetOptions({
        portfolioSource: 'wtk',
        portfolioId: '123456',
    ...
    widget = infront.riskMeasuresTimeseriesWidget("RiskMeasuresTimeseriesWidget", opts);
</script>
...
<div id="RiskMeasuresTimeseriesWidget"></div>
```

#### See

RiskMeasuresTimeseriesWidgetOptions | WidgetBase | SvelteSingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<RiskMeasuresTimeseriesWidgetOptions>
...
```ts
new RiskMeasuresTimeseriesWidget(
    parentElement: HTMLElement,
    infrontUI: UI,
    options: Partial<RiskMeasuresTimeseriesWidgetOptions>,
): RiskMeasuresTimeseriesWidget
```
...
##### Returns RiskMeasuresTimeseriesWidget

Overrides SvelteSingleInstrumentWidgetBase<RiskMeasuresTimeseriesWidgetOptions>.constructor
...
```ts
optionsProxy: OptionsStore<RiskMeasuresTimeseriesWidgetOptions>
```
...
##### Returns RiskMeasuresTimeseriesWidgetOptions
...
    element: HTMLElement,
    infrontUI: UI,
    options: RiskMeasuresTimeseriesWidgetOptions,
...
- infrontUI: UI
- options: RiskMeasuresTimeseriesWidgetOptions
- widgetFn: SvelteWidgetFn<RiskMeasuresTimeseriesWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: RiskMeasuresTimeseriesWidgetOptions): void
```
