...
qualified_name: "WTK.ValueWidgetOptions"
kind: class
...
nav_path: "WTK > Base Widget Options > ValueWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.ValueWidgetOptions.html"
defines: ["ValueWidgetOptions"]
member_count: 39
members: ["hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "decimals", "defaultContent", "instrument", "allowZero", "blinkDuration", "blinkType", "className?", "column", "compute", "computeFields", "content", "currencyClassName?", "dataItem", "dataType", "enableChangeStatusColors", "hover?", "name", "onClick?", "rootElement", "showCurrency", "translate?", "type?"]
member_groups:
  ...
  "SingleInstrumentWidget": ["decimals", "defaultContent", "instrument"]
  "ValueWidget": ["allowZero", "blinkDuration", "blinkType", "className?", "column", "compute", "computeFields", "content", "currencyClassName?", "dataItem", "dataType", "enableChangeStatusColors", "hover?", "name", "onClick?", "rootElement", "showCurrency", "translate?", "type?"]
related_types: ["WTK.SingleInstrumentWidgetOptions", "WTK.InstrumentSingleValueWidgetOptions", "WTK.PortfolioSingleValueWidgetOptions", "WTK.TradingPowerWidgetOptions", "WTK.PositionWidgetOptions", "WTK.QuoteWidgetOptions"]
reference_count: 15
references: ["WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.BlinkDuration", "WTK.BlinkType", "WTK.DataType", "WTK.SingleInstrumentWidgetOptions", "WTK.ValueWidget", "WTK.WidgetOptions", "WTK.InstrumentSingleValueWidgetOptions", "WTK.PortfolioSingleValueWidgetOptions", "WTK.TradingPowerWidgetOptions", "WTK.PositionWidgetOptions", "WTK.QuoteWidgetOptions", "WTK.InfrontWidget"]
---

# ValueWidgetOptions

ValueWidgetOptions class extending SingleInstrumentWidgetOptions class.

Set options for the ValueWidget.

#### See

ValueWidget | WidgetOptions | SingleInstrumentWidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.ValueWidgetOptions))

- SingleInstrumentWidgetOptions

  - ValueWidgetOptions

    - InstrumentSingleValueWidgetOptions
    - PortfolioSingleValueWidgetOptions
    - TradingPowerWidgetOptions
...
Overrides SingleInstrumentWidgetOptions.content
...
- (lineId: any, value: any, extras?: any): void
