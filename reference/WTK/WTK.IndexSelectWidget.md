---
title: "IndexSelectWidget"
qualified_name: "WTK.IndexSelectWidget"
kind: class
...
module: "WTK"
group: "Widgets"
nav_path: "WTK > Widgets > IndexSelectWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.IndexSelectWidget.html"
defines: ["IndexSelectWidget"]
member_count: 14
...
related_types: ["WTK.IndexSelectWidgetOptions"]
reference_count: 5
references: ["WTK.UI", "WTK.IndexSelectWidgetOptions", "WTK.WidgetState", "WTK.WidgetBase", "WTK.InfrontWidget"]
---

# IndexSelectWidget

IndexSelectWidget class extending SvelteSingleInstrumentWidgetBase class.

`InfrontWidget = infront.indexSelectWidget(target, [options]);`

Dropdown of a given index List

Selected index is given back with `onIndexClicked` callback

Selected index constituents is given back with `onIndexInstruments` callback

Options can be configured with IndexSelectWidgetOptions.

#### Example

```ts
// This configuration creates a dropdown to select index.
<script type="text/javascript">
    var opts = new Infront.IndexSelectWidgetOptions();
    opts.instrument = { ticker: 'BMW', feed: 26 };

    widget = infront.indexSelectWidget("#IndexSelectWidget, opts);
</script>
...
...
IndexSelectWidgetOptions | WidgetBase | SvelteSingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<IndexSelectWidgetOptions>
...
    element: HTMLElement,
    infrontUI: UI,
    options: IndexSelectWidgetOptions,
    widgetFn: SvelteWidgetFn<IndexSelectWidgetOptions, Record<string, any>>,
): void
```
...
```ts
validateOptions(options: IndexSelectWidgetOptions): void
```
