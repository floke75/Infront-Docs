...
qualified_name: "WTK.TradingWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > TradingWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.TradingWidgetOptions.html"
defines: ["TradingWidgetOptions"]
member_count: 22
members: ["decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "clickToLogin", "hasTradingContentCallback", "rememberCanceledLogin", "tradingLoginCallback"]
member_groups:
...
related_types: ["WTK.WidgetOptions", "WTK.OrderEntryWidgetOptions", "WTK.AssetsPieChartOptions", "WTK.NetTradesWidgetOptions", "WTK.OrderStackWidgetOptions", "WTK.PortfolioNameWidgetOptions", "WTK.PortfolioValuesWidgetOptions", "WTK.CommonListOptions"]
reference_count: 14
references: ["WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.WidgetOptions", "WTK.TradingWidgetBase", "WTK.OrderEntryWidgetOptions", "WTK.AssetsPieChartOptions", "WTK.NetTradesWidgetOptions", "WTK.OrderStackWidgetOptions", "WTK.PortfolioNameWidgetOptions", "WTK.PortfolioValuesWidgetOptions", "WTK.CommonListOptions", "WTK.InfrontWidget"]
---

# TradingWidgetOptions

TradingWidgetOptions class extending WidgetOptions class.

Set options for the TradingWidgetBase.

#### See

TradingWidgetBase | WidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.TradingWidgetOptions))
