---
title: "FinancialCalendarWidgetOptions"
qualified_name: "WTK.FinancialCalendarWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > FinancialCalendarWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.FinancialCalendarWidgetOptions.html"
defines: ["FinancialCalendarWidgetOptions"]
member_count: 36
members: ["decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "countryCodes", "defaultContent", "defaultSortOrder", "enableHeaderLine", "enableRegionSelector", "endDate", "feeds", "instrument", "instruments", "layout", "onInstrumentSelected", "pageItems", "paging", "showCategory", "showTicker", "showTickerInHeader", "startDate", "startEmpty"]
member_groups:
  ...
  "FinancialCalendarWidget": ["countryCodes", "defaultContent", "defaultSortOrder", "enableHeaderLine", "enableRegionSelector", "endDate", "feeds", "instrument", "instruments", "layout", "onInstrumentSelected", "pageItems", "paging", "showCategory", "showTicker", "showTickerInHeader", "startDate", "startEmpty"]
related_types: ["WTK.WidgetOptions"]
reference_count: 9
references: ["WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.SortOrder", "WTK.FinancialCalendarLayout", "WTK.WidgetOptions", "WTK.FinancialCalendarWidget", "WTK.InfrontWidget"]
---

# FinancialCalendarWidgetOptions

FinancialCalendarWidgetOptions class extending WidgetOptions class.

Set options for the FinancialCalendarWidget.

#### See

FinancialCalendarWidget | WidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.FinancialCalendarWidgetOptions))
...
The country/countries to show a calendar for.
...
```ts
enableRegionSelector: boolean = false
```
...
The instruments to show a calendar for.
...
```ts
layout: FinancialCalendarLayout = FinancialCalendarLayout.COMPACT
```
...
[FinancialCalendarLayout](./WTK.FinancialCalendarLayout.md)

##### Default Value

`FinancialCalendarLayout.COMPACT`
...
Callback providing selected instrument.
...
`5 (10 if FinancialCalendarLayout.EXPANDED == true)`
