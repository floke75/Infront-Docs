---
title: "NewsReaderWidgetOptions"
qualified_name: "WTK.NewsReaderWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > NewsReaderWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.NewsReaderWidgetOptions.html"
defines: ["NewsReaderWidgetOptions"]
member_count: 20
members: ["decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "cssURL", "newsItem"]
member_groups:
  ...
  "NewsReaderWidget": ["cssURL", "newsItem"]
related_types: ["WTK.WidgetOptions"]
reference_count: 7
references: ["WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.WidgetOptions", "WTK.NewsReaderWidget", "WTK.InfrontWidget"]
---

# NewsReaderWidgetOptions

NewsReaderWidgetOptions class extending WidgetOptions class.

Set options for the NewsReaderWidget.

#### See

NewsReaderWidget | WidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.NewsReaderWidgetOptions))
