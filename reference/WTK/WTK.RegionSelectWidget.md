---
title: "RegionSelectWidget"
qualified_name: "WTK.RegionSelectWidget"
kind: class
...
nav_path: "WTK > Analytics Widgets > RegionSelectWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.RegionSelectWidget.html"
defines: ["RegionSelectWidget"]
member_count: 14
...
related_types: ["WTK.RegionSelectWidgetOptions", "WTK.StaticSvelteInfrontWidgetComponent"]
reference_count: 4
references: ["WTK.UI", "WTK.RegionSelectWidgetOptions", "WTK.WidgetState", "WTK.StaticSvelteInfrontWidgetComponent"]
---

# RegionSelectWidget

RegionSelectWidget class extending SvelteWidgetBase class.

Options can be configured with RegionSelectWidgetOptions.

#### Example

```ts
<script type="text/javascript">
    widget = infront.widget(RegionSelectWidget, "#targetId", {
      // options
    });
</script>
...
...
```ts
<script type="text/javascript">
    widget = infront.regionSelectWidget("#targetId", {
      // options
    });
...
RegionSelectWidgetOptions | SvelteWidgetBase

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<RegionSelectWidgetOptions>

  - RegionSelectWidget

#### Implements

- [StaticSvelteInfrontWidgetComponent](./WTK.StaticSvelteInfrontWidgetComponent.md)<typeof RegionSelectWidget>
...
    element: HTMLElement,
    infrontUI: UI,
    options: RegionSelectWidgetOptions,
    widgetFn: SvelteWidgetFn<RegionSelectWidgetOptions, Record<string, any>>,
): void
```
...
```ts
validateOptions(options: RegionSelectWidgetOptions): void
```
