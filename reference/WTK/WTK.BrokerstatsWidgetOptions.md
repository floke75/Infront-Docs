---
title: "BrokerstatsWidgetOptions"
qualified_name: "WTK.BrokerstatsWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > BrokerstatsWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.BrokerstatsWidgetOptions.html"
defines: ["BrokerstatsWidgetOptions"]
member_count: 65
members: ["hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "broker", "columns", "defaultSortedColumn", "defaultSortOrder", "enablePeriodSelector", "feed", "instrument", "maxItems", "onBrokerSelected", "onInstrumentSelected", "period", "tickerInHeader", "availableColumns", "className", "compareCaseInsensitive", "compareCaseInsensitiveLocale", "createExpandRow", "decimals", "defaultContent", "enableChangeStatusColors", "enableColumnsMove", "enableColumnsResize", "enableFixedHeader", "excludeUnsortedState", "expandableRows", "extraColumns", "extraOptions", "interactionHighlight", "layout", "linkTrigger", "loadSavedColumns", "onColumnDeleted", "onColumnExpand", "onColumnInsert", "onColumnMoved", "onColumnMoving", "onColumnsChanged", "onColumnsResized", "onResetColumns", "onSettingsClicked", "rowSelectable", "sortable", "tabs", "uiFactory", "clickToLogin", "hasTradingContentCallback", "rememberCanceledLogin", "tradingLoginCallback"]
member_groups:
  ...
  "BrokerstatsWidget": ["broker", "columns", "defaultSortedColumn", "defaultSortOrder", "enablePeriodSelector", "feed", "instrument", "maxItems", "onBrokerSelected", "onInstrumentSelected", "period", "tickerInHeader"]
...
reference_count: 13
references: ["WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.SortOrder", "WTK.WidgetDecimals", "WTK.ListLayout", "WTK.QuoteListTabOptions", "WTK.ListUIFactory", "WTK.CommonListOptions", "WTK.BrokerstatsWidget", "WTK.WidgetOptions", "WTK.InfrontWidget", "WTK.Field"]
---

# BrokerstatsWidgetOptions

BrokerstatsWidgetOptions class extending CommonListOptions class.

Set options for the BrokerstatsWidget.

#### See

BrokerstatsWidget | WidgetOptions | CommonListOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.BrokerstatsWidgetOptions))
...
`["NAME", "FULLNAME", "BUY_VOLUME", "SELL_VOLUME", "INT_VOLUME", "TOTAL_VOLUME"]`
...
Enable/disable period selector.
...
Callback that sends the selected broker.
...
Callback that sends the selected instrument.
...
one of the string values specified in InfrontConstants.BrokerStatsPeriods:
...
InfrontConstants.BrokerStatsPeriods
...
Enable/disable ticker in header.
