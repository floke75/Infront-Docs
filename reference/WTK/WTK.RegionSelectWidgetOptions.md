---
title: "RegionSelectWidgetOptions"
qualified_name: "WTK.RegionSelectWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > RegionSelectWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.RegionSelectWidgetOptions.html"
defines: ["RegionSelectWidgetOptions"]
member_count: 31
members: ["instrument?", "decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "constructor", "closeOnSelect", "customRegions", "defaultLabel?", "disabled", "loadingLabel?", "onRegionSelected?", "selectedRegionCode", "showArrow", "showCurrentRegionAsLabel", "showFlagIcon", "showLoadingLabel"]
member_groups:
  ...
  "Other": ["constructor", "closeOnSelect", "customRegions", "defaultLabel?", "disabled", "loadingLabel?", "onRegionSelected?", "selectedRegionCode", "showArrow", "showCurrentRegionAsLabel", "showFlagIcon", "showLoadingLabel"]
reference_count: 9
references: ["SDK.InfrontSDK.SymbolId", "WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.AnalyticsRegionInfo", "WTK.RegionSelectWidget", "WTK.SvelteWidgetOptions", "WTK.InfrontWidget"]
---

# RegionSelectWidgetOptions

RegionSelectWidgetOptions class extending RegionSelectWidget class.

Set Options for the RegionSelectWidget.

#### See

RegionSelectWidget | SvelteWidgetOptions
...
```ts
new RegionSelectWidgetOptions(
    initOptions?: Partial<RegionSelectWidgetOptions>,
): RegionSelectWidgetOptions
```

Initializes a new [RegionSelectWidgetOptions](#).
You can optionally specify an init object that specifies
a subset of properties to set on the new options object.

##### Parameters

- `Optional` initOptions: Partial<RegionSelectWidgetOptions>

  The initial property values to set.

##### Returns RegionSelectWidgetOptions
...
Indicates whether the dropdown should close when you select a region.
...
```ts
customRegions: AnalyticsRegionInfo[] = undefined
```

An optional list of custom regions to show in the dropdown.
If not specified, the built-in list of regions is used or the regions of the instrument is used.
...
Can be toggled via a call to `SubSectorSelectWidget`'s ` modify()` call.
...
You can turn this message off by setting [RegionSelectWidgetOptions.showLoadingLabel](#showloadinglabel) to `false`.

Defaults to "(loading...)".

#### `Optional` onRegionSelected

```ts
onRegionSelected?: (region: AnalyticsRegionInfo) => void
```

Called when a region selection changes, and on initial load to notify
of the underlying region and country codes.
...
Sets the region that should be selected by default.
...
#### showCurrentRegionAsLabel

```ts
showCurrentRegionAsLabel: boolean = true
```

Indicates whether to show the currently selected region. If set to `false`,
[RegionSelectWidgetOptions.defaultLabel](#defaultlabel)
is shown instead.
...
while the sector list is still loading, or to use the [RegionSelectWidgetOptions.defaultLabel](#defaultlabel)
instead.
