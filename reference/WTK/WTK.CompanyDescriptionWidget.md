---
title: "CompanyDescriptionWidget"
qualified_name: "WTK.CompanyDescriptionWidget"
kind: class
...
module: "WTK"
group: "Widgets"
nav_path: "WTK > Widgets > CompanyDescriptionWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.CompanyDescriptionWidget.html"
defines: ["CompanyDescriptionWidget"]
member_count: 11
...
reference_count: 5
references: ["WTK.WidgetSubscriptions", "WTK.SingleInstrumentWidgetBase", "WTK.CompanyDescriptionWidgetOptions", "WTK.WidgetBase", "WTK.InfrontWidget"]
---

# CompanyDescriptionWidget

CompanyDescriptionWidget class extending SingleInstrumentWidgetBase class.

`InfrontWidget = Infront.companyDescription(target, [options]);`

This widget is used for displaying company description.

Options can be configured with CompanyDescriptionWidgetOptions.
...
CompanyDescriptionWidgetOptions | WidgetBase | SingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.CompanyDescriptionWidget))
