---
title: "SvelteAlertWidgetOptions"
qualified_name: "WTK.SvelteAlertWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > SvelteAlertWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.SvelteAlertWidgetOptions.html"
defines: ["SvelteAlertWidgetOptions"]
member_count: 23
members: ["instrument?", "decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "alert?", "alertAddedClick?", "customSearchClicked?", "hideSearchBox?"]
member_groups:
  ...
  "AlertWidget": ["alert?", "alertAddedClick?", "customSearchClicked?", "hideSearchBox?"]
reference_count: 8
references: ["SDK.InfrontSDK.SymbolId", "WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.WidgetOptions", "WTK.SingleInstrumentWidgetOptions", "WTK.InfrontWidget"]
---

# SvelteAlertWidgetOptions

SvelteAlertWidgetOptions class extending SvelteSingleInstrumentWidgetBaseOptions class.

Set options for the SvelteAlertWidget.

#### See

SvelteAlertWidget | WidgetOptions | SingleInstrumentWidgetOptions
