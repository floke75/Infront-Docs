---
title: "AnalyticsCompanyDescriptionWidget"
qualified_name: "WTK.AnalyticsCompanyDescriptionWidget"
kind: class
...
nav_path: "WTK > Analytics Widgets > AnalyticsCompanyDescriptionWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsCompanyDescriptionWidget.html"
defines: ["AnalyticsCompanyDescriptionWidget"]
member_count: 14
...
related_types: ["WTK.AnalyticsCompanyDescriptionWidgetOptions"]
reference_count: 5
references: ["WTK.UI", "WTK.AnalyticsCompanyDescriptionWidgetOptions", "WTK.WidgetState", "WTK.WidgetBase", "WTK.InfrontWidget"]
---

# AnalyticsCompanyDescriptionWidget

AnalyticsCompanyDescriptionWidget class extending SvelteSingleInstrumentWidgetBase class.

`InfrontWidget = infront.analyticsCompanyDescriptionWidget(target, [options]);`

Displays the description of a company.

Options can be configured with AnalyticsCompanyDescriptionWidgetOptions.

#### Example

```ts
// This configuration creates a window to add or modify the analytics top shareholders widget.
<script type="text/javascript">
    var opts = new Infront.analyticsCompanyDescriptionWidgetOptions();
    opts.instrument = { ticker: 'BMW', feed: 26 };

    widget = infront.analyticsCompanyDescriptionWidget("#analyticsCompanyDescriptionWidget, opts);
</script>
...
<div id="analyticsCompanyDescriptionWidget"></div>
```

#### See

[AnalyticsCompanyDescriptionWidget](#) | WidgetBase | SvelteSingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<AnalyticsCompanyDescriptionWidgetOptions>
...
    element: HTMLElement,
    infrontUI: UI,
    options: AnalyticsCompanyDescriptionWidgetOptions,
...
- infrontUI: UI
- options: AnalyticsCompanyDescriptionWidgetOptions
- widgetFn: SvelteWidgetFn<AnalyticsCompanyDescriptionWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: AnalyticsCompanyDescriptionWidgetOptions): void
```
