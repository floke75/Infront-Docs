---
title: "AnalyticsKeyFiguresWidget"
qualified_name: "WTK.AnalyticsKeyFiguresWidget"
kind: class
...
nav_path: "WTK > Analytics Widgets > AnalyticsKeyFiguresWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsKeyFiguresWidget.html"
defines: ["AnalyticsKeyFiguresWidget"]
member_count: 14
...
related_types: ["WTK.AnalyticsKeyFiguresWidgetOptions", "WTK.StaticSvelteInfrontWidgetComponent"]
reference_count: 4
references: ["WTK.UI", "WTK.AnalyticsKeyFiguresWidgetOptions", "WTK.WidgetState", "WTK.StaticSvelteInfrontWidgetComponent"]
---

# AnalyticsKeyFiguresWidget

AnalyticsKeyFiguresWidget class extending SvelteSingleInstrumentWidgetBase class.

Options can be configured with AnalyticsKeyFiguresWidgetOptions.

#### Example

```ts
<script type="text/javascript">
    widget = infront.widget(AnalyticsKeyFiguresWidget, "#targetId", {
      // options
    });
</script>
...
...
```ts
<script type="text/javascript">
    widget = infront.analyticsKeyFiguresWidget("#targetId", {
      // options
    });
</script>
...
...
AnalyticsKeyFiguresWidgetOptions | SvelteSingleInstrumentWidgetBase

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<AnalyticsKeyFiguresWidgetOptions>

  - AnalyticsKeyFiguresWidget

#### Implements

- [StaticSvelteInfrontWidgetComponent](./WTK.StaticSvelteInfrontWidgetComponent.md)<typeof AnalyticsKeyFiguresWidget>
...
    element: HTMLElement,
    infrontUI: UI,
    options: AnalyticsKeyFiguresWidgetOptions,
...
- infrontUI: UI
- options: AnalyticsKeyFiguresWidgetOptions
- widgetFn: SvelteWidgetFn<AnalyticsKeyFiguresWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: AnalyticsKeyFiguresWidgetOptions): void
```
