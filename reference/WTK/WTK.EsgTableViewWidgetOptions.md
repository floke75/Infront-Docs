---
title: "EsgTableViewWidgetOptions"
qualified_name: "WTK.EsgTableViewWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > EsgTableViewWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.EsgTableViewWidgetOptions.html"
defines: ["EsgTableViewWidgetOptions"]
member_count: 19
members: ["instrument?", "decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle"]
member_groups:
...
reference_count: 8
references: ["SDK.InfrontSDK.SymbolId", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.EsgTableViewWidget", "WTK.WidgetOptions", "WTK.WidgetDecimals", "WTK.InfrontWidget"]
---

# EsgTableViewWidgetOptions

[EsgTableViewWidgetOptions](#) class is extending SvelteSingleInstrumentWidgetBaseOptions class.

Set options for the EsgTableViewWidget.

#### See

EsgTableViewWidget | SvelteSingleInstrumentWidgetBaseOptions | WidgetOptions
...
Overrides SvelteSingleInstrumentWidgetBaseOptions.decimals
