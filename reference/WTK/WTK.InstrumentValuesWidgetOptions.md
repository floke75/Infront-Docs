---
title: "InstrumentValuesWidgetOptions"
qualified_name: "WTK.InstrumentValuesWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > InstrumentValuesWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.InstrumentValuesWidgetOptions.html"
defines: ["InstrumentValuesWidgetOptions"]
member_count: 24
members: ["hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "fields", "layout", "rememberCanceledLogin", "content", "decimals", "defaultContent", "instrument"]
member_groups:
  ...
  "InstrumentValuesWidget": ["fields", "layout", "rememberCanceledLogin"]
  "SingleInstrumentWidget": ["content", "decimals", "defaultContent", "instrument"]
related_types: ["WTK.SingleInstrumentWidgetOptions"]
reference_count: 8
references: ["WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.MultipleValuesWidgetLayout", "WTK.SingleInstrumentWidgetOptions", "WTK.InstrumentValuesWidget", "WTK.WidgetOptions", "WTK.InfrontWidget"]
---

# InstrumentValuesWidgetOptions

InstrumentValuesWidgetOptions class extending SingleInstrumentWidgetOptions class.

Set options for the InstrumentValuesWidget.

#### See

InstrumentValuesWidget | WidgetOptions | SingleInstrumentWidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.InstrumentValuesWidgetOptions))
...
This is where you specify which fields you want in your widget.
...
Defines which layout you want to use.
...
[MultipleValuesWidgetLayout](./WTK.MultipleValuesWidgetLayout.md)
...
```ts
rememberCanceledLogin: boolean = true
```

Remember canceled login.
