---
title: "CountryMultiSelectWidget"
qualified_name: "WTK.CountryMultiSelectWidget"
kind: class
...
nav_path: "WTK > Analytics Widgets > CountryMultiSelectWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.CountryMultiSelectWidget.html"
defines: ["CountryMultiSelectWidget"]
member_count: 14
...
related_types: ["WTK.CountryMultiSelectWidgetOptions", "WTK.StaticSvelteInfrontWidgetComponent"]
reference_count: 4
references: ["WTK.UI", "WTK.CountryMultiSelectWidgetOptions", "WTK.WidgetState", "WTK.StaticSvelteInfrontWidgetComponent"]
---

# CountryMultiSelectWidget

CountryMultiSelectWidget class extending SvelteWidgetBase class.

`InfrontWidget = infront.countryMultiSelectWidget(target, [options]);`

TODO: description.

Options can be configured with CountryMultiSelectWidgetOptions.

#### Example

```ts
<script type="text/javascript">
    widget = infront.countryMultiSelectWidget("#targetId", new CountryMultiSelectWidgetOptions({
    }));
</script>
...
<div id="targetId"></div>
...
CountryMultiSelectWidgetOptions | SvelteWidgetBase

#### Hierarchy

- SvelteWidgetBase<CountryMultiSelectWidgetOptions>

  - CountryMultiSelectWidget

#### Implements

- [StaticSvelteInfrontWidgetComponent](./WTK.StaticSvelteInfrontWidgetComponent.md)<typeof CountryMultiSelectWidget>
...
    element: HTMLElement,
    infrontUI: UI,
    options: CountryMultiSelectWidgetOptions,
...
- infrontUI: UI
- options: CountryMultiSelectWidgetOptions
- widgetFn: SvelteWidgetFn<CountryMultiSelectWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: CountryMultiSelectWidgetOptions): void
```
