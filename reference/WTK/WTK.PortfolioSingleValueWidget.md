---
title: "PortfolioSingleValueWidget"
qualified_name: "WTK.PortfolioSingleValueWidget"
kind: class
...
nav_path: "WTK > Trading Widgets > PortfolioSingleValueWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.PortfolioSingleValueWidget.html"
defines: ["PortfolioSingleValueWidget"]
member_count: 10
...
reference_count: 5
references: ["WTK.WidgetSubscriptions", "WTK.ValueWidget", "WTK.PortfolioSingleValueWidgetOptions", "WTK.WidgetBase", "WTK.InfrontWidget"]
---

# PortfolioSingleValueWidget

PortfolioSingleValueWidget class extending ValueWidget class.
...
Options can be configured with PortfolioSingleValueWidgetOptions.
...
<script type="text/javascript">
    ...
    infrontUI.singlePortfolioValueWidget("#portfolioSingleValue", opts);
</script>
...
<div id="portfolioSingleValue"></div>
```

#### See

PortfolioSingleValueWidgetOptions | WidgetBase | ValueWidget | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.PortfolioSingleValueWidget))
