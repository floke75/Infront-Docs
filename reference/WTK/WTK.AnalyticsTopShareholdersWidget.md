---
title: "AnalyticsTopShareholdersWidget"
qualified_name: "WTK.AnalyticsTopShareholdersWidget"
kind: class
...
nav_path: "WTK > Analytics Widgets > AnalyticsTopShareholdersWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsTopShareholdersWidget.html"
defines: ["AnalyticsTopShareholdersWidget"]
member_count: 14
...
related_types: ["WTK.AnalyticsTopShareholdersWidgetOptions"]
reference_count: 5
references: ["WTK.UI", "WTK.AnalyticsTopShareholdersWidgetOptions", "WTK.WidgetState", "WTK.WidgetBase", "WTK.InfrontWidget"]
---

# AnalyticsTopShareholdersWidget

AnalyticsTopShareholdersWidget class extending SvelteSingleInstrumentWidgetBase class.

`InfrontWidget = infront.analyticsTopShareholdersWidget(target, [options]);`

Displays the top shareholders of a company (instrument) in a simple table.

Options can be configured with AnalyticsTopShareholdersWidgetOptions.
...
<script type="text/javascript">
    var opts = new Infront.analyticsTopShareholdersWidgetOptions();
    opts.instrument = { ticker: 'BMW', feed: 26 };

    widget = infront.analyticsTopShareholdersWidget("#analyticsTopShareholdersWidget, opts);
</script>
...
<div id="analyticsTopShareholdersWidget"></div>
```

#### See

[AnalyticsTopShareholdersWidget](#) | WidgetBase | SvelteSingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<AnalyticsTopShareholdersWidgetOptions>
...
    element: HTMLElement,
    infrontUI: UI,
    options: AnalyticsTopShareholdersWidgetOptions,
...
- infrontUI: UI
- options: AnalyticsTopShareholdersWidgetOptions
- widgetFn: SvelteWidgetFn<AnalyticsTopShareholdersWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: AnalyticsTopShareholdersWidgetOptions): void
```
