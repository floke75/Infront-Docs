---
title: "RiskScenarioScatterPlotWidget"
qualified_name: "WTK.RiskScenarioScatterPlotWidget"
kind: class
...
module: "WTK"
group: "Risk Widgets"
nav_path: "WTK > Risk Widgets > RiskScenarioScatterPlotWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.RiskScenarioScatterPlotWidget.html"
defines: ["RiskScenarioScatterPlotWidget"]
member_count: 14
...
related_types: ["WTK.RiskScenarioScatterPlotWidgetOptions"]
reference_count: 5
references: ["WTK.UI", "WTK.RiskScenarioScatterPlotWidgetOptions", "WTK.WidgetState", "WTK.WidgetBase", "WTK.InfrontWidget"]
---

# RiskScenarioScatterPlotWidget

RiskScenarioScatterPlotWidget class extending SvelteSingleInstrumentWidgetBase class.

`InfrontWidget = infront.riskScenarioScatterPlotWidget(target, [options]);`

Displays the board members of a company (instrument) in a simple table.

Options can be configured with RiskScenarioScatterPlotWidgetOptions.

#### Example

```ts
// This configuration creates a window to add or modify the portfolio-composition widget.
<script type="text/javascript">
    var opts = new Infront.RiskScenarioScatterPlotWidgetOptions({
        portfolioSource: 'wtk',
        portfolioId: '123456',
        positionId: '876543,
    });

    widget = infront.riskScenarioScatterPlotWidget("RiskScenarioScatterPlotWidget", opts);
</script>
...
<div id="RiskScenarioScatterPlotWidget"></div>
```

#### See

RiskScenarioScatterPlotWidgetOptions | WidgetBase | SvelteSingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<RiskScenarioScatterPlotWidgetOptions>
...
    element: HTMLElement,
    infrontUI: UI,
    options: RiskScenarioScatterPlotWidgetOptions,
...
- infrontUI: UI
- options: RiskScenarioScatterPlotWidgetOptions
- widgetFn: SvelteWidgetFn<RiskScenarioScatterPlotWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: RiskScenarioScatterPlotWidgetOptions): void
```
