---
title: "OrderStackWidgetOptions"
qualified_name: "WTK.OrderStackWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > OrderStackWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.OrderStackWidgetOptions.html"
defines: ["OrderStackWidgetOptions"]
member_count: 25
members: ["decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "computedAvgPrice", "includedOrderStates", "orderClicked", "clickToLogin", "hasTradingContentCallback", "rememberCanceledLogin", "tradingLoginCallback"]
member_groups:
  ...
  "OrderStackWidget": ["computedAvgPrice", "includedOrderStates", "orderClicked"]
...
reference_count: 8
references: ["WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.TradingWidgetOptions", "WTK.OrderStackWidget", "WTK.WidgetOptions", "WTK.InfrontWidget"]
---

# OrderStackWidgetOptions

OrderStackWidgetOptions class extending TradingWidgetOptions class.

Set options for the OrderStackWidget.

#### See

OrderStackWidget | WidgetOptions | TradingWidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.OrderStackWidgetOptions))
...
```ts
computedAvgPrice: boolean = false
```

Enable computed average price.
...
```ts
includedOrderStates: TradingOrderStatus[] = OrderStackWidget.includedOrderStates
```

List of Infront.TradingOrderStatus to be included.

##### See

Infront.TradingOrderStatus

##### Default Value

`[Infront.TradingOrderStatus.Exchange, Infront.TradingOrderStatus.Pending, Infront.TradingOrderStatus.PendingInsert, Infront.TradingOrderStatus.Offline, Infront.TradingOrderStatus.Request, Infront.TradingOrderStatus.Monitor, Infront.TradingOrderStatus.Working, Infront.TradingOrderStatus.Inactive, Infront.TradingOrderStatus.Executed, Infront.TradingOrderStatus.DeletedExecuted, Infront.TradingOrderStatus.Deleted, Infront.TradingOrderStatus.DeletedRefused, Infront.TradingOrderStatus.DeletedModify, Infront.TradingOrderStatus.Abandoned, Infront.TradingOrderStatus.ActiveStopLoss,]`
...
- (portfolio: string, orderId: number): void
