---
title: "RiskContributionChartWidgetAlpha"
qualified_name: "WTK.RiskContributionChartWidget"
kind: class
...
module: "WTK"
group: "Risk Widgets"
nav_path: "WTK > Risk Widgets > RiskContributionChartWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.RiskContributionChartWidget.html"
defines: ["RiskContributionChartWidget"]
member_count: 41
...
related_types: ["WTK.RiskContributionChartWidgetOptions"]
reference_count: 6
references: ["WTK.UI", "WTK.RiskContributionChartWidgetOptions", "WTK.WidgetState", "SDK.InfrontSDK.SymbolId", "WTK.WidgetBase", "WTK.InfrontWidget"]
---

# RiskContributionChartWidgetAlpha

RiskContributionChartWidget class extending SvelteSingleInstrumentWidgetBase class.

`InfrontWidget = infront.riskContributionChartWidget(target, [options]);`

The RiskContributionChart widget shows a detailed overview of the risk contribution of each portfolio position in a barchart sorted from lowest to highest.

The chart includes all portfolio positions and hence gives a complete overview of the risk or return contributed by each position especially those which contribute most and least.

Options can be configured with RiskContributionChartWidgetOptions.

#### Example

```ts
<script type="text/javascript">
    const opts = new Infront.RiskContributionChartWidgetOptions({
        portfolioSource: 'wtk',
        portfolioId: '123456',
        type: 'RISK',
        sort: 'LOWEST_RISK',
    ...
    widget = infront.riskContributionChartWidget("RiskContributionChartWidget", opts);
</script>
...
<div id="RiskContributionChartWidget"></div>
```

#### See

RiskContributionChartWidgetOptions | WidgetBase | SvelteSingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<RiskContributionChartWidgetOptions>
...
```ts
new RiskContributionChartWidget(
    parentElement: HTMLElement,
    infrontUI: UI,
    options: Partial<RiskContributionChartWidgetOptions>,
): RiskContributionChartWidget
```
...
##### Returns RiskContributionChartWidget

Overrides SvelteSingleInstrumentWidgetBase<RiskContributionChartWidgetOptions>.constructor
...
```ts
optionsProxy: OptionsStore<RiskContributionChartWidgetOptions>
```
...
##### Returns RiskContributionChartWidgetOptions
...
    element: HTMLElement,
    infrontUI: UI,
    options: RiskContributionChartWidgetOptions,
...
- infrontUI: UI
- options: RiskContributionChartWidgetOptions
- widgetFn: SvelteWidgetFn<RiskContributionChartWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: RiskContributionChartWidgetOptions): void
```
