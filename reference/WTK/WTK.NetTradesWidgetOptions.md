---
title: "NetTradesWidgetOptions"
qualified_name: "WTK.NetTradesWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > NetTradesWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.NetTradesWidgetOptions.html"
defines: ["NetTradesWidgetOptions"]
member_count: 29
members: ["decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "buySellButtonClick", "defaultSortedColumn", "defaultSortOrder", "hideEmptyList", "layout", "showExpiryDate", "showPortfolio", "clickToLogin", "hasTradingContentCallback", "rememberCanceledLogin", "tradingLoginCallback"]
member_groups:
  ...
  "NetTradesWidget": ["buySellButtonClick", "defaultSortedColumn", "defaultSortOrder", "hideEmptyList", "layout", "showExpiryDate", "showPortfolio"]
...
reference_count: 10
references: ["WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.SortOrder", "WTK.ListLayout", "WTK.TradingWidgetOptions", "WTK.NetTradesWidget", "WTK.WidgetOptions", "WTK.InfrontWidget"]
---

# NetTradesWidgetOptions

NetTradesWidgetOptions class extending TradingWidgetOptions class.

Set options for the NetTradesWidget.

#### See

NetTradesWidget | WidgetOptions | TradingWidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.NetTradesWidgetOptions))
...
```ts
buySellButtonClick: (instrument: Instrument) => void
```

Callback on buy-sell-button click.
...
```ts
defaultSortedColumn: number = Infront.TradingTag.Symbol
```
