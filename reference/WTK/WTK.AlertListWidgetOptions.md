---
title: "AlertListWidgetOptions"
qualified_name: "WTK.AlertListWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > AlertListWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AlertListWidgetOptions.html"
defines: ["AlertListWidgetOptions"]
member_count: 22
members: ["decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "alertListMini", "closeModifyAlert", "columns", "openModifyAlertClick"]
member_groups:
  ...
  "AlertListWidget": ["alertListMini", "closeModifyAlert", "columns", "openModifyAlertClick"]
related_types: ["WTK.WidgetOptions"]
reference_count: 7
references: ["WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.WidgetOptions", "WTK.AlertListWidget", "WTK.InfrontWidget"]
---

# AlertListWidgetOptions

AlertListWidgetOptions class extending WidgetOptions class.

Set options for the AlertListWidget.

#### See

AlertListWidget | WidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.AlertListWidgetOptions))
...
`["TYPE","SOURCE","CONDITION","RECURRENCE","COMMENT"]`
