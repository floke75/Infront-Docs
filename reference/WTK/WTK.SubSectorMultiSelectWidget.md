---
title: "SubSectorMultiSelectWidget"
qualified_name: "WTK.SubSectorMultiSelectWidget"
kind: class
...
nav_path: "WTK > Analytics Widgets > SubSectorMultiSelectWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.SubSectorMultiSelectWidget.html"
defines: ["SubSectorMultiSelectWidget"]
member_count: 14
...
related_types: ["WTK.SubSectorMultiSelectWidgetOptions", "WTK.StaticSvelteInfrontWidgetComponent"]
reference_count: 4
references: ["WTK.UI", "WTK.SubSectorMultiSelectWidgetOptions", "WTK.WidgetState", "WTK.StaticSvelteInfrontWidgetComponent"]
---

# SubSectorMultiSelectWidget

SubSectorMultiSelectWidget class extending SvelteWidgetBase class.

`InfrontWidget = infront.sectorMultiSelectWidget(target, [options]);`

Provides a hierarchical sector/sub-sector selector.

Options can be configured with SubSectorMultiSelectWidgetOptions.

#### Example

```ts
<script type="text/javascript">
    widget = infront.subSectorMultiSelectWidget("#targetId", new SubSectorMultiSelectWidgetOptions({
    }));
</script>
...
<div id="targetId"></div>
...
SubSectorMultiSelectWidgetOptions | SvelteWidgetBase

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<SubSectorMultiSelectWidgetOptions>

  - SubSectorMultiSelectWidget

#### Implements

- [StaticSvelteInfrontWidgetComponent](./WTK.StaticSvelteInfrontWidgetComponent.md)<typeof SubSectorMultiSelectWidget>
...
    element: HTMLElement,
    infrontUI: UI,
    options: SubSectorMultiSelectWidgetOptions,
...
- infrontUI: UI
- options: SubSectorMultiSelectWidgetOptions
- widgetFn: SvelteWidgetFn<SubSectorMultiSelectWidgetOptions, Record<string, any>>
...
```ts
partialOptions(
    options: Partial<SubSectorMultiSelectWidgetOptions>,
): Partial<SubSectorMultiSelectWidgetOptions>
```
...
##### Returns Partial<SubSectorMultiSelectWidgetOptions>
...
```ts
validateOptions(options: SubSectorMultiSelectWidgetOptions): void
```
