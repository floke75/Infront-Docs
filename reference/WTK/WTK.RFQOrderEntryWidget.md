---
title: "RFQOrderEntryWidget"
qualified_name: "WTK.RFQOrderEntryWidget"
kind: class
...
nav_path: "WTK > Trading Widgets > RFQOrderEntryWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.RFQOrderEntryWidget.html"
defines: ["RFQOrderEntryWidget"]
member_count: 14
...
related_types: ["WTK.RFQOrderEntryWidgetOptions", "WTK.StaticSvelteInfrontWidgetComponent"]
reference_count: 6
references: ["WTK.UI", "WTK.RFQOrderEntryWidgetOptions", "WTK.WidgetState", "WTK.WidgetBase", "WTK.InfrontWidget", "WTK.StaticSvelteInfrontWidgetComponent"]
---

# RFQOrderEntryWidget

RFQOrderEntryWidget class extending SvelteSingleInstrumentWidgetBase.

`InfrontWidget = infront.rfqOrderEntry(target, [options]);`

The RFQOrderEntryWidget allows users to request quotes from brokers (RFQ / Request For Quote)
and accept or reject the received quotes to place trades.

Options can be configured with RFQOrderEntryWidgetOptions.

#### Example

```ts
<script type="text/javascript">
    widget = infront.rfqOrderEntry("#targetId", new Infront.RFQOrderEntryWidgetOptions({
        instrument: { feed: 18, ticker: 'AAPL' },
        portfolio: 'MyPortfolio',
        widgetTitle: 'RFQ for AAPL'
    }));
</script>
...
<div id="targetId"></div>
...
RFQOrderEntryWidgetOptions | WidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<RFQOrderEntryWidgetOptions>

  - RFQOrderEntryWidget

#### Implements

- [StaticSvelteInfrontWidgetComponent](./WTK.StaticSvelteInfrontWidgetComponent.md)<typeof RFQOrderEntryWidget>
- Target
...
    element: HTMLElement,
    infrontUI: UI,
    options: RFQOrderEntryWidgetOptions,
    widgetFn: SvelteWidgetFn<RFQOrderEntryWidgetOptions, Record<string, any>>,
): void
```
...
```ts
validateOptions(options: RFQOrderEntryWidgetOptions): void
```
