---
title: "ColumnChooserWidgetOptions"
qualified_name: "WTK.ColumnChooserWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > ColumnChooserWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.ColumnChooserWidgetOptions.html"
defines: ["ColumnChooserWidgetOptions"]
member_count: 25
members: ["decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "allowDirectUpdate", "allowDragAndDrop", "listWidget", "onAdd", "onClose", "overrideTitle", "showTitle", "useOriginal"]
member_groups:
  "Widget Options": ["decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle"]
  "ColumnChooserWidget": ["allowDirectUpdate", "allowDragAndDrop", "listWidget", "onAdd", "onClose", "overrideTitle", "showTitle", "useOriginal"]
related_types: ["WTK.WidgetOptions"]
reference_count: 8
references: ["WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.CommonListWidgetBase", "WTK.WidgetOptions", "WTK.ColumnChooserWidget", "WTK.InfrontWidget"]
---

# ColumnChooserWidgetOptions

ColumnChooserWidgetOptionsclass extending WidgetOptions class.

Set options for the ColumnChooserWidget.

#### See

ColumnChooserWidget | WidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.ColumnChooserWidgetOptions))
...
```ts
allowDirectUpdate: boolean = true
```
...
Overrides WidgetOptions.useOriginal
