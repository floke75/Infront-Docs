---
title: "RiskScenarioScatterPlotWidgetOptions"
qualified_name: "WTK.RiskScenarioScatterPlotWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > RiskScenarioScatterPlotWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.RiskScenarioScatterPlotWidgetOptions.html"
defines: ["RiskScenarioScatterPlotWidgetOptions"]
member_count: 37
members: ["instrument?", "decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "chartHeight?", "chartWidth?", "color", "numberOfPoints", "plotlineColors", "plotlineWidth", "portfolioId", "portfolioSource", "positionId", "showLegend", "showPlotlines", "showTitle", "showTooltip", "spacingBottom", "spacingLeft", "spacingRight", "spacingTop", "valuationDatetime"]
member_groups:
  ...
  "RiskScenarioScatterPlotWidget": ["chartHeight?", "chartWidth?", "color", "numberOfPoints", "plotlineColors", "plotlineWidth", "portfolioId", "portfolioSource", "positionId", "showLegend", "showPlotlines", "showTitle", "showTooltip", "spacingBottom", "spacingLeft", "spacingRight", "spacingTop", "valuationDatetime"]
reference_count: 8
references: ["SDK.InfrontSDK.SymbolId", "WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.RiskScenarioScatterPlotWidget", "WTK.SvelteWidgetOptions", "WTK.InfrontWidget"]
---

# RiskScenarioScatterPlotWidgetOptions

RiskScenarioScatterPlotWidgetOptions class extending SvelteSingleInstrumentWidgetBaseOptions class.

Set Options for the RiskScenarioScatterPlotWidget.

#### See

RiskScenarioScatterPlotWidget | SvelteWidgetOptions | SvelteSingleInstrumentWidgetBaseOptions
...
Define color for the scatter chart dots.

Or set color by css-variable: --wtk-risk-scenario-scatter-plot-options-color
...
Define two colors for the two plotlines.

Or set colors by css-variables:

- --wtk-risk-scenario-scatter-plot-options-x-plotline-color
- --wtk-risk-scenario-scatter-plot-options-y-plotline-color

##### Default Value

`['#33A8CC', '#334CCC']` - default set by failover
...
```ts
showPlotlines: boolean = true
```

Show or hide the plotlines on the chart.

The plotlines show the x- and y-position of the selected portfolio-position.
