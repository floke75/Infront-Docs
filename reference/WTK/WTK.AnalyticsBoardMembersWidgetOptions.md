---
title: "AnalyticsBoardMembersWidgetOptions"
qualified_name: "WTK.AnalyticsBoardMembersWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > AnalyticsBoardMembersWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsBoardMembersWidgetOptions.html"
defines: ["AnalyticsBoardMembersWidgetOptions"]
member_count: 22
members: ["instrument?", "decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "maxItems", "source", "topRolesCssClass"]
member_groups:
  ...
  "AnalyticsBoardMembersWidget": ["maxItems", "source", "topRolesCssClass"]
reference_count: 9
references: ["SDK.InfrontSDK.SymbolId", "WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "SDK.InfrontSDK.CoreDataAPI.CdapiEquityCompaniesDataCompanySource", "WTK.AnalyticsBoardMembersWidget", "WTK.SvelteWidgetOptions", "WTK.InfrontWidget"]
---

# AnalyticsBoardMembersWidgetOptions

AnalyticsBoardMembersWidgetOptions class extending SvelteSingleInstrumentWidgetBaseOptions class.

Set Options for the AnalyticsBoardMembersWidget.

#### See

AnalyticsBoardMembersWidget | SvelteWidgetOptions | SvelteSingleInstrumentWidgetBaseOptions
...
```ts
source: CdapiEquityCompaniesDataCompanySource = 'INFRONT'
```
...
```ts
topRolesCssClass: string
```

Add CSS class for the top roles chairman and vice chairman.

Using the pre-defined class `cell-table__field--top-roles` will use toolkit default highlight style.
