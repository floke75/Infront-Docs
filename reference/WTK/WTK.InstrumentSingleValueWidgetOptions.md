---
title: "InstrumentSingleValueWidgetOptions"
qualified_name: "WTK.InstrumentSingleValueWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > InstrumentSingleValueWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.InstrumentSingleValueWidgetOptions.html"
defines: ["InstrumentSingleValueWidgetOptions"]
member_count: 40
members: ["hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "tagConverter", "decimals", "defaultContent", "instrument", "allowZero", "blinkDuration", "blinkType", "className?", "column", "compute", "computeFields", "content", "currencyClassName?", "dataItem", "dataType", "enableChangeStatusColors", "hover?", "name", "onClick?", "rootElement", "showCurrency", "translate?", "type?"]
member_groups:
  ...
  "InstrumentSingleValueWidget": ["tagConverter"]
...
reference_count: 11
references: ["WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.Field", "WTK.BlinkDuration", "WTK.BlinkType", "WTK.DataType", "WTK.ValueWidgetOptions", "WTK.InstrumentSingleValueWidget", "WTK.WidgetOptions", "WTK.InfrontWidget"]
---

# InstrumentSingleValueWidgetOptions

InstrumentSingleValueWidgetOptions class extending ValueWidgetOptions class.

Set options for the InstrumentSingleValueWidget.

#### See

InstrumentSingleValueWidget | WidgetOptions | ValueWidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.InstrumentSingleValueWidgetOptions))
...
```ts
tagConverter: (symbol: Symbol, column: Field) => number
```
...
- (symbol: Symbol, column: Field): number
...
Inherited from ValueWidgetOptions.instrument
...
Inherited from ValueWidgetOptions.onClick
