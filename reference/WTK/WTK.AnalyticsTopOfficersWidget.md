---
title: "AnalyticsTopOfficersWidget"
qualified_name: "WTK.AnalyticsTopOfficersWidget"
kind: class
...
nav_path: "WTK > Analytics Widgets > AnalyticsTopOfficersWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsTopOfficersWidget.html"
defines: ["AnalyticsTopOfficersWidget"]
member_count: 14
...
related_types: ["WTK.AnalyticsTopOfficersWidgetOptions"]
reference_count: 5
references: ["WTK.UI", "WTK.AnalyticsTopOfficersWidgetOptions", "WTK.WidgetState", "WTK.WidgetBase", "WTK.InfrontWidget"]
---

# AnalyticsTopOfficersWidget

AnalyticsTopOfficersWidget class extending SvelteSingleInstrumentWidgetBase class.

`InfrontWidget = infront.analyticsTopOfficersWidget(target, [options]);`

Displays the top officers of a company (instrument) in a simple table.

Options can be configured with AnalyticsTopOfficersWidgetOptions.

#### Example

```ts
// This configuration creates a window to add or modify the analytics top officers widget.
<script type="text/javascript">
    var opts = new Infront.AnalyticsTopOfficersWidgetOptions();
    opts.instrument = { ticker: 'BMW', feed: 26 };

    widget = infront.analyticsTopOfficersWidget("#analyticsTopOfficersWidget, opts);
</script>
...
<div id="analyticsTopOfficersWidget"></div>
```

#### See

AnalyticsTopOfficersWidgetOptions | WidgetBase | SvelteSingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<AnalyticsTopOfficersWidgetOptions>
...
    element: HTMLElement,
    infrontUI: UI,
    options: AnalyticsTopOfficersWidgetOptions,
...
- infrontUI: UI
- options: AnalyticsTopOfficersWidgetOptions
- widgetFn: SvelteWidgetFn<AnalyticsTopOfficersWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: AnalyticsTopOfficersWidgetOptions): void
```
