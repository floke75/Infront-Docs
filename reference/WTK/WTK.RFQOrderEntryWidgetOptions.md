---
title: "RFQOrderEntryWidgetOptions"
qualified_name: "WTK.RFQOrderEntryWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > RFQOrderEntryWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.RFQOrderEntryWidgetOptions.html"
defines: ["RFQOrderEntryWidgetOptions"]
member_count: 23
members: ["instrument?", "decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "clientBIC?", "searchDetailedOptions?", "selectedPortfolio?", "showSettlementTypeDropdown"]
member_groups:
  ...
  "Other": ["clientBIC?", "searchDetailedOptions?", "selectedPortfolio?", "showSettlementTypeDropdown"]
reference_count: 7
references: ["SDK.InfrontSDK.SymbolId", "WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.RFQOrderEntryWidget", "WTK.InfrontWidget"]
---

# RFQOrderEntryWidgetOptions

RFQOrderEntryWidgetOptions class extending SvelteSingleInstrumentWidgetBaseOptions.

Set Options for the RFQOrderEntryWidget.
...
Client BIC (Bank Identifier Code) for the RFQ request.
Required by some brokers to identify the requesting institution.

##### Default Value

`undefined`

#### `Optional` searchDetailedOptions

```ts
searchDetailedOptions?: Partial<SearchDetailedOptions>
```

Additional options to pass to the search.
These are merged with the default search options, allowing customization of search behavior.

##### Default Value

`undefined`

#### `Optional` selectedPortfolio
...
If set, the portfolio dropdown will default to this portfolio.
