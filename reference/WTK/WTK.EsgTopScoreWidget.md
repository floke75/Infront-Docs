---
title: "EsgTopScoreWidget"
qualified_name: "WTK.EsgTopScoreWidget"
kind: class
...
module: "WTK"
group: "Widgets"
nav_path: "WTK > Widgets > EsgTopScoreWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.EsgTopScoreWidget.html"
defines: ["EsgTopScoreWidget"]
member_count: 14
...
related_types: ["WTK.EsgTopScoreWidgetOptions", "WTK.StaticSvelteInfrontWidgetComponent"]
reference_count: 6
references: ["WTK.UI", "WTK.EsgTopScoreWidgetOptions", "WTK.WidgetState", "WTK.WidgetBase", "WTK.InfrontWidget", "WTK.StaticSvelteInfrontWidgetComponent"]
---

# EsgTopScoreWidget

[EsgTopScoreWidget](#) class extending SvelteSingleInstrumentWidgetBase.

`InfrontWidget = Infront.esgTopScoreWidget(target, [options]);`

This widget is used to display the total ESG (Environmental Social Governance) score for specific company.
Options can be configured with EsgTopScoreWidgetOptions.

#### Example

```ts
<script type="text/javascript">
    var opts = new Infront.EsgTopScoreWidgetOptions();
    opts.instrument = new Infront.Instrument(17921, "ABB");
    infront.esgTopScoreWidget('EsgTopScoreWidget', opts);
</script>
...
<div id="EsgTopScoreWidget"></div>
```

#### See

EsgTopScoreWidgetOptions | WidgetBase | SvelteSingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<EsgTopScoreWidgetOptions>

  - EsgTopScoreWidget

#### Implements

- [StaticSvelteInfrontWidgetComponent](./WTK.StaticSvelteInfrontWidgetComponent.md)<typeof EsgTopScoreWidget>
...
    element: HTMLElement,
    infrontUI: UI,
    options: EsgTopScoreWidgetOptions,
    widgetFn: SvelteWidgetFn<EsgTopScoreWidgetOptions, Record<string, any>>,
): void
```
...
```ts
validateOptions(options: EsgTopScoreWidgetOptions): void
```
