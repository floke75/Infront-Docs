---
title: "AnalyticsAnalystsWidget"
qualified_name: "WTK.AnalyticsAnalystsWidget"
kind: class
...
nav_path: "WTK > Analytics Widgets > AnalyticsAnalystsWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsAnalystsWidget.html"
defines: ["AnalyticsAnalystsWidget"]
member_count: 14
...
related_types: ["WTK.AnalyticsAnalystsWidgetOptions"]
reference_count: 5
references: ["WTK.UI", "WTK.AnalyticsAnalystsWidgetOptions", "WTK.WidgetState", "WTK.WidgetBase", "WTK.InfrontWidget"]
---

# AnalyticsAnalystsWidget

AnalyticsAnalystsWidget class extending SvelteSingleInstrumentWidgetBase class.

`InfrontWidget = infront.analyticsAnalystsWidget(target, [options]);`

Displays the board members of a company (instrument) in a simple table.

Options can be configured with AnalyticsAnalystsWidgetOptions.
...
<script type="text/javascript">
    var opts = new Infront.AnalyticsAnalystsWidgetOptions();
    opts.instrument = { ticker: 'BMW', feed: 26 };

    widget = infront.analyticsAnalystsWidget("#analyticsAnalystsWidget, opts);
</script>
...
<div id="analyticsAnalystsWidget"></div>
```

#### See

AnalyticsAnalystsWidgetOptions | WidgetBase | SvelteSingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<AnalyticsAnalystsWidgetOptions>
...
    element: HTMLElement,
    infrontUI: UI,
    options: AnalyticsAnalystsWidgetOptions,
...
- infrontUI: UI
- options: AnalyticsAnalystsWidgetOptions
- widgetFn: SvelteWidgetFn<AnalyticsAnalystsWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: AnalyticsAnalystsWidgetOptions): void
```
