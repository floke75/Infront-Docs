---
title: "AnalyticsHistoricalRecommendationsWidget"
qualified_name: "WTK.AnalyticsHistoricalRecommendationsWidget"
kind: class
...
nav_path: "WTK > Analytics Widgets > AnalyticsHistoricalRecommendationsWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsHistoricalRecommendationsWidget.html"
defines: ["AnalyticsHistoricalRecommendationsWidget"]
member_count: 14
...
related_types: ["WTK.AnalyticsHistoricalRecommendationsWidgetOptions", "WTK.StaticSvelteInfrontWidgetComponent"]
reference_count: 7
references: ["WTK.UI", "WTK.AnalyticsHistoricalRecommendationsWidgetOptions", "WTK.WidgetState", "WTK.WidgetBase", "WTK.SingleInstrumentWidgetBase", "WTK.InfrontWidget", "WTK.StaticSvelteInfrontWidgetComponent"]
---

# AnalyticsHistoricalRecommendationsWidget

AnalyticsHistoricalRecommendationsWidget class extending SvelteSingleInstrumentWidgetBase class.

`InfrontWidget = infront.analyticsHistoricalRecommendationsWidget(target, [options]);`

This widget is used for displaying the instrument's target-price details in a table
and a chart comparing close-price with target-price median.

Options can be configured with AnalyticsHistoricalRecommendationsWidgetOptions.

#### Example

```ts
<script type="text/javascript">
    var opts = new infront.AnalyticsHistoricalRecommendationsWidgetOptions();
    opts.instrument = { ticker: 'BMW', feed: 26 };

    widget = infront.analyticsHistoricalRecommendationsWidget("#analyticsHistoricalRecommendations", opts);
</script>
...
<div id="analyticsHistoricalRecommendations"></div>
```

#### See

AnalyticsHistoricalRecommendationsWidgetOptions | WidgetBase | SingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<    AnalyticsHistoricalRecommendationsWidgetOptions,>

  - AnalyticsHistoricalRecommendationsWidget

#### Implements

- [StaticSvelteInfrontWidgetComponent](./WTK.StaticSvelteInfrontWidgetComponent.md)<
  typeof AnalyticsHistoricalRecommendationsWidget,
  >
...
    element: HTMLElement,
    infrontUI: UI,
    options: AnalyticsHistoricalRecommendationsWidgetOptions,
    widgetFn: SvelteWidgetFn<
        AnalyticsHistoricalRecommendationsWidgetOptions,
        Record<string, any>,
    >,
): void
```
...
```ts
validateOptions(options: AnalyticsHistoricalRecommendationsWidgetOptions): void
```
