---
title: "InstrumentCardWidget"
qualified_name: "WTK.InstrumentCardWidget"
kind: class
...
module: "WTK"
group: "Widgets"
nav_path: "WTK > Widgets > InstrumentCardWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.InstrumentCardWidget.html"
defines: ["InstrumentCardWidget"]
member_count: 14
...
related_types: ["WTK.InstrumentCardWidgetOptions", "WTK.StaticSvelteInfrontWidgetComponent"]
reference_count: 4
references: ["WTK.UI", "WTK.InstrumentCardWidgetOptions", "WTK.WidgetState", "WTK.StaticSvelteInfrontWidgetComponent"]
---

# InstrumentCardWidget

InstrumentCardWidget - displays flag, ticker, currency, timestamp, description,
last price and intraday percent change for a single instrument.
...
- SvelteSingleInstrumentWidgetBase<InstrumentCardWidgetOptions>

  - InstrumentCardWidget

#### Implements

- [StaticSvelteInfrontWidgetComponent](./WTK.StaticSvelteInfrontWidgetComponent.md)<typeof InstrumentCardWidget>
...
    element: HTMLElement,
    infrontUI: UI,
    options: InstrumentCardWidgetOptions,
    widgetFn: SvelteWidgetFn<InstrumentCardWidgetOptions, Record<string, any>>,
): void
```
...
```ts
validateOptions(options: InstrumentCardWidgetOptions): void
```
