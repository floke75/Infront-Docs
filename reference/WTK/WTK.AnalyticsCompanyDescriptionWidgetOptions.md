---
title: "AnalyticsCompanyDescriptionWidgetOptions"
qualified_name: "WTK.AnalyticsCompanyDescriptionWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > AnalyticsCompanyDescriptionWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsCompanyDescriptionWidgetOptions.html"
defines: ["AnalyticsCompanyDescriptionWidgetOptions"]
member_count: 20
members: ["instrument?", "decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "source"]
member_groups:
  ...
  "AnalyticsCompanyDescriptionWidget": ["source"]
reference_count: 9
references: ["SDK.InfrontSDK.SymbolId", "WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "SDK.InfrontSDK.CoreDataAPI.CdapiEquityCompaniesDataCompanySource", "WTK.AnalyticsCompanyDescriptionWidget", "WTK.SvelteWidgetOptions", "WTK.InfrontWidget"]
---

# AnalyticsCompanyDescriptionWidgetOptions

AnalyticsCompanyDescriptionWidgetOptions class extending SvelteSingleInstrumentWidgetBaseOptions class.

Set Options for the AnalyticsCompanyDescriptionWidget.

#### See

AnalyticsCompanyDescriptionWidget | SvelteWidgetOptions | SvelteSingleInstrumentWidgetBaseOptions
...
Source for the company description data.
