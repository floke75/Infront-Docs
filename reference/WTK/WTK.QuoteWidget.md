---
title: "QuoteWidget"
qualified_name: "WTK.QuoteWidget"
kind: class
...
module: "WTK"
group: "Widgets"
nav_path: "WTK > Widgets > QuoteWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.QuoteWidget.html"
defines: ["QuoteWidget"]
member_count: 11
...
reference_count: 5
references: ["WTK.WidgetSubscriptions", "WTK.ValueWidget", "WTK.QuoteWidgetOptions", "WTK.WidgetBase", "WTK.InfrontWidget"]
---

# QuoteWidget

QuoteWidget class extending ValueWidget class.

`InfrontWidget = Infront.quoteWidget(target, [options]);`

Widget that displays a single quote

Options can be configured with QuoteWidgetOptions.
...
QuoteWidgetOptions | WidgetBase | ValueWidget | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.QuoteWidget))
