---
title: "AnalyticsGprvScoreCardWidget"
qualified_name: "WTK.AnalyticsGprvScoreCardWidget"
kind: class
...
nav_path: "WTK > Analytics Widgets > AnalyticsGprvScoreCardWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsGprvScoreCardWidget.html"
defines: ["AnalyticsGprvScoreCardWidget"]
member_count: 14
...
related_types: ["WTK.AnalyticsGprvScoreCardWidgetOptions", "WTK.StaticSvelteInfrontWidgetComponent"]
reference_count: 7
references: ["WTK.UI", "WTK.AnalyticsGprvScoreCardWidgetOptions", "WTK.WidgetState", "WTK.WidgetBase", "WTK.SingleInstrumentWidgetBase", "WTK.InfrontWidget", "WTK.StaticSvelteInfrontWidgetComponent"]
---

# AnalyticsGprvScoreCardWidget

The [AnalyticsGprvScoreCardWidget](#) provides a quick way to visualize
an instrument's GPRV scores compared to its sector average.

#### See

AnalyticsGprvScoreCardWidgetOptions | WidgetBase | SingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<AnalyticsGprvScoreCardWidgetOptions>

  - AnalyticsGprvScoreCardWidget

#### Implements

- [StaticSvelteInfrontWidgetComponent](./WTK.StaticSvelteInfrontWidgetComponent.md)<typeof AnalyticsGprvScoreCardWidget>
...
    element: HTMLElement,
    infrontUI: UI,
    options: AnalyticsGprvScoreCardWidgetOptions,
...
- infrontUI: UI
- options: AnalyticsGprvScoreCardWidgetOptions
- widgetFn: SvelteWidgetFn<AnalyticsGprvScoreCardWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: AnalyticsGprvScoreCardWidgetOptions): void
```
