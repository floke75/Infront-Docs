---
title: "AnalyticsTargetPriceWidget"
qualified_name: "WTK.AnalyticsTargetPriceWidget"
kind: class
...
nav_path: "WTK > Analytics Widgets > AnalyticsTargetPriceWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsTargetPriceWidget.html"
defines: ["AnalyticsTargetPriceWidget"]
member_count: 14
...
related_types: ["WTK.AnalyticsTargetPriceWidgetOptions", "WTK.StaticSvelteInfrontWidgetComponent"]
reference_count: 7
references: ["WTK.UI", "WTK.AnalyticsTargetPriceWidgetOptions", "WTK.WidgetState", "WTK.WidgetBase", "WTK.SingleInstrumentWidgetBase", "WTK.InfrontWidget", "WTK.StaticSvelteInfrontWidgetComponent"]
---

# AnalyticsTargetPriceWidget

AnalyticsTargetPriceWidget class extending SvelteSingleInstrumentWidgetBase class.

`InfrontWidget = infront.analyticsTargetPriceWidget(target, [options]);`
...
Options can be configured with AnalyticsTargetPriceWidgetOptions.

#### Example

```ts
<script type="text/javascript">
    var opts = new infront.AnalyticsTargetPriceWidgetOptions();
    opts.instrument = { ticker: 'BMW', feed: 26 };

    widget = infront.analyticsTargetPriceWidget("#analyticsTargetPrice", opts);
</script>
...
<div id="analyticsTargetPrice"></div>
```

#### See

AnalyticsTargetPriceWidgetOptions | WidgetBase | SingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<AnalyticsTargetPriceWidgetOptions>

  - AnalyticsTargetPriceWidget

#### Implements

- [StaticSvelteInfrontWidgetComponent](./WTK.StaticSvelteInfrontWidgetComponent.md)<typeof AnalyticsTargetPriceWidget>
...
    element: HTMLElement,
    infrontUI: UI,
    options: AnalyticsTargetPriceWidgetOptions,
...
- infrontUI: UI
- options: AnalyticsTargetPriceWidgetOptions
- widgetFn: SvelteWidgetFn<AnalyticsTargetPriceWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: AnalyticsTargetPriceWidgetOptions): void
```
