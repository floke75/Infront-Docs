---
title: "HistoryWidgetOptions"
qualified_name: "WTK.HistoryWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > HistoryWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.HistoryWidgetOptions.html"
defines: ["HistoryWidgetOptions"]
member_count: 27
members: ["hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "columns", "endYear", "filterField", "filterSmallSplits", "startYear", "useRatioForSplit", "content", "decimals", "defaultContent", "instrument"]
member_groups:
  ...
  "HistoryWidget": ["columns", "endYear", "filterField", "filterSmallSplits", "startYear", "useRatioForSplit"]
  "SingleInstrumentWidget": ["content", "decimals", "defaultContent", "instrument"]
related_types: ["WTK.SingleInstrumentWidgetOptions"]
reference_count: 8
references: ["WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.HistoryWidgetColumn", "WTK.SingleInstrumentWidgetOptions", "WTK.HistoryWidget", "WTK.WidgetOptions", "WTK.InfrontWidget"]
---

# HistoryWidgetOptions

HistoryWidgetOptions class extending SingleInstrumentWidgetOptions class.

Set options for the HistoryWidget.

#### See

HistoryWidget | WidgetOptions | SingleInstrumentWidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.HistoryWidgetOptions))
...
```ts
columns: (string | HistoryWidgetColumn)[]
```

History widget columns.
...
```ts
filterSmallSplits: boolean = false
```
...
```ts
useRatioForSplit: boolean = false
```
