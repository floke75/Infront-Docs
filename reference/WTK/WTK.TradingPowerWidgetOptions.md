---
title: "TradingPowerWidgetOptions"
qualified_name: "WTK.TradingPowerWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > TradingPowerWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.TradingPowerWidgetOptions.html"
defines: ["TradingPowerWidgetOptions"]
member_count: 40
members: ["hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "decimals", "defaultContent", "instrument", "base", "allowZero", "blinkDuration", "blinkType", "className?", "column", "compute", "computeFields", "content", "currencyClassName?", "dataItem", "dataType", "enableChangeStatusColors", "hover?", "name", "onClick?", "rootElement", "showCurrency", "translate?", "type?"]
member_groups:
...
reference_count: 10
references: ["WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.BlinkDuration", "WTK.BlinkType", "WTK.DataType", "WTK.ValueWidgetOptions", "WTK.TradingPowerWidget", "WTK.WidgetOptions", "WTK.InfrontWidget"]
---

# TradingPowerWidgetOptions

TradingPowerWidgetOptions class extending ValueWidgetOptions class.

Set options for the TradingPowerWidget.

#### See

TradingPowerWidget | WidgetOptions | ValueWidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.TradingPowerWidgetOptions))
