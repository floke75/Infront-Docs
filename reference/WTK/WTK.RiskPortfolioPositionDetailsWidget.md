---
title: "RiskPortfolioPositionDetailsWidgetAlpha"
qualified_name: "WTK.RiskPortfolioPositionDetailsWidget"
kind: class
...
module: "WTK"
group: "Risk Widgets"
nav_path: "WTK > Risk Widgets > RiskPortfolioPositionDetailsWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.RiskPortfolioPositionDetailsWidget.html"
defines: ["RiskPortfolioPositionDetailsWidget"]
member_count: 41
...
related_types: ["WTK.RiskPortfolioPositionDetailsWidgetOptions"]
reference_count: 6
references: ["WTK.UI", "WTK.RiskPortfolioPositionDetailsWidgetOptions", "WTK.WidgetState", "SDK.InfrontSDK.SymbolId", "WTK.WidgetBase", "WTK.InfrontWidget"]
---

# RiskPortfolioPositionDetailsWidgetAlpha

RiskPortfolioPositionDetailsWidget class extending SvelteSingleInstrumentWidgetBase class.

`InfrontWidget = infront.riskPortfolioPositionDetailsWidget(target, [options]);`

The RiskPortfolioPositionDetails widget can be used as expandable pop-up window, which provides additional insights for a selected position:

- Key Figures – Detailed performance metrics, sensitivity & risk indicators, and market data.
- Simulated Scenarios – Projections based on the predidined distributional analysis.

Options can be configured with RiskPortfolioPositionDetailsWidgetOptions.

#### Example

```ts
<script type="text/javascript">
    var opts = new Infront.RiskPortfolioPositionDetailsWidgetOptions({
        portfolioSource: 'wtk',
        portfolioId: '123456',
        positionId: '876543',
    });

    widget = infront.riskPortfolioPositionDetailsWidget("RiskPortfolioPositionDetailsWidget", opts);
</script>
...
<div id="RiskPortfolioPositionDetailsWidget"></div>
```

#### See

RiskPortfolioPositionDetailsWidgetOptions | WidgetBase | SvelteSingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<RiskPortfolioPositionDetailsWidgetOptions>
...
```ts
new RiskPortfolioPositionDetailsWidget(
    parentElement: HTMLElement,
    infrontUI: UI,
    options: Partial<RiskPortfolioPositionDetailsWidgetOptions>,
): RiskPortfolioPositionDetailsWidget
```
...
##### Returns RiskPortfolioPositionDetailsWidget

Overrides SvelteSingleInstrumentWidgetBase<RiskPortfolioPositionDetailsWidgetOptions>.constructor
...
```ts
optionsProxy: OptionsStore<RiskPortfolioPositionDetailsWidgetOptions>
```
...
##### Returns RiskPortfolioPositionDetailsWidgetOptions
...
    element: HTMLElement,
    infrontUI: UI,
    options: RiskPortfolioPositionDetailsWidgetOptions,
...
- infrontUI: UI
- options: RiskPortfolioPositionDetailsWidgetOptions
- widgetFn: SvelteWidgetFn<RiskPortfolioPositionDetailsWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: RiskPortfolioPositionDetailsWidgetOptions): void
```
