---
title: "AnalyticsEstimatesBarWidget"
qualified_name: "WTK.AnalyticsEstimatesBarWidget"
kind: class
...
nav_path: "WTK > Analytics Widgets > AnalyticsEstimatesBarWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsEstimatesBarWidget.html"
defines: ["AnalyticsEstimatesBarWidget"]
member_count: 14
...
related_types: ["WTK.AnalyticsEstimatesBarWidgetOptions", "WTK.StaticSvelteInfrontWidgetComponent"]
reference_count: 7
references: ["WTK.UI", "WTK.AnalyticsEstimatesBarWidgetOptions", "WTK.WidgetState", "WTK.WidgetBase", "WTK.SingleInstrumentWidgetBase", "WTK.InfrontWidget", "WTK.StaticSvelteInfrontWidgetComponent"]
---

# AnalyticsEstimatesBarWidget

The [AnalyticsEstimatesBarWidget](#) provides a visual overview of the analyst recommendations.
This includes mostly estimate fields but also supports a generic amount of SymbolFields.

#### See

AnalyticsEstimatesBarWidgetOptions | WidgetBase | SingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<AnalyticsEstimatesBarWidgetOptions>

  - AnalyticsEstimatesBarWidget

#### Implements

- [StaticSvelteInfrontWidgetComponent](./WTK.StaticSvelteInfrontWidgetComponent.md)<typeof AnalyticsEstimatesBarWidget>
...
    element: HTMLElement,
    infrontUI: UI,
    options: AnalyticsEstimatesBarWidgetOptions,
...
- infrontUI: UI
- options: AnalyticsEstimatesBarWidgetOptions
- widgetFn: SvelteWidgetFn<AnalyticsEstimatesBarWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: AnalyticsEstimatesBarWidgetOptions): void
```
