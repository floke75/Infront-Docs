---
title: "RiskPortfolioPositionDetailsWidgetOptions"
qualified_name: "WTK.RiskPortfolioPositionDetailsWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > RiskPortfolioPositionDetailsWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.RiskPortfolioPositionDetailsWidgetOptions.html"
defines: ["RiskPortfolioPositionDetailsWidgetOptions"]
member_count: 37
members: ["instrument?", "decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "chartHeight?", "chartWidth?", "colors", "groupPadding", "pointPadding", "portfolioId", "portfolioSource", "positionId", "showChartTitle", "showLegend", "showTitle", "showTooltip", "spacingBottom", "spacingLeft", "spacingRight", "spacingTop", "underlyingLabelMode", "valuationDatetime"]
member_groups:
  ...
  "RiskPortfolioPositionDetailsWidget": ["chartHeight?", "chartWidth?", "colors", "groupPadding", "pointPadding", "portfolioId", "portfolioSource", "positionId", "showChartTitle", "showLegend", "showTitle", "showTooltip", "spacingBottom", "spacingLeft", "spacingRight", "spacingTop", "underlyingLabelMode", "valuationDatetime"]
reference_count: 8
references: ["SDK.InfrontSDK.SymbolId", "WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.RiskPortfolioPositionDetailsWidget", "WTK.SvelteWidgetOptions", "WTK.InfrontWidget"]
---

# RiskPortfolioPositionDetailsWidgetOptions

RiskPortfolioPositionDetailsWidgetOptions class extending SvelteSingleInstrumentWidgetBaseOptions class.

Set Options for the RiskPortfolioPositionDetailsWidget.

#### See

RiskPortfolioPositionDetailsWidget | SvelteWidgetOptions | SvelteSingleInstrumentWidgetBaseOptions
...
### RiskPortfolioPositionDetailsWidget
...
Or set colors by css-variable: --wtk-risk-portfolio-position-details-options-color-list
which should define a list of comma-separated colors.

##### Default Value

`['#50B432']` - default set by failover
...
Together with [RiskPortfolioPositionDetailsWidgetOptions.pointPadding](#pointpadding) this option can be used to optimize the column (bar) sizes.
...
Together with [RiskPortfolioPositionDetailsWidgetOptions.groupPadding](#grouppadding) this option can be used to optimize the column (bar) sizes.
...
Show or hide the chart title above the distribution chart.
...
```ts
underlyingLabelMode: UnderlyingLabelMode = 'ticker'
```

Controls how the underlying instrument label is displayed in derivative and structured-product risk groups.

- `'ticker'` - display ticker and feed number (` AAPL [15]`)
- `'isin'` - ISIN code
- `'vwdKey'` - vwd key
