---
title: "AnalyticsEstimatesTableWidget"
qualified_name: "WTK.AnalyticsEstimatesTableWidget"
kind: class
...
nav_path: "WTK > Analytics Widgets > AnalyticsEstimatesTableWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsEstimatesTableWidget.html"
defines: ["AnalyticsEstimatesTableWidget"]
member_count: 14
...
related_types: ["WTK.AnalyticsEstimatesTableWidgetOptions", "WTK.StaticSvelteInfrontWidgetComponent"]
reference_count: 4
references: ["WTK.UI", "WTK.AnalyticsEstimatesTableWidgetOptions", "WTK.WidgetState", "WTK.StaticSvelteInfrontWidgetComponent"]
---

# AnalyticsEstimatesTableWidget

AnalyticsEstimatesTableWidget class extending SvelteSingleInstrumentWidgetBase class.

Options can be configured with AnalyticsEstimatesTableWidgetOptions.

#### Example

```ts
<script type="text/javascript">
    widget = infront.widget(AnalyticsEstimatesTableWidget, "#targetId", {
      // options
    });
</script>
...
...
```ts
<script type="text/javascript">
    widget = infront.analyticsEstimatesTableWidget("#targetId", {
      // options
    });
</script>
...
...
AnalyticsEstimatesTableWidgetOptions | SvelteSingleInstrumentWidgetBase

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<AnalyticsEstimatesTableWidgetOptions>

  - AnalyticsEstimatesTableWidget

#### Implements

- [StaticSvelteInfrontWidgetComponent](./WTK.StaticSvelteInfrontWidgetComponent.md)<typeof AnalyticsEstimatesTableWidget>
...
    element: HTMLElement,
    infrontUI: UI,
    options: AnalyticsEstimatesTableWidgetOptions,
...
- infrontUI: UI
- options: AnalyticsEstimatesTableWidgetOptions
- widgetFn: SvelteWidgetFn<AnalyticsEstimatesTableWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: AnalyticsEstimatesTableWidgetOptions): void
```
