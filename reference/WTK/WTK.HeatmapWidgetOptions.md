---
title: "HeatmapWidgetOptions"
qualified_name: "WTK.HeatmapWidgetOptions"
kind: class
...
member_groups:
  ...
  "HeatmapWidget": ["chain", "chains", "chainsProviderId", "colorClippingThreshold", "defaultChain", "defaultColor", "feed", "heatmapPeriod", "instruments", "instrumentTypes", "layout", "maxItems", "mode", "onInstrumentSelected", "rangeDownMaxColor", "rangeDownMinColor", "rangeUpMaxColor", "rangeUpMinColor", "sortOrder", "streaming", "useChains"]
...
reference_count: 15
references: ["WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.WidgetDecimals", "WTK.Field", "WTK.SortOrder", "WTK.QuoteListTabOptions", "WTK.ListUIFactory", "WTK.HeatmapPeriod", "WTK.ListLayout", "WTK.HeatmapMode", "WTK.CommonListOptions", "WTK.HeatmapWidget", "WTK.WidgetOptions", "WTK.InfrontWidget"]
---

# HeatmapWidgetOptions

HeatmapWidgetOptions class extending CommonListOptions class.

Set options for the HeatmapWidget.

#### See

HeatmapWidget | WidgetOptions | CommonListOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.HeatmapWidgetOptions))
...
Uses chains array instead (of feed number) to populate instruments
...
#### colorClippingThreshold

```ts
colorClippingThreshold: number = 3
```
...
```ts
heatmapPeriod: HeatmapPeriod = HeatmapPeriod.INTRADAY
```
...
[HeatmapPeriod](./WTK.HeatmapPeriod.md)

##### Default Value

`HeatmapPeriod.INTRADAY`
...
```ts
layout: ListLayout = ListLayout.CARD
```
...
Overrides CommonListOptions.layout
...
Selects what should the instruments be based on possible values
`'CHAINS'`, `'WATCHLIST'` or blank

##### See

[HeatmapMode](./WTK.HeatmapMode.md)
...
The callback receives the concrete instrument that was clicked, as an Instrument-object, as a parameter.
...
Overrides CommonListOptions.streaming
