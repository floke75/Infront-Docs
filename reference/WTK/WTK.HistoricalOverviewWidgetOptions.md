---
title: "HistoricalOverviewWidgetOptions"
qualified_name: "WTK.HistoricalOverviewWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > HistoricalOverviewWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.HistoricalOverviewWidgetOptions.html"
defines: ["HistoricalOverviewWidgetOptions"]
member_count: 23
members: ["hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "barPeriod", "historicFields", "content", "decimals", "defaultContent", "instrument"]
member_groups:
  ...
  "HistoricalOverviewWidget": ["barPeriod", "historicFields"]
  "SingleInstrumentWidget": ["content", "decimals", "defaultContent", "instrument"]
related_types: ["WTK.SingleInstrumentWidgetOptions"]
reference_count: 7
references: ["WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.SingleInstrumentWidgetOptions", "WTK.HistoricalOverviewWidget", "WTK.WidgetOptions", "WTK.InfrontWidget"]
---

# HistoricalOverviewWidgetOptions

HistoricalOverviewWidgetOptions class extending SingleInstrumentWidgetOptions class.

Set options for the HistoricalOverviewWidget.

#### See

HistoricalOverviewWidget | WidgetOptions | SingleInstrumentWidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.HistoricalOverviewWidgetOptions))
...
```ts
barPeriod: HistoricalPeriods | HistoricalTotalPeriods = InfrontConstants.HistoricalPeriods.ONE_YEAR
```
...
```ts
historicFields: (HistoricalPeriods | HistoricalTotalPeriods)[] = ...
```
...
InfrontConstants.HistoricalPeriods | InfrontConstants.HistoricalTotalPeriods.

##### Default Value

`[InfrontConstants.HistoricalPeriods.ONE_WEEK, InfrontConstants.HistoricalPeriods.ONE_MONTH, InfrontConstants.HistoricalPeriods.THREE_MONTH, InfrontConstants.HistoricalPeriods.SIX_MONTH, InfrontConstants.HistoricalPeriods.YTD]`
