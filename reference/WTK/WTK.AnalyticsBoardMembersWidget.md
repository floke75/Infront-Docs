---
title: "AnalyticsBoardMembersWidget"
qualified_name: "WTK.AnalyticsBoardMembersWidget"
kind: class
...
nav_path: "WTK > Analytics Widgets > AnalyticsBoardMembersWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsBoardMembersWidget.html"
defines: ["AnalyticsBoardMembersWidget"]
member_count: 14
...
related_types: ["WTK.AnalyticsBoardMembersWidgetOptions"]
reference_count: 5
references: ["WTK.UI", "WTK.AnalyticsBoardMembersWidgetOptions", "WTK.WidgetState", "WTK.WidgetBase", "WTK.InfrontWidget"]
---

# AnalyticsBoardMembersWidget

AnalyticsBoardMembersWidget class extending SvelteSingleInstrumentWidgetBase class.

`InfrontWidget = infront.analyticsBoardMembersWidget(target, [options]);`

Displays the board members of a company (instrument) in a simple table.

Options can be configured with AnalyticsBoardMembersWidgetOptions.

#### Example

```ts
// This configuration creates a window to add or modify the analytics board members widget.
<script type="text/javascript">
    var opts = new Infront.AnalyticsBoardMembersWidgetOptions();
    opts.instrument = { ticker: 'BMW', feed: 26 };

    widget = infront.analyticsBoardMembersWidget("#analyticsBoardMembersWidget, opts);
</script>
...
<div id="analyticsBoardMembersWidget"></div>
```

#### See

AnalyticsBoardMembersWidgetOptions | WidgetBase | SvelteSingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<AnalyticsBoardMembersWidgetOptions>
...
    element: HTMLElement,
    infrontUI: UI,
    options: AnalyticsBoardMembersWidgetOptions,
...
- infrontUI: UI
- options: AnalyticsBoardMembersWidgetOptions
- widgetFn: SvelteWidgetFn<AnalyticsBoardMembersWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: AnalyticsBoardMembersWidgetOptions): void
```
