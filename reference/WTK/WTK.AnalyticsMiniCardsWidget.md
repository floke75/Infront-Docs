---
title: "AnalyticsMiniCardsWidget"
qualified_name: "WTK.AnalyticsMiniCardsWidget"
kind: class
...
nav_path: "WTK > Analytics Widgets > AnalyticsMiniCardsWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsMiniCardsWidget.html"
defines: ["AnalyticsMiniCardsWidget"]
member_count: 14
...
related_types: ["WTK.AnalyticsMiniCardsWidgetOptions"]
reference_count: 4
references: ["WTK.UI", "WTK.AnalyticsMiniCardsWidgetOptions", "WTK.WidgetState", "WTK.InfrontWidget"]
---

# AnalyticsMiniCardsWidget

AnalyticsMiniCardsWidget class extending SvelteSingleInstrumentWidgetBase class.

`InfrontWidget = infront.analyticsMiniCards(target, [options]);`

This widget is used for displaying fundamental & estimate data consisting of a axis-less bar-chart to compare the data.

Options can be configured with AnalyticsMiniCardsWidgetOptions.
...
<script type="text/javascript">
    var opts = new Infront.AnalyticsMiniCardsWidgetOptions();
    ...
    widget = infront.analyticsMiniCardsWidget("#analyticsMiniCards, opts);
</script>
...
<div id="analyticsMiniCards"></div>
```

#### See

AnalyticsMiniCardsWidgetOptions | SvelteSingleInstrumentWidgetBase | SvelteWidgetBase | SvelteInfrontWidget | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<AnalyticsMiniCardsWidgetOptions>
...
    element: HTMLElement,
    infrontUI: UI,
    options: AnalyticsMiniCardsWidgetOptions,
...
- infrontUI: UI
- options: AnalyticsMiniCardsWidgetOptions
- widgetFn: SvelteWidgetFn<AnalyticsMiniCardsWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: AnalyticsMiniCardsWidgetOptions): void
```
