---
title: "RiskPortfolioSelectWidgetBeta"
qualified_name: "WTK.RiskPortfolioSelectWidget"
kind: class
...
module: "WTK"
group: "Risk Widgets"
nav_path: "WTK > Risk Widgets > RiskPortfolioSelectWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.RiskPortfolioSelectWidget.html"
defines: ["RiskPortfolioSelectWidget"]
member_count: 44
...
related_types: ["WTK.RiskPortfolioSelectWidgetOptions", "WTK.StaticSvelteInfrontWidgetComponent"]
reference_count: 6
references: ["WTK.UI", "WTK.RiskPortfolioSelectWidgetOptions", "WTK.WidgetState", "SDK.InfrontSDK.PortfolioRisk.RiskListPortfolio", "SDK.InfrontSDK.SymbolId", "WTK.StaticSvelteInfrontWidgetComponent"]
---

# RiskPortfolioSelectWidgetBeta

RiskPortfolioSelectWidget class extending SvelteWidgetBase class.

A dropdown to select a portfolio. The list of portfolios is loaded from the IQ risk backend.

Options can be configured with RiskPortfolioSelectWidgetOptions.

#### Example

```ts
<script type="text/javascript">
    widget = infront.widget(RiskPortfolioSelectWidget, "#targetId", {
      // options
    });
</script>
...
...
```ts
<script type="text/javascript">
    widget = infront.riskPortfolioSelectWidget("#targetId", {
      // options
    });
...
RiskPortfolioSelectWidgetOptions | SvelteWidgetBase

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<RiskPortfolioSelectWidgetOptions>

  - RiskPortfolioSelectWidget

#### Implements

- [StaticSvelteInfrontWidgetComponent](./WTK.StaticSvelteInfrontWidgetComponent.md)<typeof RiskPortfolioSelectWidget>
...
```ts
new RiskPortfolioSelectWidget(
    parentElement: HTMLElement,
    infrontUI: UI,
    options: Partial<RiskPortfolioSelectWidgetOptions>,
): RiskPortfolioSelectWidget
```
...
##### Returns RiskPortfolioSelectWidget

Overrides SvelteSingleInstrumentWidgetBase<RiskPortfolioSelectWidgetOptions>.constructor
...
```ts
optionsProxy: OptionsStore<RiskPortfolioSelectWidgetOptions>
```
...
```ts
getSelection(): RiskListPortfolio
```

Beta

##### Returns [RiskListPortfolio](../SDK/SDK.InfrontSDK.PortfolioRisk.RiskListPortfolio.md)
...
    element: HTMLElement,
    infrontUI: UI,
    options: RiskPortfolioSelectWidgetOptions,
...
- infrontUI: UI
- options: RiskPortfolioSelectWidgetOptions
- widgetFn: SvelteWidgetFn<RiskPortfolioSelectWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: RiskPortfolioSelectWidgetOptions): void
```
