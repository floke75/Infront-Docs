---
title: "AnalyticsGprvScoreCardWidgetOptions"
qualified_name: "WTK.AnalyticsGprvScoreCardWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > AnalyticsGprvScoreCardWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsGprvScoreCardWidgetOptions.html"
defines: ["AnalyticsGprvScoreCardWidgetOptions"]
member_count: 30
members: ["instrument?", "decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "dropdownDirection", "innerDialStrokeWidth", "linkChannel?", "ltmSource", "onMetricClicked?", "onSectorSelected?", "onSectorTypeSelected?", "outerDialStrokeWidth", "sectorSelectorMode", "sectorType", "constructor"]
member_groups:
  ...
  "AnalyticsGprvScoreCardWidget": ["dropdownDirection", "innerDialStrokeWidth", "linkChannel?", "ltmSource", "onMetricClicked?", "onSectorSelected?", "onSectorTypeSelected?", "outerDialStrokeWidth", "sectorSelectorMode", "sectorType"]
  "Other": ["constructor"]
reference_count: 11
references: ["SDK.InfrontSDK.SymbolId", "WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "SDK.InfrontSDK.CoreDataAPI.CdapiGetEquityIssuersOptionsEquityIssuerKeyfigureSource", "WTK.SubSectorSelection", "WTK.AnalyticsGprvScoreCardWidget", "WTK.SvelteWidgetOptions", "WTK.InfrontWidget", "WTK.WidgetOptions"]
---

# AnalyticsGprvScoreCardWidgetOptions

[AnalyticsGprvScoreCardWidgetOptions](#) class extending SvelteSingleInstrumentWidgetBaseOptions class.

Set options for the AnalyticsGprvScoreCardWidget.

#### See

AnalyticsGprvScoreCardWidget | SvelteWidgetOptions | SvelteSingleInstrumentWidgetBaseOptions
...
#### innerDialStrokeWidth

```ts
innerDialStrokeWidth: number = 4
```

The thickness of the total score dial inner arc (the sector score).
...
Callback for the sector type has changed.

#### outerDialStrokeWidth

```ts
outerDialStrokeWidth: number = 6
```

The thickness of the total score dial outer arc (the instrument score).
...
```ts
sectorType: GprvSectorType = 'infrontSector'
```

The sector type to show the GRPV averages for.
...
```ts
new AnalyticsGprvScoreCardWidgetOptions(
    init?: Partial<AnalyticsGprvScoreCardWidgetOptions>,
): AnalyticsGprvScoreCardWidgetOptions
```

Initializes a new [AnalyticsGprvScoreCardWidgetOptions](#).
You can optionally specify an init object that specifies
a subset of properties to set on the new options object.

##### Parameters

- `Optional` init: Partial<AnalyticsGprvScoreCardWidgetOptions>

  The initial property values to set.

##### Returns AnalyticsGprvScoreCardWidgetOptions
