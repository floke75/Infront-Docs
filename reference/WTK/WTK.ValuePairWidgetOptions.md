---
title: "ValuePairWidgetOptions"
qualified_name: "WTK.ValuePairWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > ValuePairWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.ValuePairWidgetOptions.html"
defines: ["ValuePairWidgetOptions"]
member_count: 23
members: ["hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "content", "decimals", "defaultContent", "instrument", "leftField", "rightField"]
member_groups:
  ...
  "ValuePairWidget": ["leftField", "rightField"]
related_types: ["WTK.SingleInstrumentWidgetOptions"]
reference_count: 7
references: ["WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.SingleInstrumentWidgetOptions", "WTK.ValuePairWidget", "WTK.WidgetOptions", "WTK.InfrontWidget"]
---

# ValuePairWidgetOptions

ValuePairWidgetOptions class extending SingleInstrumentWidgetOptions class.

Set options for the ValuePairWidget.

#### See

ValuePairWidget | WidgetOptions | SingleInstrumentWidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.ValuePairWidgetOptions))
...
```ts
leftField: string | object
```

leftField takes a column definition, see example.
...
```ts
rightField: string | object
```

rightField takes a column definition, see example.
