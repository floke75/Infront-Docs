---
title: "PositionsWidgetOptions"
qualified_name: "WTK.PositionsWidgetOptions"
kind: class
...
member_groups:
  ...
  "PositionsWidget": ["displayRowColumns", "enableOrders", "enableTrades", "hideInstrumentSubtypes", "hideInstrumentTypes", "instrumentSubtypes", "instrumentTypes", "layout", "loans", "onChangeModeCallback", "onInstrumentSelected", "onOrderClick", "onTradeClick"]
  "TradingTableWidget": ["clickToLogin", "emptyListMessage", "hideEmptyList", "maxItems", "onItemCountChange", "showDeleteAll", "showPortfolio", "showPortfolioSelect", "titleClick"]
...
reference_count: 14
references: ["WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.WidgetDecimals", "WTK.Field", "WTK.SortOrder", "WTK.QuoteListTabOptions", "WTK.ListUIFactory", "WTK.ListLayout", "WTK.TradingTableWidgetOptions", "WTK.PositionsWidget", "WTK.WidgetOptions", "WTK.InfrontWidget", "WTK.CommonListOptions"]
---

# PositionsWidgetOptions

PositionsWidgetOptions class extending TradingTableWidgetOptions class.

Set options for the PositionsWidget.

#### See

PositionsWidget | WidgetOptions | TradingTableWidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.PositionsWidgetOptions))
...
Inherited from TradingTableWidgetOptions.columns
...
Displays columns based on given constants.

##### Default Value

`['AVG_PRICE', 'LAST', 'CURRENCY', 'INVESTED']`

Overrides TradingTableWidgetOptions.displayRowColumns
...
#### hideInstrumentSubtypes

```ts
hideInstrumentSubtypes: string[] = null
```

Hides instruments on given instrument sub types.
...
```ts
hideInstrumentTypes: string[] = null
```

Hides instruments on given instrument types.
...
```ts
instrumentSubtypes: string[] = null
```

Adds instruments on given instrument sub types.
...
Adds instruments given instrument types.
...
Overrides TradingTableWidgetOptions.layout
