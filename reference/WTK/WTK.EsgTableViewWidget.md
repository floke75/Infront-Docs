---
title: "EsgTableViewWidget"
qualified_name: "WTK.EsgTableViewWidget"
kind: class
...
module: "WTK"
group: "Widgets"
nav_path: "WTK > Widgets > EsgTableViewWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.EsgTableViewWidget.html"
defines: ["EsgTableViewWidget"]
member_count: 14
...
related_types: ["WTK.EsgTableViewWidgetOptions", "WTK.StaticSvelteInfrontWidgetComponent"]
reference_count: 6
references: ["WTK.UI", "WTK.EsgTableViewWidgetOptions", "WTK.WidgetState", "WTK.WidgetBase", "WTK.InfrontWidget", "WTK.StaticSvelteInfrontWidgetComponent"]
---

# EsgTableViewWidget

[EsgTableViewWidget](#) class extending SvelteSingleInstrumentWidgetBase.

`InfrontWidget = Infront.esgTableViewWidget(target, [options]);`

This widget is used to display ESG (Environmental Social Governance) details for specific company.
Options can be configured with EsgTableViewWidgetOptions.

#### Example

```ts
<script type="text/javascript">
    var opts = new Infront.EsgTableViewWidgetOptions();
    opts.instrument = new Infront.Instrument(17921, "ABB");
    infront.esgTableViewWidget('EsgTableViewWidget', opts);
</script>
...
...
EsgTableViewWidgetOptions | WidgetBase | SvelteSingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<EsgTableViewWidgetOptions>

  - EsgTableViewWidget

#### Implements

- [StaticSvelteInfrontWidgetComponent](./WTK.StaticSvelteInfrontWidgetComponent.md)<typeof EsgTableViewWidget>
...
    element: HTMLElement,
    infrontUI: UI,
    options: EsgTableViewWidgetOptions,
    widgetFn: SvelteWidgetFn<EsgTableViewWidgetOptions, Record<string, any>>,
): void
```
...
```ts
validateOptions(options: EsgTableViewWidgetOptions): void
```
