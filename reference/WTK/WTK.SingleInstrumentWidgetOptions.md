---
title: "SingleInstrumentWidgetOptions"
qualified_name: "WTK.SingleInstrumentWidgetOptions"
kind: class
...
nav_path: "WTK > Base Widget Options > SingleInstrumentWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.SingleInstrumentWidgetOptions.html"
defines: ["SingleInstrumentWidgetOptions"]
member_count: 21
members: ["hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "content", "decimals", "defaultContent", "instrument"]
member_groups:
...
related_types: ["WTK.WidgetOptions", "WTK.AlertWidgetOptions", "WTK.CompanyDescriptionWidgetOptions", "WTK.CompanyFundamentalsWidgetOptions", "WTK.DocumentsWidgetOptions", "WTK.FocusWidgetOptions", "WTK.FundAllocationWidgetOptions", "WTK.FundMorningstarRatingWidgetOptions", "WTK.FundRiskLevelWidgetOptions", "WTK.FundStylemapWidgetOptions", "WTK.HistoricalOverviewWidgetOptions", "WTK.HistoryWidgetOptions", "WTK.IndexOverviewWidgetOptions", "WTK.InstrumentOverviewWidgetOptions", "WTK.IntradayTradesSimpleWidgetOptions", "WTK.InstrumentValuesWidgetOptions", "WTK.OrderbookWidgetOptions", "WTK.ValuePairWidgetOptions", "WTK.ValueWidgetOptions"]
reference_count: 24
references: ["WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.WidgetOptions", "WTK.SingleInstrumentWidgetBase", "WTK.AlertWidgetOptions", "WTK.CompanyDescriptionWidgetOptions", "WTK.CompanyFundamentalsWidgetOptions", "WTK.DocumentsWidgetOptions", "WTK.FocusWidgetOptions", "WTK.FundAllocationWidgetOptions", "WTK.FundMorningstarRatingWidgetOptions", "WTK.FundRiskLevelWidgetOptions", "WTK.FundStylemapWidgetOptions", "WTK.HistoricalOverviewWidgetOptions", "WTK.HistoryWidgetOptions", "WTK.IndexOverviewWidgetOptions", "WTK.InstrumentOverviewWidgetOptions", "WTK.IntradayTradesSimpleWidgetOptions", "WTK.InstrumentValuesWidgetOptions", "WTK.OrderbookWidgetOptions", "WTK.ValuePairWidgetOptions", "WTK.ValueWidgetOptions", "WTK.InfrontWidget"]
---

# SingleInstrumentWidgetOptions

SingleInstrumentWidgetOptions class extending WidgetOptions class.

Set options for the SingleInstrumentWidgetBase.

#### See

SingleInstrumentWidgetBase | WidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.SingleInstrumentWidgetOptions))
...
- WidgetOptions
  ...
  - SingleInstrumentWidgetOptions
    ...
    - AlertWidgetOptions
    - CompanyDescriptionWidgetOptions
    - CompanyFundamentalsWidgetOptions
    - DocumentsWidgetOptions
    - FocusWidgetOptions
    - FundAllocationWidgetOptions
    - FundMorningstarRatingWidgetOptions
    - FundRiskLevelWidgetOptions
    - FundStylemapWidgetOptions
    - HistoricalOverviewWidgetOptions
    - HistoryWidgetOptions
    - IndexOverviewWidgetOptions
    - InstrumentOverviewWidgetOptions
    - IntradayTradesSimpleWidgetOptions
    - InstrumentValuesWidgetOptions
    - OrderbookWidgetOptions
    - ValuePairWidgetOptions
    - ValueWidgetOptions
...
Overrides WidgetOptions.decimals
