---
title: "CommunicationStatusWidgetOptions"
qualified_name: "WTK.CommunicationStatusWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > CommunicationStatusWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.CommunicationStatusWidgetOptions.html"
defines: ["CommunicationStatusWidgetOptions"]
member_count: 59
members: ["hasContentCallback", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "availableColumns", "className", "compareCaseInsensitive", "compareCaseInsensitiveLocale", "createExpandRow", "decimals", "defaultContent", "defaultSortOrder", "enableChangeStatusColors", "enableColumnsMove", "enableColumnsResize", "enableFixedHeader", "excludeUnsortedState", "expandableRows", "extraColumns", "extraOptions", "interactionHighlight", "layout", "linkTrigger", "loadSavedColumns", "onColumnDeleted", "onColumnExpand", "onColumnInsert", "onColumnMoved", "onColumnMoving", "onColumnsChanged", "onColumnsResized", "onResetColumns", "onSettingsClicked", "rowSelectable", "tabs", "uiFactory", "columns", "defaultSortedColumn", "id", "onRowClicked", "sortable", "sortOrder", "tableHeight", "clickToLogin", "hasTradingContentCallback", "rememberCanceledLogin", "tradingLoginCallback"]
member_groups:
  "Widget Options": ["hasContentCallback", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle"]
  "CommonListWidgetBase": ["availableColumns", "className", "compareCaseInsensitive", "compareCaseInsensitiveLocale", "createExpandRow", "decimals", "defaultContent", "defaultSortOrder", "enableChangeStatusColors", "enableColumnsMove", "enableColumnsResize", "enableFixedHeader", "excludeUnsortedState", "expandableRows", "extraColumns", "extraOptions", "interactionHighlight", "layout", "linkTrigger", "loadSavedColumns", "onColumnDeleted", "onColumnExpand", "onColumnInsert", "onColumnMoved", "onColumnMoving", "onColumnsChanged", "onColumnsResized", "onResetColumns", "onSettingsClicked", "rowSelectable", "tabs", "uiFactory"]
  "CommunicationStatusWidget": ["columns", "defaultSortedColumn", "id", "onRowClicked", "sortable", "sortOrder", "tableHeight"]
...
reference_count: 13
references: ["WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.WidgetDecimals", "WTK.SortOrder", "WTK.ListLayout", "WTK.QuoteListTabOptions", "WTK.ListUIFactory", "WTK.CommonListOptions", "WTK.CommunicationStatusWidget", "WTK.WidgetOptions", "WTK.InfrontWidget", "WTK.Field"]
---

# CommunicationStatusWidgetOptions

CommunicationStatusWidgetOptions class extending CommonListOptions class.

Set options for the CommunicationStatusWidget.

#### See

CommunicationStatusWidget | WidgetOptions | CommonListOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.CommunicationStatusWidgetOptions))
...
`Feed, Status, Category, IP Address, PID, SID`
...
```ts
defaultSortedColumn: any = '_FEED_DESCRIPTION'
```
...
Overrides CommonListOptions.id
