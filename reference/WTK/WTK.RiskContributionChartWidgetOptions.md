---
title: "RiskContributionChartWidgetOptions"
qualified_name: "WTK.RiskContributionChartWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > RiskContributionChartWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.RiskContributionChartWidgetOptions.html"
defines: ["RiskContributionChartWidgetOptions"]
member_count: 38
members: ["instrument?", "decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "chartHeight?", "chartWidth?", "colors", "groupPadding", "maxItems", "pointPadding", "portfolioId", "portfolioSource", "showLegend", "showTitle", "showTooltip", "sort", "spacingBottom", "spacingLeft", "spacingRight", "spacingTop", "tickPixelInterval", "type", "valuationDatetime"]
member_groups:
  ...
  "RiskContributionChartWidget": ["chartHeight?", "chartWidth?", "colors", "groupPadding", "maxItems", "pointPadding", "portfolioId", "portfolioSource", "showLegend", "showTitle", "showTooltip", "sort", "spacingBottom", "spacingLeft", "spacingRight", "spacingTop", "tickPixelInterval", "type", "valuationDatetime"]
reference_count: 8
references: ["SDK.InfrontSDK.SymbolId", "WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.RiskContributionChartWidget", "WTK.SvelteWidgetOptions", "WTK.InfrontWidget"]
---

# RiskContributionChartWidgetOptions

RiskContributionChartWidgetOptions class extending SvelteSingleInstrumentWidgetBaseOptions class.

Set Options for the RiskContributionChartWidget.

#### See

RiskContributionChartWidget | SvelteWidgetOptions | SvelteSingleInstrumentWidgetBaseOptions
...
- --wtk-risk-contribution-chart-options-bar-color
- --wtk-risk-contribution-chart-options-bar-negative-color
...
Together with [RiskContributionChartWidgetOptions.pointPadding](#pointpadding) this option can be used to optimize the column (bar) sizes.
...
Together with [RiskContributionChartWidgetOptions.groupPadding](#grouppadding) this option can be used to optimize the column (bar) sizes.
...
```ts
sort: "HIGHEST_RISK" | "HIGHEST_RETURN" | "LOWEST_RISK" | "LOWEST_RETURN" = 'LOWEST_RISK'
```
...
```ts
type: "RISK" | "RETURN" = 'RISK'
```

Whether the chart shows "Risk" or "Return" data.
