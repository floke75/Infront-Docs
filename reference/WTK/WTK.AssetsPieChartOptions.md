---
title: "AssetsPieChartOptions"
qualified_name: "WTK.AssetsPieChartOptions"
kind: class
...
nav_path: "WTK > Widget Options > AssetsPieChartOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AssetsPieChartOptions.html"
defines: ["AssetsPieChartOptions"]
member_count: 42
members: ["decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "alpha", "beta", "borderColor", "borderWidth", "colors", "depth", "enable3d", "enableLabels", "fontFamily", "innerSize", "legend", "legendLabelColor", "legendMaxHeight", "showCash", "spacingBottom", "spacingLeft", "spacingRight", "spacingTop", "styledMode", "type", "clickToLogin", "hasTradingContentCallback", "rememberCanceledLogin", "tradingLoginCallback"]
member_groups:
  ...
  "AssetsPieChart": ["alpha", "beta", "borderColor", "borderWidth", "colors", "depth", "enable3d", "enableLabels", "fontFamily", "innerSize", "legend", "legendLabelColor", "legendMaxHeight", "showCash", "spacingBottom", "spacingLeft", "spacingRight", "spacingTop", "styledMode", "type"]
...
reference_count: 8
references: ["WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.TradingWidgetOptions", "WTK.AssetsPieChart", "WTK.WidgetOptions", "WTK.InfrontWidget"]
---

# AssetsPieChartOptions

AssetsPieChartOptions class extending TradingWidgetOptions class.

Set options for the AssetsPieChart.

#### See

AssetsPieChart | WidgetOptions | TradingWidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.AssetsPieChartOptions))
...
Rotate chart around its x-axis ([AssetsPieChartOptions.enable3d](#enable3d) must be `true`).
...
Rotate chart around its y-axis ([AssetsPieChartOptions.enable3d](#enable3d) must be `true`).
...
`['#189fde', '#4dc46d', '#ffb319', '#f2564d', '#805e9d', '#3cd0ce', '#aef25f', '#ff8340', '#d069ae', '#26a69a', '#ffee58', '#5969bf']`
...
The depth/thickness of a 3d chart ([AssetsPieChartOptions.enable3d](#enable3d) must be `true`).
...
```ts
type: string = AssetsPieChart.kInstrumentTypes
```
