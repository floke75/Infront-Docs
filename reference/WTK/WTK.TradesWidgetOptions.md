---
title: "TradesWidgetOptions"
qualified_name: "WTK.TradesWidgetOptions"
kind: class
...
member_groups:
  ...
  "TradesWidget": ["columns", "hideInstrumentTypes", "showDateSelectors", "showFilter", "showHistoricTrades", "showInstrumentTypes", "showTodaysTrades"]
...
reference_count: 14
references: ["WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.WidgetDecimals", "WTK.Field", "WTK.SortOrder", "WTK.ListLayout", "WTK.QuoteListTabOptions", "WTK.ListUIFactory", "WTK.TradingTableWidgetOptions", "WTK.TradesWidget", "WTK.WidgetOptions", "WTK.InfrontWidget", "WTK.CommonListOptions"]
---

# TradesWidgetOptions

TradesWidgetOptions class extending TradingTableWidgetOptions class.

Set options for the TradesWidget.

#### See

TradesWidget | WidgetOptions | TradingTableWidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.TradesWidgetOptions))
...
```ts
showDateSelectors: boolean = false
```

Show the date selectors for setting a start and end date for which period to show historical data.

##### Default Value

`false`

Overrides TradingTableWidgetOptions.showDateSelectors
...
Show the input field for filtering the portfolio data.

Data in TradesWidget can be filtered by symbols,
which need to be provided as comma separated ticker strings.
Example: "BRD,EL,SNG"
...
Overrides TradingTableWidgetOptions.showFilter

#### showHistoricTrades

```ts
showHistoricTrades: boolean = false
```
...
```ts
showInstrumentTypes: string[]
```

What instrument types to show.
