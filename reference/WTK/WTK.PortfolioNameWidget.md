---
title: "PortfolioNameWidget"
qualified_name: "WTK.PortfolioNameWidget"
kind: class
...
nav_path: "WTK > Trading Widgets > PortfolioNameWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.PortfolioNameWidget.html"
defines: ["PortfolioNameWidget"]
member_count: 12
...
related_types: ["WTK.TradingWidgetBase"]
reference_count: 6
references: ["WTK.WidgetSubscriptions", "WTK.WidgetOptions", "WTK.TradingWidgetBase", "WTK.PortfolioNameWidgetOptions", "WTK.WidgetBase", "WTK.InfrontWidget"]
---

# PortfolioNameWidget

PortfolioNameWidget class extending TradingWidgetBase class.

`InfrontWidget = InfrontUI.portfolioNameWidget(target, [options]);`

Shows the name of the portfolio.

Options can be configured with PortfolioNameWidgetOptions.
...
<script type="text/javascript">
    ...
    infrontUI.portfolioNameWidget("#portfolioName", opts);
</script>
...
<div id="portfolioName"></div>
```

#### See

PortfolioNameWidgetOptions | WidgetBase | TradingWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.PortfolioNameWidget))
