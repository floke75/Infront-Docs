---
title: "AnalyticsHistoricalRecommendationsWidgetOptions"
qualified_name: "WTK.AnalyticsHistoricalRecommendationsWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > AnalyticsHistoricalRecommendationsWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsHistoricalRecommendationsWidgetOptions.html"
defines: ["AnalyticsHistoricalRecommendationsWidgetOptions"]
member_count: 21
members: ["instrument?", "decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "estimateSource", "constructor"]
member_groups:
  ...
  "AnalyticsHistoricalRecommendationsWidget": ["estimateSource"]
  "Other": ["constructor"]
reference_count: 9
references: ["SDK.InfrontSDK.SymbolId", "WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "SDK.InfrontSDK.CoreDataAPI.CdapiEquityCompanyEstimateSource", "WTK.AnalyticsHistoricalRecommendationsWidget", "WTK.SvelteWidgetOptions", "WTK.InfrontWidget"]
---

# AnalyticsHistoricalRecommendationsWidgetOptions

AnalyticsHistoricalRecommendationsWidgetOptions class extending SvelteSingleInstrumentWidgetBaseOptions class.

Set Options for the AnalyticsHistoricalRecommendationsWidget.

#### See

AnalyticsHistoricalRecommendationsWidget | SvelteWidgetOptions | SvelteSingleInstrumentWidgetBaseOptions
...
```ts
new AnalyticsHistoricalRecommendationsWidgetOptions(
    initOptions?: Partial<AnalyticsHistoricalRecommendationsWidgetOptions>,
): AnalyticsHistoricalRecommendationsWidgetOptions
```

Initializes a new [AnalyticsHistoricalRecommendationsWidgetOptions](#).
You can optionally specify an init object that specifies
a subset of properties to set on the new options object.

##### Parameters

- `Optional` initOptions: Partial<AnalyticsHistoricalRecommendationsWidgetOptions>

  The initial property values to set.

##### Returns AnalyticsHistoricalRecommendationsWidgetOptions
