---
title: "SvelteInstrumentSingleValueWidget"
qualified_name: "WTK.SvelteInstrumentSingleValueWidget"
kind: class
...
module: "WTK"
group: "Widgets"
nav_path: "WTK > Widgets > SvelteInstrumentSingleValueWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.SvelteInstrumentSingleValueWidget.html"
defines: ["SvelteInstrumentSingleValueWidget"]
member_count: 14
...
related_types: ["WTK.SvelteInstrumentSingleValueWidgetOptions", "WTK.StaticSvelteInfrontWidgetComponent"]
reference_count: 5
references: ["WTK.UI", "WTK.SvelteInstrumentSingleValueWidgetOptions", "WTK.WidgetState", "WTK.InfrontWidget", "WTK.StaticSvelteInfrontWidgetComponent"]
---

# SvelteInstrumentSingleValueWidget

SvelteInstrumentSingleValueWidget class extending SvelteSingleInstrumentWidgetBase class.

`InfrontWidget = infront.svelteInstrumentSingleValueWidget(target, [options]);`

This widget is capable of displaying/requesting a single SymbolField of an instrument.
Additionally it supports customizeable labels via options.

Options can be configured with SvelteInstrumentSingleValueWidgetOptions.

#### Example

```ts
// This configuration creates a window to add or modify svelte instrument single value widget.
<script type="text/javascript">
    var opts = new Infront.SvelteInstrumentSingleValueWidgetOptions();
    opts.instrument = { ticker: 'BMW', feed: 26 };
    opts.field = InfrontSDK.SymbolField.Last;

    widget = infront.svelteInstrumentSingleValueWidget("#svelteInstrumentSingleValue, opts);
</script>
...
<div id="svelteInstrumentSingleValue"></div>
```

#### See

[SvelteInstrumentSingleValueWidget](#) | SvelteWidgetBase | SvelteSingleInstrumentWidgetBaseOptions | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<SvelteInstrumentSingleValueWidgetOptions>

  - SvelteInstrumentSingleValueWidget

#### Implements

- [StaticSvelteInfrontWidgetComponent](./WTK.StaticSvelteInfrontWidgetComponent.md)<typeof SvelteInstrumentSingleValueWidget>
...
    element: HTMLElement,
    infrontUI: UI,
    options: SvelteInstrumentSingleValueWidgetOptions,
...
- infrontUI: UI
- options: SvelteInstrumentSingleValueWidgetOptions
- widgetFn: SvelteWidgetFn<SvelteInstrumentSingleValueWidgetOptions, Record<string, any>>
...
```ts
validateOptions(options: SvelteInstrumentSingleValueWidgetOptions): void
```
