---
title: "AnalyticsSectorInformationWidget"
qualified_name: "WTK.AnalyticsSectorInformationWidget"
kind: class
...
nav_path: "WTK > Analytics Widgets > AnalyticsSectorInformationWidget"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsSectorInformationWidget.html"
defines: ["AnalyticsSectorInformationWidget"]
member_count: 14
...
related_types: ["WTK.AnalyticsSectorInformationWidgetOptions", "WTK.StaticSvelteInfrontWidgetComponent"]
reference_count: 7
references: ["WTK.UI", "WTK.AnalyticsSectorInformationWidgetOptions", "WTK.WidgetState", "WTK.WidgetBase", "WTK.SingleInstrumentWidgetBase", "WTK.InfrontWidget", "WTK.StaticSvelteInfrontWidgetComponent"]
---

# AnalyticsSectorInformationWidget

AnalyticsSectorInformationWidget class extending SvelteSingleInstrumentWidgetBase class.

`InfrontWidget = infront.analyticsSectorInformationWidget(target, [options]);`

This widget is used for comparing companies' market-capitalizations.

Comparison can be done for a company, a sector, a sub-sector or a region.

Options can be configured with AnalyticsSectorInformationWidgetOptions.

#### Example

```ts
<script type="text/javascript">
    var opts = new infront.AnalyticsSectorInformationWidgetOptions({
    ...
    widget = infront.analyticsSectorInformationWidget("#analyticsSectorInfo", opts);
</script>
...
<div id="analyticsSectorInfo"></div>
```

#### See

AnalyticsSectorInformationWidgetOptions | WidgetBase | SingleInstrumentWidgetBase | [InfrontWidget](./WTK.InfrontWidget.md)

#### Hierarchy

- SvelteSingleInstrumentWidgetBase<AnalyticsSectorInformationWidgetOptions>

  - AnalyticsSectorInformationWidget

#### Implements

- [StaticSvelteInfrontWidgetComponent](./WTK.StaticSvelteInfrontWidgetComponent.md)<typeof AnalyticsSectorInformationWidget>
...
    element: HTMLElement,
    infrontUI: UI,
    options: AnalyticsSectorInformationWidgetOptions,
...
- infrontUI: UI
- options: AnalyticsSectorInformationWidgetOptions
- widgetFn: SvelteWidgetFn<AnalyticsSectorInformationWidgetOptions, Record<string, any>>
...
```ts
partialOptions(
    options: Partial<AnalyticsSectorInformationWidgetOptions>,
): Partial<AnalyticsSectorInformationWidgetOptions>
```
...
##### Returns Partial<AnalyticsSectorInformationWidgetOptions>
...
```ts
validateOptions(options: AnalyticsSectorInformationWidgetOptions): void
```
