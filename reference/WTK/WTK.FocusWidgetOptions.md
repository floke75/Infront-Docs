---
title: "FocusWidgetOptions"
qualified_name: "WTK.FocusWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > FocusWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.FocusWidgetOptions.html"
defines: ["FocusWidgetOptions"]
member_count: 23
members: ["hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "layout", "onClick", "content", "decimals", "defaultContent", "instrument"]
member_groups:
  ...
  "FocusWidget": ["layout", "onClick"]
  "SingleInstrumentWidget": ["content", "decimals", "defaultContent", "instrument"]
related_types: ["WTK.SingleInstrumentWidgetOptions"]
reference_count: 8
references: ["WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "WTK.FocusWidgetLayout", "WTK.SingleInstrumentWidgetOptions", "WTK.FocusWidget", "WTK.WidgetOptions", "WTK.InfrontWidget"]
---

# FocusWidgetOptions

FocusWidgetOptions class extending SingleInstrumentWidgetOptions class.

Set options for the FocusWidget.

#### See

FocusWidget | WidgetOptions | SingleInstrumentWidgetOptions

#### Hierarchy ([View Summary](../type-hierarchy.md#WTK.FocusWidgetOptions))
...
```ts
layout: FocusWidgetLayout = FocusWidgetLayout.STANDARD
```
...
[FocusWidgetLayout](./WTK.FocusWidgetLayout.md)

##### Default Value

`FocusWidgetLayout.STANDARD`
