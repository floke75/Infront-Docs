---
title: "AnalyticsAnalystsWidgetOptions"
qualified_name: "WTK.AnalyticsAnalystsWidgetOptions"
kind: class
...
nav_path: "WTK > Widget Options > AnalyticsAnalystsWidgetOptions"
source_url: "https://docs.infrontfinance.com/docs/classes/WTK.AnalyticsAnalystsWidgetOptions.html"
defines: ["AnalyticsAnalystsWidgetOptions"]
member_count: 22
members: ["instrument?", "decimals", "hasContentCallback", "id", "linkChannels", "navButton", "navButtonClicked", "noContentPlaceholder?", "onChanges?", "persistState", "popupContainer?", "resetPopupPosition?", "showSearchWidget", "storageType", "streaming", "useOriginal", "usePerfectScrollbar", "widgetStateCallback", "widgetTitle", "analystsData?", "maxItems?", "source"]
member_groups:
  ...
  "AnalyticsAnalystsWidget": ["analystsData?", "maxItems?", "source"]
reference_count: 10
references: ["SDK.InfrontSDK.SymbolId", "WTK.WidgetDecimals", "WTK.WidgetNavButtonType", "WTK.WidgetPopupParent", "WTK.WidgetState", "SDK.InfrontSDK.CoreDataAPI.CdapiEquityCompanyEstimateAnalysts", "SDK.InfrontSDK.CoreDataAPI.CdapiEquityCompanyEstimateSource", "WTK.AnalyticsAnalystsWidget", "WTK.SvelteWidgetOptions", "WTK.InfrontWidget"]
---

# AnalyticsAnalystsWidgetOptions

AnalyticsAnalystsWidgetOptions class extending SvelteSingleInstrumentWidgetBaseOptions class.

Set Options for the AnalyticsAnalystsWidget.

#### See

AnalyticsAnalystsWidget | SvelteWidgetOptions | SvelteSingleInstrumentWidgetBaseOptions
...
### AnalyticsAnalystsWidget

#### `Optional` analystsData

```ts
analystsData?: CdapiEquityCompanyEstimateAnalysts[]
```

Customly provided data.
Setting this will prevent the widget from doing it's own requests.
...
Limit the amount of displayed board members.
...
```ts
source: CdapiEquityCompanyEstimateSource = 'INFRONT'
```

Source for the board members data.
