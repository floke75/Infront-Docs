...
# Sdkchart Wtkwdg13072

# Sdkchart Wtkwdg13072

Test snippet for SdkchartWtkwdg13072

Demonstrates: `ChartWidget`, `chartWidget`

This page is split across 2 part files:

- [Script (script.ts)](./Widget-snippets-Sdkchart-Wtkwdg13072.parts/01-script-script-ts.md)
- [Markup (template.html)](./Widget-snippets-Sdkchart-Wtkwdg13072.parts/02-markup-template-html.md)
