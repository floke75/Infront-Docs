...
<script type="text/javascript">
    var instrumentList = [
        ...
        new Infront.Instrument(26, 'DAI'), // nice cars
    ...
    function infrontReady() {
        ...
        // chartOpts.mainDataType = Infront.Chart.DataType.CLOSE;
        // chartOpts.mainDataType = Infront.Chart.DataType.BID;
        // special data types:
        // chartOpts.mainDataType = Infront.Chart.DataType.BID_ASK;
        // chartOpts.mainDataType = Infront.Chart.DataType.PERFORMANCE;
      ...
      */
        ...
        if (!USE_CUSTOM_DATA_DEMO) {
            ...
            chartOpts2.linkChannels = [7756];
            chartOpts2.indicatorsBasedOnResolution = false;

            chartWidget2 = infront.chartWidget('chartwidget2', chartOpts2);
        }

        navLink = new Infront.Link(infront, Infront.LinkAction.Replace, [7756], onLink);
...
<div class="list_chartnavi">
    <ul class="cf">
        <li class="range-button current" data-range="ONE_DAY" onclick="switchPeriod(this)">1D</li>
...
<div class="list_chartnavi">
    <ul class="cf">
        <li class="nav-item current" data-index="0" onclick="switchInstrument(this)">Tesla</li>
        <li class="nav-item" data-index="1" onclick="switchInstrument(this)">Apple</li>
        <li class="nav-item" data-index="2" onclick="switchInstrument(this)">Daimler</li>
        ...
        <li class="nav-item" data-index="13" onclick="switchInstrument(this)" style="width: 80px">
            DIGIGR
        </li>
        <li class="nav-item" data-index="14" onclick="switchInstrument(this)">DNB</li>
        <li class="nav-item" data-index="15" onclick="switchInstrument(this)" style="width: 80px">
            Delphi Nordic N
        </li>
        <li class="nav-item" data-index="16" onclick="switchInstrument(this)" style="width: 80px">
            Jyske Realkredit 2033
        </li>
        <li class="nav-item" data-index="17" onclick="switchInstrument(this)" style="width: 80px">
            Nykredit Realkredit 2026
        </li>
        <li class="nav-item" data-index="18" onclick="switchInstrument(this)">OSEBX</li>
        <li class="nav-item" data-index="19" onclick="switchInstrument(this)">ABB2L 270NDS</li>
    </ul>
</div>
<div class="list_chartnavi">
    <ul class="cf">
