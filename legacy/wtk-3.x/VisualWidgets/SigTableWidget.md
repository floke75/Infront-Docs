---
title: "Stock Ideas Generator Table widget"
kind: legacy-widget
...
widget_id: "SigTableWidget"
option_count: 9
options: ["target", "options", "company", "view", "mode", "universe", "showFaq", "buttonList", "isInfrontWT"]
source_url: "https://doc.infrontfinance.com/v3/VisualWidgets#SigTableWidget"
---

# Stock Ideas Generator Table widget

```javascript
InfinWidget = InfinancialsUI.SigTableWidget(target, [options]);
```
