...
option_count: 9
options: ["instrumentTypes", "instrumentSubtypes", "loans", "hideInstrumentTypes", "hideInstrumentSubtypes", "displayRowColumns", "enableOrders", "enableTrades", "onChangeModeCallback"]
source_url: "https://doc.infrontfinance.com/v3/TradingWidgets#PositionsWidget"
---
...
Adds instruments on given sub types
...
Hides instruments on given types
...
Hides instruments on given sub types

### `displayRowColumns`

- **Type:** `any[]`
- **Default:** `["AVG_PRICE", "LAST", "CURRENCY", "INVESTED"]`
...
Callback that is triggered whenever mode is changed
