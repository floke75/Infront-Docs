...
option_count: 19
options: ["target", "options", "target", "options", "widgetTitle", "id", "persistState", "storageType", "linkChannels", "decimals", "hasContentCallback", "widgetStateCallback", "navButton", "navButtonClicked", "useOriginal", "showSearchWidget", "instrument", "pageItems", "paging"]
source_url: "https://doc.infrontfinance.com/v2/MarketDataWidgets#IntradayTradesWidget"
---
...
|  |  |  |  |
|---|---|---|---|
| VOLUME | TIME | LAST | BUYER |
| BUYER_FULL | SELLER | SELLER_FULL |  |
