...
option_count: 57
options: ["target", "options", "createExpandRow", "onInstrumentSelected", "setMaxItems(count: number)", "columns", "sortable", "defaultSortedColumn", "defaultSortOrder", "compareCaseInsensitive", "enableChangeStatusColors", "className", "interactionHighlight", "extraColumns", "extraOptions", "tabs", "id", "lable", "columns", "loadSavedColumns", "onColumnsChanged", "availableColumns", "enableColumnsMove", "enableColumnsResize", "decimals", "layout", "defaultContent", "expandableRows", "expandableRows", "onSettingsClicked", "onColumnDeleted", "onColumnMoving", "onColumnMoving", "onColumnMoved", "onColumnInsert", "onColumnsResized", "onResetColumns", "expandableRows", "feed", "instruments", "layout", "linkAction", "maxItems", "rowSelectable", "selectedRow", "showDropDowns", "onItemCountChange", "tabs", "tabs.id", "tabs.label", "tabs.columns", "chains", "chain.feed", "chain.name", "chain.description", "defaultChain", "types"]
source_url: "https://doc.infrontfinance.com/v2/MarketDataWidgets#QuoteListWidget"
---
