...
option_count: 18
options: ["target", "options", "target", "options", "widgetTitle", "id", "persistState", "storageType", "linkChannels", "decimals", "hasContentCallback", "widgetStateCallback", "navButton", "navButtonClicked", "useOriginal", "showSearchWidget", "instrument", "layout"]
source_url: "https://doc.infrontfinance.com/v2/MarketDataWidgets#MultipleValuesWidget"
---

# Multiple values widget

```javascript
InfrontWidget = Infront.instrumentValues(target, [options]);
```
...
- **Type:** `enum`
- **Default:** `Infront.MultipleValuesWidgetLayout.TABLE_ROW`
